...
docker create --expose $PORT -p $PORT:$PORT -p 9042:9042 -p 7000:7000 -p 7001:7001 -p 9160:9160 -e JMX_PORT=7199 -e LOCAL_JMX=no --name $NAME cassandra:$CASSANDRA_VERSION
