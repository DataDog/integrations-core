...
PRIVILEGED_METRICS = [
    ...
    'supabase.go.threads',
    'supabase.http.server.response_size_bytes.count',
    ...
    'supabase.pg_ls.archive_statusdir_wal_pending_count.count',
    ...
    'supabase.pg_stat_database_conflicts.confl_bufferpin.count',
    'supabase.pg_stat_database_conflicts.confl_deadlock.count',
    'supabase.pg_stat_database_conflicts.confl_lock.count',
    'supabase.pg_stat_database_conflicts.confl_snapshot.count',
    'supabase.pg_stat_database_conflicts.confl_tablespace.count',
    ...
    'supabase.physical_replication_lag.seconds',
    'supabase.postgres_exporter.build_info',
    'supabase.postgres_exporter.config_last_reload_success_timestamp_seconds',
...
STORAGE_API_METRICS = [
    ...
    'supabase.storage_api.process_cpu_user_seconds.count',
]