...
PRIVILEGED_METRICS = [
    ...
    'supabase.supavisor.client.connection.duration.bucket',
    'supabase.supavisor.client.connection.duration.count',
    'supabase.supavisor.client.connection.duration.sum',
    'supabase.supavisor.client.connection.lifetime_ms.bucket',
    'supabase.supavisor.client.connection.lifetime_ms.count',
    'supabase.supavisor.client.connection.lifetime_ms.sum',
    'supabase.supavisor.client.joins.fail.count',
    'supabase.supavisor.client.joins.ok.count',
    'supabase.supavisor.client.network.recv.count',
    'supabase.supavisor.client.network.send.count',
    'supabase.supavisor.client.queries_count.count',
    'supabase.supavisor.client.query.duration.bucket',
    'supabase.supavisor.client.query.duration.count',
    'supabase.supavisor.client.query.duration.sum',
    'supabase.supavisor.client_handler.started_count.count',
    'supabase.supavisor.client_handler.state.duration.bucket',
    'supabase.supavisor.client_handler.state.duration.count',
    'supabase.supavisor.client_handler.state.duration.sum',
    'supabase.supavisor.client_handler.stopped_count.count',
    'supabase.supavisor.connections.active',
    'supabase.supavisor.db.network.recv.count',
    'supabase.supavisor.db.network.send.count',
    'supabase.supavisor.db_handler.db_connection_count.count',
    'supabase.supavisor.db_handler.prepared_statements_evicted_count.count',
    'supabase.supavisor.db_handler.started_count.count',
    'supabase.supavisor.db_handler.stopped_count.count',
    'supabase.supavisor.pool.checkout.duration.local.bucket',
    'supabase.supavisor.pool.checkout.duration.local.count',
    'supabase.supavisor.pool.checkout.duration.local.sum',
    'supabase.supavisor.pool.checkout.duration.remote.bucket',
    'supabase.supavisor.pool.checkout.duration.remote.count',
    'supabase.supavisor.pool.checkout.duration.remote.sum',
    'supabase.supavisor.pool.connections.checked_out',
    'supabase.supavisor.pool.connections.idle',
    'supabase.supavisor.proxy.connections.active',
    'supabase.supavisor.tenants.active',
