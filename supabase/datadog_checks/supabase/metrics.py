...
PRIVELEGED_METRICS = {
    ...
    'db_sql_connection_closed_max_idle_time': 'db.sql.connection_closed_max_idle_time', # COUNTER
    'db_sql_connection_closed_max_idle': 'db.sql.connection_closed_max_idle', # COUNTER
    'db_sql_connection_closed_max_lifetime': 'db.sql.connection_closed_max_lifetime', # COUNTER
    'db_sql_connection_max_open': 'db.sql.connection_max_open',
    'db_sql_connection_open': 'db.sql.connection_open',
    'db_sql_connection_wait_duration_milliseconds': 'db.sql.connection_wait_duration', # COUNTER
    'db_sql_connection_wait': 'db.sql.connection_wait', # COUNTER
    'db_transmit_bytes': 'db.transmit_bytes', # COUNTER
    'http_server_response_size_bytes': 'http.server.response_size_bytes', # COUNTER
    'http_status_codes': 'http.status_codes', # COUNTER
    'node_cpu_guest_seconds': 'node.cpu.guest_seconds', # COUNTER
    'node_cpu_seconds': 'node.cpu.seconds', # COUNTER
    'node_disk_discard_time_seconds': 'node.disk.discard_time_seconds', # COUNTER
    'node_disk_discarded_sectors': 'node.disk.discarded_sectors', # COUNTER
    'node_disk_discards_completed': 'node.disk.discards_completed', # COUNTER
    'node_disk_discards_merged': 'node.disk.discards_merged', # COUNTER
    'node_disk_flush_requests_time_seconds': 'node.disk.flush_requests_time_seconds', # COUNTER
    'node_disk_flush_requests': 'node.disk.flush_requests', # COUNTER
    'node_disk_io_now': 'node.disk.io_now',
    'node_disk_io_time_seconds': 'node.disk.io_time_seconds', # COUNTER
    'node_disk_io_time_weighted_seconds': 'node.disk.io_time_weighted_seconds', # COUNTER
    'node_disk_read_bytes': 'node.disk.read_bytes', # COUNTER
    'node_disk_read_time_seconds': 'node.disk.read_time_seconds', # COUNTER
    'node_disk_reads_completed': 'node.disk.reads_completed', # COUNTER
    'node_disk_reads_merged': 'node.disk.reads_merged', # COUNTER
    'node_disk_write_time_seconds': 'node.disk.write_time_seconds', # COUNTER
    'node_disk_writes_completed': 'node.disk.writes_completed', # COUNTER
    'node_disk_writes_merged': 'node.disk.writes_merged', # COUNTER
    'node_disk_written_bytes': 'node.disk.written_bytes', # COUNTER
    ...
    'node_network_receive_bytes': 'node.network.receive_bytes', # COUNTER
    'node_network_receive_compressed': 'node.network.receive_compressed', # COUNTER
    'node_network_receive_drop': 'node.network.receive_drop', # COUNTER
    'node_network_receive_errs': 'node.network.receive_errors', # COUNTER
    'node_network_receive_fifo': 'node.network.receive_fifo', # COUNTER
    'node_network_receive_frame': 'node.network.receive_frame', # COUNTER
    'node_network_receive_multicast': 'node.network.receive_multicast', # COUNTER
    'node_network_receive_packets': 'node.network.receive_packets', # COUNTER
    'node_network_transmit_bytes': 'node.network.transmit_bytes', # COUNTER
    'node_network_transmit_carrier': 'node.network.transmit_carrier', # COUNTER
    'node_network_transmit_colls':'node.network.transmit_colls', # COUNTER
    'node_network_transmit_compressed': 'node.network.transmit_compressed', # COUNTER
    'node_network_transmit_drop': 'node.network.transmit_drop', # COUNTER
    'node_network_transmit_errs': 'node.network.transmit_errors', # COUNTER
    'node_network_transmit_fifo': 'node.network.transmit_fifo', # COUNTER
    'node_network_transmit_packets': 'node.network.transmit_packets', # COUNTER
    ...
    'pg_exporter_scrapes': 'pg_exporter.scrapes', # COUNTER
    'pg_exporter_user_queries_load_error': 'pg_exporter.user_queries_load_error',
    'pg_ls_archive_statusdir_wal_pending_count': 'pg_ls.archive_statusdir_wal_pending_count', # COUNTER
    ...
    'pg_stat_bgwriter_buffers_alloc': 'pg_stat_bgwriter.buffers_alloc', # COUNTER
    'pg_stat_bgwriter_buffers_backend_fsync': 'pg_stat_bgwriter.buffers_backend_fsync', # COUNTER
    'pg_stat_bgwriter_buffers_backend': 'pg_stat_bgwriter.buffers_backend', # COUNTER
    'pg_stat_bgwriter_buffers_checkpoint': 'pg_stat_bgwriter.buffers_checkpoint', # COUNTER
    'pg_stat_bgwriter_buffers_clean': 'pg_stat_bgwriter.buffers_clean', # COUNTER
    'pg_stat_bgwriter_checkpoint_sync_time': 'pg_stat_bgwriter.checkpoint_sync_time', # COUNTER
    'pg_stat_bgwriter_checkpoint_write_time': 'pg_stat_bgwriter.checkpoint_write_time', # COUNTER
    'pg_stat_bgwriter_checkpoints_req': 'pg_stat_bgwriter.checkpoints_req', # COUNTER
    'pg_stat_bgwriter_checkpoints_timed': 'pg_stat_bgwriter.checkpoints_timed', # COUNTER
    'pg_stat_bgwriter_maxwritten_clean': 'pg_stat_bgwriter.maxwritten_clean', # COUNTER
    'pg_stat_bgwriter_stats_reset': 'pg_stat_bgwriter.stats_reset', # COUNTER
    'pg_stat_database_blks_hit': 'pg_stat_database.blks_hit', # COUNTER
    'pg_stat_database_blks_read': 'pg_stat_database.blks_read', # COUNTER
    'pg_stat_database_conflicts_confl_bufferpin': 'pg_stat_database_conflicts.confl_bufferpin', # COUNTER
    'pg_stat_database_conflicts_confl_deadlock': 'pg_stat_database_conflicts.confl_deadlock', # COUNTER
    'pg_stat_database_conflicts_confl_lock': 'pg_stat_database_conflicts.confl_lock', # COUNTER
    'pg_stat_database_conflicts_confl_snapshot': 'pg_stat_database_conflicts.confl_snapshot', # COUNTER
    'pg_stat_database_conflicts_confl_tablespace': 'pg_stat_database_conflicts.confl_tablespace', # COUNTER
    'pg_stat_database_conflicts': 'pg_stat_database.conflicts', # COUNTER
    'pg_stat_database_deadlocks': 'pg_stat_database.deadlocks', # COUNTER
    'pg_stat_database_most_recent_reset': 'pg_stat_database.most_recent_reset', # COUNTER
    'pg_stat_database_num_backends': 'pg_stat_database.num_backends',
    'pg_stat_database_temp_bytes': 'pg_stat_database.temp_bytes', # COUNTER
    'pg_stat_database_temp_files': 'pg_stat_database.temp_files', # COUNTER
    'pg_stat_database_tup_deleted': 'pg_stat_database.tup_deleted', # COUNTER
    'pg_stat_database_tup_fetched': 'pg_stat_database.tup_fetched', # COUNTER
    'pg_stat_database_tup_inserted': 'pg_stat_database.tup_inserted', # COUNTER
    'pg_stat_database_tup_returned': 'pg_stat_database.tup_returned', # COUNTER
    'pg_stat_database_tup_updated': 'pg_stat_database.tup_updated', # COUNTER
    'pg_stat_database_xact_commit': 'pg_stat_database.xact_commit', # COUNTER
    'pg_stat_database_xact_rollback': 'pg_stat_database.xact_rollback', # COUNTER
    'pg_stat_replication_replay_lag': 'pg_stat_replication.replay_lag',
    'pg_stat_replication_send_lag': 'pg_stat_replication.send_lag',
    'pg_stat_statements_total_queries': 'pg_stat_statements.total_queries', # COUNTER
    'pg_stat_statements_total_time_seconds': 'pg_stat_statements.total_time_seconds', # COUNTER
    ...
    'pgrst_db_pool_timeouts': 'pgrst.db_pool.connection_timeouts', # COUNTER
    'pgrst_db_pool_waiting': 'pgrst.db_pool.requests_waiting',
    'pgrst_schema_cache_loads': 'pgrst.schema_cache.loads', # COUNTER
    ...
    'postgres_exporter_config_last_reload_success_timestamp_seconds': 'postgres_exporter.config_last_reload_success_timestamp_seconds',
    'postgres_exporter_config_last_reload_successful': 'postgres_exporter.config_last_reload_successful',
    'postgresql_restarts': 'postgresql.restarts', # COUNTER
    ...
    'promhttp_metric_handler_requests_in_flight': 'promhttp_metric_handler.requests_in_flight',
    'promhttp_metric_handler_requests': 'promhttp_metric_handler.requests', # COUNTER
    ...
    'supabase_usage_metrics_user_queries': 'usage_metrics.user_queries', # COUNTER
}
