...
# NOTE: names purposefully do NOT follow the names of PySNMP classes.
# This is because these possible types should be completely decoupled from PySNMP classes.
