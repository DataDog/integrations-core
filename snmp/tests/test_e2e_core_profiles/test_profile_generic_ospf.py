...
def test_e2e_profile_generic_ospf(dd_agent_check):
    ...
    for tag_row in tag_rows:
        ...
        aggregator.assert_metric('snmp.ospfVirtNbrLsRetransQLen', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
    ...
    for tag_row in tag_rows:
        ...
        aggregator.assert_metric('snmp.ospfVirtIfRetransInterval', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
