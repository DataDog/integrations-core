...
def test_e2e_profile_kyocera_printer(dd_agent_check):
    config = create_e2e_core_test_config('kyocera-printer')
    ...
    tag_rows = [
        ['kcprt_memory_device_location:pc_card-a', 'kcprt_memory_device_status:ready_read_write', 'kcprt_memory_device_type:strage'],
        [
