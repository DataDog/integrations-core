...
1.3.6.1.4.1.14823.2.2.1.2.1.13.1.3.4|66|29
    """
    # fmt: on
    aggregator.assert_metric("snmp.cpu.usage", metric_type=aggregator.GAUGE, tags=metric_tags + ['cpu:4'])
...
1.3.6.1.4.1.12356.101.12.2.2.1.20.2|2|1
    ...
    aggregator.assert_metric(
        'snmp.fgVpnTunEntStatus', metric_type=aggregator.GAUGE, tags=metric_tags + ['vpn_tunnel:ESMAO']
    )
...
1.3.6.1.2.1.2.1.0|2|28
    """
    # fmt: on
    aggregator.assert_metric("snmp.ifNumber", metric_type=aggregator.GAUGE, tags=metric_tags)
...
1.3.6.1.2.1.4.31.1.1.4.1|70|310637142
    ...
    aggregator.assert_metric(
        ...
        tags=metric_tags + ["ipversion:ipv4"],
    )
...
1.3.6.1.2.1.6.5.0|65|4698
    """
    # fmt: on
    aggregator.assert_metric("snmp.tcpActiveOpens", metric_type=aggregator.COUNT, tags=metric_tags)
...
1.3.6.1.2.1.7.8.0|70|6116206687099577350
    """
    # fmt: on
    aggregator.assert_metric("snmp.udpHCInDatagrams", metric_type=aggregator.COUNT, tags=metric_tags)
...
1.3.6.1.2.1.14.10.1.6.192.29.116.26.0|2|8
    ...
    # fmt: on
    aggregator.assert_metric(
        "snmp.ospfNbr", metric_type=aggregator.GAUGE, tags=metric_tags + ["neighbor_state:full"], value=1
    )
    aggregator.assert_metric(
        "snmp.ospfNbrState", metric_type=aggregator.GAUGE, tags=metric_tags + ["neighbor_state:full"]
    )
...
1.3.6.1.2.1.15.3.1.3.244.12.239.177|2|2
    ...
    aggregator.assert_metric(
        ...
        tags=metric_tags + ["admin_status:start"],
    )
    aggregator.assert_metric(
...
def assert_extend_cisco_cpu_memory(aggregator, common_tags):
    metric_tags = common.filter_metric_tags(common_tags)
    aggregator.assert_metric("snmp.memory.used", metric_type=aggregator.GAUGE, tags=metric_tags + ["mem:18"])
    aggregator.assert_metric("snmp.ciscoMemoryPoolUsed", metric_type=aggregator.GAUGE, tags=metric_tags)
    aggregator.assert_metric("snmp.cpu.usage", metric_type=aggregator.GAUGE, tags=metric_tags + ["cpu:712"])
    aggregator.assert_metric(
        "snmp.cpmCPUTotal1minRev",
        metric_type=aggregator.GAUGE,
        tags=metric_tags + ["cpu:712"],
    )
...
1.3.6.1.4.1.9.9.13.1.4.1.3.11|2|6
    ...
    aggregator.assert_metric(
        ...
        metric_type=aggregator.GAUGE,
        tags=metric_tags + ['fan_state:not_functioning', 'fan_status_index:11'],
    )
    aggregator.assert_metric(
        'snmp.ciscoEnvMonFanState', metric_type=aggregator.GAUGE, tags=metric_tags + ['fan_status_index:11']
    )
...
"""
    # fmt: on
    aggregator.assert_metric("snmp.hrSystemUptime", metric_type=aggregator.GAUGE, tags=metric_tags)
    ...
    for cpu_row in cpu_rows:
        ...
        aggregator.assert_metric(
            ...
            metric_type=aggregator.GAUGE,
            tags=metric_tags + ['processorid:' + processorid, 'hr_device_index:' + hr_device_index],
        )
    ...
    for mem_row in hr_mem_rows:
        aggregator.assert_metric('snmp.hrStorageSize', metric_type=aggregator.GAUGE, tags=metric_tags + mem_row)
        aggregator.assert_metric('snmp.hrStorageUsed', metric_type=aggregator.GAUGE, tags=metric_tags + mem_row)
...
def assert_extend_generic_host_resources_cpu_mem(aggregator, common_tags):
    ...
    cpu_rows = ['10', '21']
    for cpu_row in cpu_rows:
        aggregator.assert_metric('snmp.cpu.usage', metric_type=aggregator.GAUGE, tags=metric_tags + ['cpu:' + cpu_row])

    mem_rows = ['31', '4']
    for mem_row in mem_rows:
        aggregator.assert_metric(
            'snmp.memory.total', metric_type=aggregator.GAUGE, tags=metric_tags + ['mem:' + mem_row]
        )
        aggregator.assert_metric(
            'snmp.memory.usage', metric_type=aggregator.GAUGE, tags=metric_tags + ['mem:' + mem_row]
        )
        aggregator.assert_metric(
            'snmp.memory.used', metric_type=aggregator.GAUGE, tags=metric_tags + ['mem:' + mem_row]
        )
...
1.3.6.1.6.3.10.2.1.4.0|2|1234
    ...
    aggregator.assert_metric("snmp.entPhySensorValue", metric_type=aggregator.GAUGE, tags=metric_tags + additional_tags)
...
1.3.6.1.4.1.9.9.109.1.1.1.1.12.712|66|353
    ...
    # fmt:on
    tags = ['cpu:712']
    aggregator.assert_metric("snmp.cpmCPUMemoryUsed", metric_type=aggregator.GAUGE, tags=metric_tags + tags)
...
1.3.6.1.4.1.2636.3.15.10.1.2.170.25|2|25
    """
    # fmt: on
    tags = ['interface:jnxCosIfsetDescr value1', 'queue_number:25'] + metric_tags
...
1.3.6.1.4.1.2636.3.6.2.1.4.83.1.5.116.104.101.105.114|70|12317383665498203792
    """
    # fmt: on
    tags = ['interface:eth111'] + metric_tags
...
1.3.6.1.4.1.2636.3.5.2.1.4.37.116.104.101.105.114.32.100.114.105.118.105.110.103.32.113.117.97.105.110.116.108.121.32.98.117.116.32.74.97.100.101.100.32.111.120.101.110.38.74.97.100.101.100.32.111.120.101.110.32.107.101.112.116.32.116.104.101.105.114.32.100.114.105.118.105.110.103.32.98.117.116.32.107.101.112.116.4|70|4454094099404974412
    """
    # fmt: on
    tags = ['firewall_filter_name:filter111'] + metric_tags
...
1.3.6.1.4.1.2636.3.40.1.4.1.2.1.5.11.43.74.97.100.101.100.32.102.111.114.119.97.114.100.32.98.117.116.32.111.120.101.110.32.113.117.97.105.110.116.108.121.32.116.104.101.105.114.32.116.104.101.105.114|70|12189304536513319332
    """
    # fmt: on
    tags = ['port_name:port111'] + metric_tags
