...
def test_e2e_profile_tripplite_ups(dd_agent_check):
 ...
 'tl_ups_ident_serial_num:kept driving Jaded Jaded zombies acted',
 'tl_ups_location:but kept quaintly Jaded forward',
 'tl_ups_snmp_card_serial_num:but Jaded but']
    ...
    tag_rows = [
         ['tl_ups_input_voltage_index:11', 'tl_ups_input_voltage_type:phase_to_phase'],
    ...
    tag_rows = [
         ['tl_env_contact_config:normally_closed', 'tl_env_contact_name:acted driving Jaded', 'tl_env_contact_status:normal'],
         ['tl_env_contact_config:normally_open', 'tl_env_contact_name:Jaded forward their zombies their', 'tl_env_contact_status:normal'],
    ...
    tag_rows = [
         ['tl_ups_outlet_group_desc:but oxen', 'tl_ups_outlet_group_name:forward acted oxen', 'ups_outlet_group_status_group_state:ups_outlet_group_status_off'],
         ['tl_ups_outlet_group_desc:driving but kept but oxen acted their their', 'tl_ups_outlet_group_name:forward but'],
