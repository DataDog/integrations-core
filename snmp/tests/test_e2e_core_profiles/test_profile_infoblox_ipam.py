...
def test_e2e_profile_infoblox_ipam(dd_agent_check):
    ...
    tag_rows = [
        ['ib_service_description:forward oxen oxen', 'ib_service_name:lcd', 'ib_service_status:inactive'],
        ['ib_service_description:kept zombies kept', 'ib_service_name:raid-disk8', 'ib_service_status:warning'],
    ]
    for tag_row in tag_rows:
