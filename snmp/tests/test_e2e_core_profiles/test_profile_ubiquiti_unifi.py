...
def test_e2e_profile_ubiquiti_unifi(dd_agent_check):
    config = create_e2e_core_test_config('ubiquiti-unifi')
    ...
    for tag_row in tag_rows:
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioCuSelfRx', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioCuSelfTx', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioCuTotal', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioOtherBss', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioRxPackets', metric_type=aggregator.COUNT, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ubiquiti.unifiRadioTxPackets', metric_type=aggregator.COUNT, tags=common_tags + tag_row)
