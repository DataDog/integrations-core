...
def test_e2e_profile_extreme_switching(dd_agent_check):
    ...
    aggregator.assert_metric('snmp.extremeCurrentTemperature', metric_type=aggregator.GAUGE, tags=metric_tags)
    aggregator.assert_metric('snmp.extremeInputPowerVoltage', metric_type=aggregator.GAUGE, tags=metric_tags)
