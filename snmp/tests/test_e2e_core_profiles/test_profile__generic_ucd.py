...
def test_e2e_profile__generic_ucd(dd_agent_check):
    ...
    aggregator.assert_metric('snmp.ucd.ssCpuRawIdle', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawInterrupt', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawKernel', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawNice', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawSystem', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawUser', metric_type=aggregator.GAUGE, tags=common_tags)
    aggregator.assert_metric('snmp.ucd.ssCpuRawWait', metric_type=aggregator.GAUGE, tags=common_tags)
    ...
    for tag_row in tag_rows:
        ...
        aggregator.assert_metric('snmp.ucd.diskIONReadX', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ucd.diskIONWrittenX', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ucd.diskIOReads', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
        aggregator.assert_metric('snmp.ucd.diskIOWrites', metric_type=aggregator.GAUGE, tags=common_tags + tag_row)
