...
APPLICATION_CONTROLLER = {
    ...
    'argocd_kubectl_requests': 'kubectl.requests',
    'argocd_kubectl_exec_plugin_call': 'kubectl.exec_plugin.call',
    'argocd_kubectl_request_retries': 'kubectl.request.retries',
    'argocd_kubectl_transport_cache_entries': 'kubectl.transport.cache_entries',
    'argocd_kubectl_transport_create_calls': 'kubectl.transport.create_calls',
...
APPSET_CONTROLLER = {
    ...
    'argocd_github_api_requests': 'github_api.requests',
...
API_SERVER = {
    ...
    'argocd_login_request': 'login.request',
    'argocd_proxy_extension_request': 'proxy_extension.request',
...
REPO_SERVER = {
    ...
    'argocd_git_fetch_fail': 'git.fetch.fail',
    ...
    'argocd_oci_request': 'oci.request',
    'argocd_oci_request_duration_seconds': 'oci.request.duration.seconds',
    'argocd_oci_test_repo_fail': 'oci.test_repo.fail',
    'argocd_oci_get_tags_fail': 'oci.get_tags.fail',
    'argocd_oci_digest_metadata_fail': 'oci.digest_metadata.fail',
    'argocd_oci_resolve_revision_fail': 'oci.resolve_revision.fail',
    'argocd_oci_extract_fail': 'oci.extract.fail',
}
