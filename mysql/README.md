...
Please note that `@'localhost'` is only for local connections - use the hostname/IP of your Agent for remote connections. For more information, see the [MySQL documentation][5].
...
## Further Reading
Read our [series of blog posts][19] about monitoring MySQL with Datadog.
...
[19]: https://www.datadoghq.com/blog/monitoring-mysql-performance-metrics
