...
The MySQL check is included in the [Datadog Agent][2] package, so you don't need to install anything else on your MySQL servers.

### Configuration

Edit `conf.d/mysql.d/conf.yaml` in the root of your [Agent's configuration directory][3] in order to connect the Agent to your MySQL server. You will begin collecting your MySQL [metrics](#metric-collection) and [logs](#log-collection) right away. See the [sample configuration file][4] for all available configuration options.
...
Note that `@'localhost'` is only for local connections - use the hostname/IP of your Agent for remote connections. For more information, see the [MySQL documentation][5].
...
In order to gather `extra_performance_metrics`, your MySQL server must have `performance_schema` enabled - otherwise set `extra_performance_metrics` to `false`. For more information on `performance_schema`, [see the MySQL documentation][6].
...
See our [sample mysql.yaml][4] for all available configuration options, including those for custom metrics.

[Restart the Agent][7] to start sending MySQL metrics to Datadog.
...
[Run the Agent's `status` subcommand][9] and look for `mysql` under the Checks section.
...
* [Connection Issues with the SQL Server Integration][11]
* [MySQL Localhost Error - Localhost VS 127.0.0.1][12]
* [Can I use a named instance in the SQL Server integration?][13]
* [Can I set up the dd-agent MySQL check on my Google CloudSQL?][14]
* [How to collect metrics from custom MySQL queries][15]
* [Can I collect SQL Server performance metrics beyond what is available in the sys.dm_os_performance_counters table? Try WMI][16]
* [How can I collect more metrics from my SQL Server integration?][17]
* [Database user lacks privileges][18]
* [How to collect metrics with a SQL Stored Procedure?][19]

## Further Reading
Read our [series of blog posts][20] about monitoring MySQL with Datadog.
...
[10]: https://github.com/DataDog/integrations-core/blob/master/mysql/metadata.csv
[11]: https://docs.datadoghq.com/integrations/faq/connection-issues-with-the-sql-server-integration
[12]: https://docs.datadoghq.com/integrations/faq/mysql-localhost-error-localhost-vs-127-0-0-1
[13]: https://docs.datadoghq.com/integrations/faq/can-i-use-a-named-instance-in-the-sql-server-integration
[14]: https://docs.datadoghq.com/integrations/faq/can-i-set-up-the-dd-agent-mysql-check-on-my-google-cloudsql
[15]: https://docs.datadoghq.com/integrations/faq/how-to-collect-metrics-from-custom-mysql-queries
[16]: https://docs.datadoghq.com/integrations/faq/can-i-collect-sql-server-performance-metrics-beyond-what-is-available-in-the-sys-dm-os-performance-counters-table-try-wmi
[17]: https://docs.datadoghq.com/integrations/faq/how-can-i-collect-more-metrics-from-my-sql-server-integration
[18]: https://docs.datadoghq.com/integrations/faq/database-user-lacks-privileges
[19]: https://docs.datadoghq.com/integrations/faq/how-to-collect-metrics-with-sql-stored-procedure
[20]: https://www.datadoghq.com/blog/monitoring-mysql-performance-metrics
