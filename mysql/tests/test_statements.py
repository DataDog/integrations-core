...
def test_statement_metrics(
    ...
    expected_tags = set(tags.METRIC_TAGS + ['postgres_server:{}'.format(common.HOST), 'port:{}'.format(common.PORT)])
    if aurora_replication_role:
...
def test_statement_samples_collect(
    ...
    expected_tags = set(tags.METRIC_TAGS + ['postrgres_server:{}'.format(common.HOST), 'port:{}'.format(common.PORT)])
    if aurora_replication_role:
        expected_tags.add("replication_role:" + aurora_replication_role)
...
def _expected_dbm_instance_tags(dbm_instance):
    return dbm_instance['tags'] + ['postgres_server:{}'.format(common.HOST), 'port:{}'.format(common.PORT)]
