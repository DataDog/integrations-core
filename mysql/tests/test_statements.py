...
@pytest.mark.parametrize("only_query_recent_statements", [True, False])
@mock.patch.dict('os.environ', {'DDEV_SKIP_GENERIC_TAGS_CHECK': 'true'})
def test_statement_metrics(
    aggregator, dd_run_check, dbm_instance, query, default_schema, datadog_agent, aurora_replication_role, only_query_recent_statements
):
