...
def test_statement_metrics(
    ...
    expected_tags = set(tags.METRIC_TAGS + ['mysql_server:{}'.format(common.HOST), 'port:{}'.format(common.PORT)])
    if aurora_replication_role:
...
def _expected_dbm_instance_tags(dbm_instance):
    return dbm_instance['tags'] + ['mysql_server:{}'.format(common.HOST), 'port:{}'.format(common.PORT)]
