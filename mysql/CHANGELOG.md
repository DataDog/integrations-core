...
* [Added] [Unified Instance Tagging]: Add cloud_metadata to DBM event payloads. See [#14312](https://github.com/DataDog/integrations-core/pull/14312).
...
* [Fixed] [DBM-2204] mysql: set self._check instance variables to make tracking work. See [#14146](https://github.com/DataDog/integrations-core/pull/14146).
