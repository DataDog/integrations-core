...
from mysql.datadog_checks.mysql.const import GALERA_VARS, REPLICA_VARS, PROC_NAME, RATE, GAUGE, COUNT, MONOTONIC, BUILDS
from mysql.tests.variables import VARIABLES_VARS, INNODB_VARS, BINLOG_VARS, OPTIONAL_STATUS_VARS, \
    OPTIONAL_STATUS_VARS_5_6_6, PERFORMANCE_VARS, SCHEMA_VARS, SYNTHETIC_VARS, STATUS_VARS, OPTIONAL_INNODB_VARS
