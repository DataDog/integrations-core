...
def agent_metrics_version
  ENV['FLAVOR_VERSION'] || 'latest'
end

def agent_metrics_rootdir
  "#{ENV['INTEGRATIONS_DIR']}/agent_metrics_#{agent_metrics_version}"
end
...
namespace :ci do
  namespace :agent_metrics do |flavor|
    ...
    #   sh %(docker stop agent_metrics)
    #   sh %(docker rm agent_metrics)
    # end
