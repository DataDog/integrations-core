...
1. Edit the `control_m.d/conf.yaml` file, in the `conf.d/` folder at the root of your Agent's configuration directory to start collecting your control_m performance data. See the [sample control_m.d/conf.yaml][4] for all available configuration options.
...
The Control-M integration does not include any events.

### Service Checks

The Control-M integration does not include any service checks.
