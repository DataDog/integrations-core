...
**NOTE**: The Docker check has been rewritten in Go for Agent v6 to take advantage of the new internal architecture. Hence it is still maintained but **only works with Agents <v6**.

**To learn how to use the Docker_daemon Integration with the Agent v6 [Consult our dedicated agent v6 setup](#agent-v6).**
