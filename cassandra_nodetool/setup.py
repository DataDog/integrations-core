...
setup(
    ...
    packages=['check', 'check.cassandra_nodetool'],
    ...
    package_data={b'check.cassandra_nodetool': ['cassandra_nodetool.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'cassandra_nodetool=check.cassandra_nodetool:main',
        ],
    },
)
