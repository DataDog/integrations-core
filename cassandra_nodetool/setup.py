...
setup(
    ...
    packages=['dd_integrations.cassandra_nodetool'],
    ...
    package_data={b'dd_integrations.cassandra_nodetool': ['cassandra_nodetool.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'cassandra_nodetool=dd_integrations.cassandra_nodetool:main',
        ],
    },
)
