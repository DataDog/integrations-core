...
METRIC_MAP = {
    ...
    'etcd_mvcc_db_total_size_in_bytes': 'mvcc.db.total.size.in_bytes',
    'etcd_mvcc_delete_total': 'mvcc.delete.total',
    'etcd_mvcc_put_total': 'mvcc.put.total',
    'etcd_mvcc_range_total': 'mvcc.range.total',
    'etcd_mvcc_txn_total': 'mvcc.txn.total',
