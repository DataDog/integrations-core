...
METRIC_MAP = {
    'etcd_debugging_auth_revision': 'debugging.auth.revision',
    ...
    'etcd_debugging_lease_granted_total': 'debugging.lease.granted.total',
    'etcd_debugging_lease_renewed_total': 'debugging.lease.renewed.total',
    'etcd_debugging_lease_revoked_total': 'debugging.lease.revoked.total',
    'etcd_debugging_lease_ttl_total': 'debugging.lease.ttl.total',
    'etcd_debugging_mvcc_compact_revision': 'debugging.mvcc.compact.revision',
    'etcd_debugging_mvcc_current_revision': 'debugging.mvcc.current.revision',
    'etcd_debugging_mvcc_db_compaction_last': 'debugging.mvcc.db.compaction.last',
    ...
    'etcd_debugging_mvcc_total_put_size_in_bytes': 'debugging.mvcc.total.put.size.in_bytes',
    ...
    'etcd_disk_backend_defrag_duration_seconds': 'disk.backend.defrag.duration.seconds',
    'etcd_disk_defrag_inflight': 'disk.defrag.inflight',
    ...
    'etcd_disk_wal_write_duration_seconds': 'disk.wal.write.duration.seconds',
    ...
    'etcd_network_known_peers': 'network.known_peers',
    ...
    'etcd_server_apply_duration_seconds': 'server.apply.duration.seconds',
    'etcd_server_range_duration_seconds': 'server.range.duration.seconds',
    'etcd_server_client_requests_total': 'etcd.server.client.requests.total',
    'etcd_server_feature_enabled': 'server.feature_enabled',
    ...
    'etcd_server_healthcheck': 'server.healthcheck',
    'etcd_server_healthchecks_total': 'server.healthchecks.total',
    'etcd_server_heartbeat_send_failures_total': 'server.heartbeat.send.failures.total',
    'etcd_server_id': 'server.id',
    'etcd_server_is_leader': 'server.is_leader',
    'etcd_server_is_learner': 'server.is_learner',
    ...
    'etcd_server_learner_promote_failures': 'server.learner.promote_failures',
    'etcd_server_learner_promote_successes': 'server.learner.promote_successes',
    ...
    'etcd_server_snapshot_apply_in_progress_total': 'server.snapshot.apply.in_progress.total',
    ...
    'go_sched_gomaxprocs_threads': 'go.sched.gomaxprocs.threads',
    ...
    'process_network_receive_bytes_total': 'process.network.receive_bytes.total',
    'process_network_transmit_bytes_total': 'process.network.transmit_bytes.total',
