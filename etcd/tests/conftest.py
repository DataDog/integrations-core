...
def openmetrics_metrics():
    ...
    histograms = [
        ...
        'debugging.disk.backend.commit.rebalance.duration.seconds',
        'debugging.disk.backend.commit.spill.duration.seconds',
        'debugging.disk.backend.commit.write.duration.seconds',
        'debugging.lease.ttl.total',
        'disk.backend.defrag.duration.seconds',
