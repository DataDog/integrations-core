...
from .common import CONTAINER_NAME, E2E_METADATA, HERE, INSTANCE_INTEGRATION, RRD_PATH, MYSQL_USERNAME, MYSQL_PASSWORD
...
FLUSH PRIVILEGES;
'''.format(user=MYSQL_USERNAME, password=MYSQL_PASSWORD)
