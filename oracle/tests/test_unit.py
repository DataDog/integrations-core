...
# test that has successful connection to db via jdbc and instant client, but fails can_query
def test__get_connection_jdbc_can_query_fail(check, dd_run_check):
    """
    Test the _get_connection method using the JDBC client and successfully can query DB
    """
