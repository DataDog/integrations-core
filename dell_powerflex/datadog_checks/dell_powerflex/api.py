...
class PowerFlexAPI:
    ...
    def get_system_statistics(self, system_id: str | None) -> dict:
    ...
    def get_volume_statistics(self, volume_id: str | None) -> dict:
    ...
    def get_storage_pool_statistics(self, pool_id: str | None) -> dict:
    ...
    def get_sdc_statistics(self, sdc_id: str | None) -> dict:
    ...
    def get_protection_domain_statistics(self, pd_id: str | None) -> dict:
