...
class CheckpointHarmonyEndpointCheck(AgentCheck):

    # This will be the prefix of every metric the integration sends
    __NAMESPACE__ = 'checkpoint_harmony_endpoint'

    def __init__(self, name, init_config, instances):
        super(CheckpointHarmonyEndpointCheck, self).__init__(name, init_config, instances)
