        ...
        'columns': [
            {
                ...
                'items': {
                    ...
                    'Query_Processor_time_nsec': {
                        'name': 'query_processor_time_nsec',
                        'type': 'gauge'
                    }
                }
            },
...
STATS_COMMAND_COUNTERS = Query(
    {
        ...
        'columns': [
            ...
            {'name': 'performance.command.command', 'type': 'tag'},
            # the total time spent executing commands of that type, in microseconds
            {'name': 'performance.command.total_time', 'type': 'rate'},
...
STATS_MYSQL_QUERY_RULES = Query(
    {
        ...
        'columns': [
            {'name': 'rule_id', 'type': 'tag'},
            {'name': 'query_rules.rule_hits', 'type': 'rate'}
        ]
    }
)