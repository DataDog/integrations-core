...
The TorchServe check is included in the [Datadog Agent][2] package.
No additional installation is needed on your server.

### Configuration

1. Edit the `torchserve.d/conf.yaml` file, in the `conf.d/` folder at the root of your Agent's configuration directory to start collecting your torchserve performance data. See the [sample torchserve.d/conf.yaml][4] for all available configuration options.
...
The TorchServe integration does not include any events.

### Service Checks

The TorchServe integration does not include any service checks.
