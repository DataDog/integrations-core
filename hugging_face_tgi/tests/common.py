...
TEST_METRICS = {
    ...
    'hugging_face_tgi.batch.concat.duration': 'gauge',
    ...
    'hugging_face_tgi.batch.inference.duration': 'gauge',
    ...
    'hugging_face_tgi.batch.inference.success': 'monotonic_count',
    'hugging_face_tgi.batch.next.size': 'gauge',
    ...
    'hugging_face_tgi.request.duration': 'gauge',
    'hugging_face_tgi.request.duration.sum': 'monotonic_count',
    'hugging_face_tgi.request.duration.count': 'monotonic_count',
    'hugging_face_tgi.request.failure': 'monotonic_count',
    'hugging_face_tgi.request.generated_tokens': 'gauge',
    ...
    'hugging_face_tgi.request.inference.duration': 'gauge',
    ...
    'hugging_face_tgi.request.queue.duration': 'gauge',
    'hugging_face_tgi.request.queue.duration.sum': 'monotonic_count',
    'hugging_face_tgi.request.queue.duration.count': 'monotonic_count',
    'hugging_face_tgi.request.skipped_tokens': 'gauge',
    'hugging_face_tgi.request.success': 'monotonic_count',
    'hugging_face_tgi.request.validation.duration': 'gauge',
...
RENAMED_LABELS = {
    "hugging_face_tgi.request.failure": 'error_type:validation',
