...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'pinecone', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-pinecone',
    version=ABOUT['__version__'],
    description='The Pinecone check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent pinecone check',
    ...
    packages=['datadog_checks.pinecone'],
