...
def test_cant_connect(init_config, instance, aggregator):
    ...
    ambari = AmbariCheck('ambari', init_config=init_config, instances=[instance])
...
def test_get_host_metrics(instance, aggregator):
    ambari = AmbariCheck('ambari', {}, instances=[instance])
...
def test_get_service_health(init_config, instance, aggregator):
    ...
    ambari.get_service_checks(
        'LabCluster', 'HDFS', service_tags=['ambari_cluster:LabCluster', 'ambari_service:hdfs']
    )
...
def test_default_config(instance):
    ambari = AmbariCheck('ambari', init_config={}, instances=[instance])
...
def test_should_not_collect_if_disabled(instance):
    ambari = AmbariCheck(
        'ambari', init_config={'collect_service_metrics': False, 'collect_service_status': False}, instances=[instance]
    )
...
def test_should_collect_service_metrics(instance):
    ambari = AmbariCheck(
        'ambari', init_config={'collect_service_metrics': True, 'collect_service_status': False}, instances=[instance]
    )
    _mock_clusters(ambari)
    ambari.get_host_metrics = MagicMock()
...
def test_should_collect_service_status(instance):
    ambari = AmbariCheck(
        'ambari', init_config={'collect_service_metrics': False, 'collect_service_status': True}, instances=[instance]
    )
    _mock_clusters(ambari)
    ambari.get_host_metrics = MagicMock()
    ambari.get_component_metrics = MagicMock()
