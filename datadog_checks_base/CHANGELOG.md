...
* [Added] datadog_checks_base: Add obfuscate_sql_with_metadata wrapper and update stub. See [#10878](https://github.com/DataDog/integrations-core/pull/10878).
...
* [Fixed] datadog_checks_base: Fix obfuscate_sql_with_metadata wrapper not handling json.loads() edge case. See [#11038](https://github.com/DataDog/integrations-core/pull/11038).
...
* [Fixed] datadog_checks_base: Fix obfuscate_sql wrapper None value. See [#11016](https://github.com/DataDog/integrations-core/pull/11016).
