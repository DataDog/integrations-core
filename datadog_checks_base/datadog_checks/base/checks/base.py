...
class AgentCheck(object):
    ...
    def report_issue(self, id:str, issue_name:str, title:str=None, description:str=None, category:str=None, severity:int=0, extra:dict=None, remediation:dict=None, tags:list=None):
