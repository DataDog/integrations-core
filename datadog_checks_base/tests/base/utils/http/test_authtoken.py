...
class TestAuthTokenOAuth:
    def test_failure(self):
        ...
        with mock.patch('requests.Session.get'), mock.patch('oauthlib.oauth2.BackendApplicationClient'), mock.patch(
    ...
    def test_success(self, token_response, expected_expiration):
        ...
        with mock.patch('requests.Session.get') as get, mock.patch(
            'oauthlib.oauth2.BackendApplicationClient'
        ), mock.patch('requests_oauthlib.OAuth2Session', side_effect=MockOAuth2Session), mock.patch(
            'datadog_checks.base.utils.http.get_timestamp', return_value=0
        ):
            http.get('https://www.google.com')
...
class TestAuthTokenDCOS:
    def test_token_auth(self):
        ...
        with mock.patch('requests.post', side_effect=login), mock.patch(
