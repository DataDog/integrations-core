...
* [Added] Add `pyproject.toml` file. See [#11412](https://github.com/DataDog/integrations-core/pull/11412).
...
* [Added] Add runtime configuration validation. See [#8967](https://github.com/DataDog/integrations-core/pull/8967).
...
* [SANITY] Use `WinPDHCounter` shipped with `datadog-checks-base` wheel. [#1183](https://github.com/DataDog/integrations-core/issues/1183)
