...
FRONTEND_METRICS_MOCK = [
    ...
    'frontend.tokenizer_cache_hits.count',
    'frontend.tokenizer_cache_misses.count',
    'frontend.event_loop_stall.count',
    'tokio.worker_busy_ratio',
    'transport.tcp.bytes_received.count',
    'transport.tcp.bytes_sent.count',
    'transport.tcp.errors.count',
...
WORKER_METRICS_MOCK = [
    ...
    'component.model_load_time.seconds',
    ...
    'component.kv_publisher.zmq_events.count',
    'component.kv_publisher.zmq_filtered_events.count',
...
FRONTEND_HISTOGRAM_BUCKETS_MOCK = [
    ...
    'frontend.event_loop_delay.seconds',
    'request_plane.queue.seconds',
    'request_plane.roundtrip_ttft.seconds',
    'request_plane.send.seconds',
]
