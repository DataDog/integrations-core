...
class SliMetricsScraperMixin(OpenMetricsBaseCheck):
    """
    This class scrapes metrics for the kube apiserver "/metrics/sli" prometheus endpoint and submits
    ...
    def create_sli_prometheus_instance(self, instance):
        ...
        """
        KUBE_APISERVER_SLI_NAMESPACE = "kube_apiserver.slis"

        sli_instance = deepcopy(instance)
        sli_instance.update(
            {
                'namespace': KUBE_APISERVER_SLI_NAMESPACE,
