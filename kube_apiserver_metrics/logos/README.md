...
- Description heading at `/account/settings#integrations/kube_apiserver_metrics`
...
- Some integration dashboards/screenboards at `/dash/integration/kube_apiserver_metrics`
