...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'karpenter', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-karpenter',
    version=ABOUT['__version__'],
    description='The karpenter check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent karpenter check',
    ...
    packages=['datadog_checks.karpenter'],
