METRIC_MAP = {
    ...
    'karpenter_nodes_allocatable': 'nodes_allocatable',
    'karpenter_nodes_created': 'nodes_created',
    'karpenter_nodes_leases_deleted': 'nodes.leases_deleted',
    'karpenter_nodes_system_overhead': 'nodes.system_overhead',
    'karpenter_nodes_terminated': 'nodes_terminated',
    ...
    'karpenter_provisioner_limit': 'provisioner_limit',
    ...
    'karpenter_provisioner_usage': 'provisioner_usage',
