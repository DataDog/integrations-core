...
METRIC_MAP = {
    ...
    'karpenter_interruption_message_queue_duration_seconds': 'interruption.message.queue.duration_seconds',
    ...
    'operator_ec2nodeclass_status_condition_transition_seconds': 'operator.ec2nodeclass.status_condition.transitions.seconds',
    ...
    'operator_ec2nodeclass_termination_current_time_seconds': 'operator.ec2nodeclass.termination.current_time_seconds',
    'operator_ec2nodeclass_termination_duration_seconds': 'operator.ec2nodeclass.termination.duration_seconds',
    ...
    'operator_node_termination_current_time_seconds': 'operator.node.termination.current_time_seconds',
    ...
    'operator_nodeclaim_termination_current_time_seconds': 'operator.nodeclaim.termination.current_time_seconds',
    ...
    'operator_nodepool_status_condition_transition_seconds': 'operator.nodepool.status_condition.transitions.seconds',
    ...
    'operator_nodepool_termination_current_time_seconds': 'operator.nodepool.termination.current_time_seconds',
    'operator_nodepool_termination_duration_seconds': 'operator.nodepool.termination.duration_seconds',
}
