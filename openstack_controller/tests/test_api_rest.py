...
#         MockResponse(
#             file_path=os.path.join(
#                 get_here(), 'fixtures/http/neutron/networking/v2.0/quotas/667aee39f2b64032b4d7585809d31e6f.json'
#             ),
#             status_code=200,
#         ),
#     ]
...
#
#
# def test_rest_get_baremetal_response_time():
#     total_seconds = 0.0015
#     mocked_total_seconds = mock.MagicMock(return_value=total_seconds)
#     mocked_elapsed = mock.MagicMock()
#     mocked_elapsed.total_seconds = mocked_total_seconds
#     mocked_compute_response_time = MockResponse(
#         file_path=os.path.join(get_here(), 'fixtures/http/ironic/baremetal/get.json'),
#         status_code=200,
#     )
#     mocked_compute_response_time.elapsed = mocked_elapsed
#     mocked_http = mock.MagicMock()
...
#     api = make_api(config, logging, mocked_http)
#     api.create_connection()
#     compute_response_time = api.get_baremetal_response_time("667aee39f2b64032b4d7585809d31e6f")
#     mocked_http.get.assert_has_calls([mock.call('http://127.0.0.1:6385/baremetal')])
#     assert compute_response_time == total_seconds * 1000
#
#
