...
@mock.patch('datadog_checks.openstack_controller.api.AbstractApi._make_request', side_effect=make_request_responses)
def test_scenario(make_request, aggregator):
    ...
    with mock.patch(
        'datadog_checks.openstack_controller.scopes.KeystoneApi.post_auth_token', return_value=auth_tokens_response
    ):
        with mock.patch(
            ...
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute2.openstack.local', 'hypervisor_id:2', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
            ...
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute4.openstack.local', 'hypervisor_id:9', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute5.openstack.local', 'hypervisor_id:10', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
            ...
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute7.openstack.local', 'hypervisor_id:12', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute8.openstack.local', 'hypervisor_id:13', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
            ...
            aggregator.assert_metric(
                'openstack.nova.memory_mb',
                value=7982.0,
                tags=['hypervisor:compute10.openstack.local', 'hypervisor_id:15', 'virt_type:QEMU', 'status:enabled'],
                hostname='',
            )
            aggregator.assert_metric(
                'openstack.nova.server.rx_errors',
