...
PROJECTS = {u'projects': [
    {u'is_domain': False, u'description': u'Bootstrap project for initializing the cloud.',
...
def make_request_responses(url, header, params=None, timeout=None):
    if url == "http://10.0.2.15:5000/v3/projects":
        ...
        if params.get("tenant_id") == u'***************************d91a1':
            return {u'limits': {
                ...
                u'absolute': {u'maxServerMeta': 128, u'maxTotalInstances': 20, u'maxPersonality': 5,
                              u'totalServerGroupsUsed': 0, u'maxImageMeta': 128, u'maxPersonalitySize': 10240,
                              u'maxTotalRAMSize': 51200, u'maxServerGroups': 10, u'maxSecurityGroupRules': 20,
                              u'maxTotalKeypairs': 100, u'totalCoresUsed': 0, u'totalRAMUsed': 0,
                              u'maxSecurityGroups': 10, u'totalFloatingIpsUsed': 0, u'totalInstancesUsed': 0,
                              u'maxServerGroupMembers': 10, u'maxTotalFloatingIps': 10,
                              u'totalSecurityGroupsUsed': 0, u'maxTotalCores': 40}}}
            ...
            return {u'limits': {
                ...
                u'absolute': {u'maxServerMeta': 128, u'maxTotalInstances': 10, u'maxPersonality': 5,
                              ...
                              u'maxSecurityGroups': 10, u'totalFloatingIpsUsed': 0, u'totalInstancesUsed': 0,
                              u'maxServerGroupMembers': 10, u'maxTotalFloatingIps': 10,
                              u'totalSecurityGroupsUsed': 0, u'maxTotalCores': 20}}}
            ...
            return {u'limits': {
                ...
                u'absolute': {u'maxServerMeta': 128, u'maxTotalInstances': 20, u'maxPersonality': 5,
                              ...
                              u'maxSecurityGroups': 10, u'totalFloatingIpsUsed': 0, u'totalInstancesUsed': 1,
                              u'maxServerGroupMembers': 10, u'maxTotalFloatingIps': 10,
                              u'totalSecurityGroupsUsed': 1, u'maxTotalCores': 40}}}
            ...
            return {u'limits': {
                ...
                u'absolute': {u'maxServerMeta': 128, u'maxTotalInstances': 20, u'maxPersonality': 10,
                              ...
                              u'maxSecurityGroups': 10, u'totalFloatingIpsUsed': 0, u'totalInstancesUsed': 17,
                              u'maxServerGroupMembers': 10, u'maxTotalFloatingIps': 10,
                              u'totalSecurityGroupsUsed': 1, u'maxTotalCores': 40}}}
        ...
        return {u'hypervisors': [
            {u'status': u'enabled',
             u'service': {u'host': u'compute1', u'disabled_reason': None, u'id': 2},
             ...
             u'cpu_info': u'{"vendor": "Intel", "model": "Haswell-noTSX-IBRS", "arch": "x86_64", "features": ' +
                          u'["pge", "avx", "clflush", "sep", "syscall", "vme", "invpcid", "tsc", "fsgsbase", ' +
                          u'"xsave", "spec-ctrl", "vmx", "erms", "cmov", "smep", "ssse3", "pat", "lm", "msr", ' +
                          u'"nx", "fxsr", "sse4.1", "pae", "sse4.2", "pclmuldq", "fma", "tsc-deadline", "mmx", ' +
                          u'"osxsave", "cx8", "mce", "de", "rdtscp", "ht", "pse", "lahf_lm", "abm", "popcnt", ' +
                          u'"mca", "pdpe1gb", "apic", "sse", "f16c", "pni", "aes", "avx2", "sse2", "ss", ' +
                          u'"hypervisor", "bmi1", "bmi2", "pcid", "fpu", "cx16", "pse36", "mtrr", "movbe", ' +
                          u'"rdrand", "x2apic"], "topology": {"cores": 8, "cells": 1, "threads": 1, "sockets": 1}}',
             u'memory_mb_used': 4096},
            {u'status': u'enabled',
             u'service': {u'host': u'compute2', u'disabled_reason': None, u'id': 3},
            ...
            {u'status': u'enabled',
             u'service': {u'host': u'compute3', u'disabled_reason': None, u'id': 8},
             ...
             u'cpu_info': u'{"vendor": "Intel", "model": "Haswell-noTSX-IBRS", "arch": "x86_64", "features": ' +
                          u'["pge", "avx", "clflush", "sep", "syscall", "vme", "invpcid", "tsc", "fsgsbase", ' +
                          u'"xsave", "spec-ctrl", "vmx", "erms", "cmov", "smep", "ssse3", "pat", "lm", "msr", ' +
                          u'"nx", "fxsr", "sse4.1", "pae", "sse4.2", "pclmuldq", "ssbd", "fma", "tsc-deadline", ' +
                          u'"mmx", "osxsave", "cx8", "mce", "de", "rdtscp", "ht", "pse", "lahf_lm", "abm", ' +
                          u'"popcnt", "mca", "pdpe1gb", "apic", "sse", "f16c", "pni", "aes", "avx2", "sse2", "ss", ' +
                          u'"hypervisor", "bmi1", "bmi2", "pcid", "fpu", "cx16", "pse36", "mtrr", "movbe", ' +
                          u'"rdrand", "x2apic"], "topology": {"cores": 8, "cells": 1, "threads": 1, "sockets": 1}}',
             u'memory_mb_used': 2048},
            {u'status': u'enabled',
             u'service': {u'host': u'compute4', u'disabled_reason': None, u'id': 9},
             ...
             u'cpu_info': u'{"vendor": "Intel", "model": "Haswell-noTSX-IBRS", "arch": "x86_64", "features": ' +
                          ...
                          u'"popcnt", "mca", "pdpe1gb", "apic", "sse", "f16c", "pni", "aes", "avx2", "sse2", "ss", ' +
                          u'"hypervisor", "bmi1", "bmi2", "pcid", "fpu", "cx16", "pse36", "mtrr", "movbe", ' +
                          u'"rdrand", "x2apic"], "topology": {"cores": 8, "cells": 1, "threads": 1, ' +
                          u'"sockets": 1}}',
             u'memory_mb_used': 5120},
            {u'status': u'enabled',
             u'service': {u'host': u'compute5', u'disabled_reason': None, u'id': 10},
             ...
             u'memory_mb_used': 4096},
            {u'status': u'enabled',
             u'service': {u'host': u'compute6', u'disabled_reason': None, u'id': 11},
             ...
             u'memory_mb_used': 2048},
            {u'status': u'enabled',
             u'service': {u'host': u'compute7', u'disabled_reason': None, u'id': 12},
             ...
             u'cpu_info': u'{"vendor": "Intel", "model": "Haswell-noTSX-IBRS", "arch": "x86_64", "features": ' +
                          ...
                          u'"nx", "fxsr", "sse4.1", "pae", "sse4.2", "pclmuldq", "ssbd", "fma", "tsc-deadline", ' +
                          u'"mmx", "osxsave", "cx8", "mce", "de", "rdtscp", "ht", "pse", "lahf_lm", "abm", ' +
                          u'"popcnt", "mca", "pdpe1gb", "apic", "sse", "f16c", "pni", "aes", "avx2", "sse2", ' +
                          u'"ss", "hypervisor", "bmi1", "bmi2", "pcid", "fpu", "cx16", "pse36", "mtrr", "movbe", ' +
                          u'"rdrand", "x2apic"], "topology": {"cores": 8, "cells": 1, "threads": 1, "sockets": 1}}',
             u'memory_mb_used': 5120},
            {u'status': u'enabled',
             u'service': {u'host': u'compute8', u'disabled_reason': None, u'id': 13},
             ...
             u'memory_mb_used': 4096},
            {u'status': u'enabled',
             u'service': {u'host': u'compute9', u'disabled_reason': None, u'id': 14},
             ...
             u'memory_mb_used': 2048},
            {u'status': u'enabled',
             u'service': {u'host': u'compute10', u'disabled_reason': None, u'id': 15},
        ...
        return {u'aggregates': [
            {u'name': u'test-aggregate', u'availability_zone': u'nova', u'deleted': False,
             u'created_at': u'2018-10-05T00:37:02.000000', u'updated_at': None, u'hosts': [u'compute1'],
             u'deleted_at': None, u'id': 1, u'metadata': {u'availability_zone': u'nova'}}]}
    elif url == "http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/detail":
        return {u'servers': [
            {u'OS-EXT-STS:task_state': None,
             u'addresses': {
                 u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:fa:af:ec', u'version': 4, u'addr': u'10.0.0.29',
                            u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{
                 u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/57030997-f1b5-4f79-9429-8cb285318633',  # noqa E501
                 u'rel': u'self'},
                 {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/57030997-f1b5-4f79-9429-8cb285318633',  # noqa E501
                  u'rel': u'bookmark'}],
             u'image': {
                 u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                 u'links': [
                     {u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                      u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000049',
             u'OS-SRV-USG:launched_at': u'2018-09-06T17:58:33.000000',
             u'flavor': {u'id': u'10',
                         u'links': [
                             {u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                              u'rel': u'bookmark'}]},
             u'id': u'57030997-f1b5-4f79-9429-8cb285318633', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-09-06T17:58:33Z',
             u'hostId': u'1aad0cf1b6b677fd293b8d6a445ed37186ad540250ab3d93b309859b',
             u'OS-EXT-SRV-ATTR:host': u'compute4', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute4.openstack.local', u'name': u'blacklistServer',
             u'created': u'2018-09-06T17:57:38Z', u'tenant_id': u'***************************73dbe',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:fd:72:ff', u'version': 4, u'addr': u'10.0.0.27',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{
                 u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/7324440d-915b-4e12-8b85-ec8c9a524d6c',  # noqa E501
                 u'rel': u'self'},
                 {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/7324440d-915b-4e12-8b85-ec8c9a524d6c',  # noqa E501
                  u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{
                            u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                            u'rel': u'bookmark'}]}, u'OS-EXT-STS:vm_state': u'active',
             u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000048',
             u'OS-SRV-USG:launched_at': u'2018-09-06T17:54:56.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             ...
             u'tenant_id': u'***************************3fb11', u'os-extended-volumes:volumes_attached': [],
             u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None,
             u'addresses': {u'net3': [{
                 u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:0c:17:0e', u'version': 4, u'addr': u'10.0.0.26',
                 u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{
                 u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/836f724f-0028-4dc0-b9bd-e0843d767ca2',  # noqa E501
                 u'rel': u'self'},
                 {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/836f724f-0028-4dc0-b9bd-e0843d767ca2',  # noqa E501
                  u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000044',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:31:10.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{
                             u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                             u'rel': u'bookmark'}]}, u'id': u'836f724f-0028-4dc0-b9bd-e0843d767ca2',
             u'user_id': u'***************************50859', u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'',
             u'accessIPv6': u'', u'progress': 0, u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova',
             u'metadata': {}, u'status': u'ACTIVE', u'updated': u'2018-10-30T14:28:51Z',
             u'hostId': u'c457d054e8e619fe3bb0ff756ef7d7ff1adf84031379a91291984a32',
             u'OS-EXT-SRV-ATTR:host': u'compute7', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute7.openstack.local', u'name': u'finalDestination-8',
             u'created': u'2018-08-28T21:30:09Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:ca:63:58', u'version': 4, u'addr': u'10.0.0.11',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{
                 u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/1cc21586-8d43-40ea-bdc9-6f54a79957b4',  # noqa E501
                 u'rel': u'self'},
                 {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/1cc21586-8d43-40ea-bdc9-6f54a79957b4',  # noqa E501
                  u'rel': u'bookmark'}],
             ...
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:31:07.000000',
             u'flavor': {u'id': u'10', u'links': [{
                 u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10', u'rel': u'bookmark'}]},
             u'id': u'1cc21586-8d43-40ea-bdc9-6f54a79957b4', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:31:07Z',
             u'hostId': u'976f9000397fa853e174f15a55078a8297712a9c5005d2f6009af0ec',
             u'OS-EXT-SRV-ATTR:host': u'compute8', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute8.openstack.local', u'name': u'finalDestination-7',
             u'created': u'2018-08-28T21:30:09Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:fd:a9:fc', u'version': 4, u'addr': u'10.0.0.16',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/acb4197c-f54e-488e-a40a-1b7f59cc9117',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/acb4197c-f54e-488e-a40a-1b7f59cc9117',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             ...
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]}, u'id': u'acb4197c-f54e-488e-a40a-1b7f59cc9117',
             u'user_id': u'***************************50859', u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'',
             u'accessIPv6': u'', u'progress': 0, u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova',
             u'metadata': {}, u'status': u'ACTIVE', u'updated': u'2018-08-28T21:31:07Z',
             u'hostId': u'935f7d4e027a256785942c3e8173b02efc5a8a4531ede52d7871adb9',
             u'OS-EXT-SRV-ATTR:host': u'compute10', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute10.openstack.local', u'name': u'finalDestination-6',
             u'created': u'2018-08-28T21:30:09Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [{
                u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:18:51:79', u'version': 4, u'addr': u'10.0.0.21',
                u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/5357e70e-f12c-4bb7-85a2-b40d642a7e92',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/5357e70e-f12c-4bb7-85a2-b40d642a7e92',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000041',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:31:02.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'5357e70e-f12c-4bb7-85a2-b40d642a7e92', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:31:02Z',
             u'hostId': u'666fc5e7cbf246b9ea99396e890265fb556e8bc527308f93d76d10a3',
             u'OS-EXT-SRV-ATTR:host': u'compute5', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute5.openstack.local', u'name': u'finalDestination-5',
             u'created': u'2018-08-28T21:30:08Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None,
             u'addresses': {u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:90:46:f2', u'version': 4,
                                       u'addr': u'10.0.0.22', u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/7e622c28-4b12-4a58-8ac2-4a2e854f84eb',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/7e622c28-4b12-4a58-8ac2-4a2e854f84eb',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000040',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:31:28.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'7e622c28-4b12-4a58-8ac2-4a2e854f84eb', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-10-30T14:28:52Z',
             u'hostId': u'c457d054e8e619fe3bb0ff756ef7d7ff1adf84031379a91291984a32',
             u'OS-EXT-SRV-ATTR:host': u'compute7', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute7.openstack.local', u'name': u'finalDestination-4',
             u'created': u'2018-08-28T21:30:08Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:ff:4e:d6', u'version': 4, u'addr': u'10.0.0.3',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/52561f29-e479-43d7-85de-944d29ef178d',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/52561f29-e479-43d7-85de-944d29ef178d',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000003e',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:31:06.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'52561f29-e479-43d7-85de-944d29ef178d', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:31:06Z',
             u'hostId': u'976f9000397fa853e174f15a55078a8297712a9c5005d2f6009af0ec',
             u'OS-EXT-SRV-ATTR:host': u'compute8', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute8.openstack.local', u'name': u'finalDestination-2',
             u'created': u'2018-08-28T21:30:08Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [
                {u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:ea:21:2e', u'version': 4, u'addr': u'10.0.0.13',
                 u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/4d7cb923-788f-4b61-9061-abfc576ecc1a',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/4d7cb923-788f-4b61-9061-abfc576ecc1a',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000003d',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:30:45.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'4d7cb923-788f-4b61-9061-abfc576ecc1a', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-30T18:02:12Z',
             u'hostId': u'935f7d4e027a256785942c3e8173b02efc5a8a4531ede52d7871adb9',
             u'OS-EXT-SRV-ATTR:host': u'compute10', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute10.openstack.local', u'name': u'finalDestination-1',
             u'created': u'2018-08-28T21:30:08Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:94:44:4f', u'version': 4, u'addr': u'10.0.0.15',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{
                 u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/ff2f581c-5d03-4a27-a0ba-f102603fe38f',  # noqa E501
                 u'rel': u'self'},
                 {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/ff2f581c-5d03-4a27-a0ba-f102603fe38f',  # noqa E501
                  u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000003c',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:28:20.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{
                             u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                             u'rel': u'bookmark'}]},
             u'id': u'ff2f581c-5d03-4a27-a0ba-f102603fe38f', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:28:20Z',
             u'hostId': u'2e0f037ec53ab532b4d57191af2382d562a863f17ce66592c9bd7fa4',
             u'OS-EXT-SRV-ATTR:host': u'compute4', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute4.openstack.local', u'name': u'server_take_zero-2',
             u'created': u'2018-08-28T21:27:55Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:bb:13:9c', u'version': 4, u'addr': u'10.0.0.10',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/7eaa751c-1e37-4963-a836-0a28bc283a9a',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/7eaa751c-1e37-4963-a836-0a28bc283a9a',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000003b',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:28:44.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'7eaa751c-1e37-4963-a836-0a28bc283a9a', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:28:45Z',
             u'hostId': u'2e0f037ec53ab532b4d57191af2382d562a863f17ce66592c9bd7fa4',
             u'OS-EXT-SRV-ATTR:host': u'compute4', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute4.openstack.local', u'name': u'server_take_zero-1',
             u'created': u'2018-08-28T21:27:55Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [{
                u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:9f:25:1a', u'version': 4, u'addr': u'10.0.0.23',
                u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/4ceb4c69-a332-4b9d-907b-e99635aae644',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/4ceb4c69-a332-4b9d-907b-e99635aae644',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000003a',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:24:22.000000',
             u'flavor': {u'id': u'10', u'links': [{
                 u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10', u'rel': u'bookmark'}]},
             u'id': u'4ceb4c69-a332-4b9d-907b-e99635aae644', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-28T21:24:22Z',
             u'hostId': u'666fc5e7cbf246b9ea99396e890265fb556e8bc527308f93d76d10a3',
             u'OS-EXT-SRV-ATTR:host': u'compute5', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute5.openstack.local', u'name': u'moarserver-13',
             u'created': u'2018-08-28T21:23:08Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None,
             u'addresses': {u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:f3:33:58', u'version': 4,
                                       u'addr': u'10.0.0.14', u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/30888944-fb39-4590-9073-ef977ac1f039',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/30888944-fb39-4590-9073-ef977ac1f039',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000002d',
             u'OS-SRV-USG:launched_at': u'2018-08-28T21:04:22.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]}, u'id': u'30888944-fb39-4590-9073-ef977ac1f039',
             u'user_id': u'***************************50859', u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'',
             u'accessIPv6': u'', u'progress': 0, u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova',
             u'metadata': {}, u'status': u'ACTIVE', u'updated': u'2018-08-30T17:58:51Z',
             u'hostId': u'935f7d4e027a256785942c3e8173b02efc5a8a4531ede52d7871adb9',
             u'OS-EXT-SRV-ATTR:host': u'compute10', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute10.openstack.local', u'name': u'anotherServer',
             u'created': u'2018-08-28T21:03:57Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:f7:c5:e6', u'version': 4, u'addr': u'10.0.0.12',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/b3c8eee3-7e22-4a7c-9745-759073673cbe',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/b3c8eee3-7e22-4a7c-9745-759073673cbe',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000025',
             u'OS-SRV-USG:launched_at': u'2018-08-20T15:23:32.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'b3c8eee3-7e22-4a7c-9745-759073673cbe', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-10-30T14:28:29Z',
             u'hostId': u'4f626f6cfa8254516f9878d09dfd657cea28d7260eaa23dd65f5f138',
             u'OS-EXT-SRV-ATTR:host': u'compute2', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute2.openstack.local', u'name': u'jnrgjoner',
             u'created': u'2018-08-20T15:23:05Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {
                u'net3': [{u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:34:5e:38', u'version': 4, u'addr': u'10.0.0.5',
                           u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/412c79b2-25f2-44d6-8e3b-be4baee11a7f',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/412c79b2-25f2-44d6-8e3b-be4baee11a7f',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000024',
             u'OS-SRV-USG:launched_at': u'2018-08-16T22:46:46.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'412c79b2-25f2-44d6-8e3b-be4baee11a7f', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-31T17:32:20Z',
             u'hostId': u'4f626f6cfa8254516f9878d09dfd657cea28d7260eaa23dd65f5f138',
             u'OS-EXT-SRV-ATTR:host': u'compute2', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute2.openstack.local', u'name': u'ReadyServerOne',
             u'created': u'2018-08-16T22:46:24Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [{
                u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:25:1a:f2', u'version': 4, u'addr': u'10.0.0.7',
                u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/1b7a987f-c4fb-4b6b-aad9-3b461df2019d',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/1b7a987f-c4fb-4b6b-aad9-3b461df2019d',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-00000023',
             u'OS-SRV-USG:launched_at': u'2018-08-16T22:40:32.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'1b7a987f-c4fb-4b6b-aad9-3b461df2019d', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-10-30T14:28:58Z',
             u'hostId': u'4f626f6cfa8254516f9878d09dfd657cea28d7260eaa23dd65f5f138',
             u'OS-EXT-SRV-ATTR:host': u'compute2', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute2.openstack.local',
            ...
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [{
                ...
                u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/2e1ce152-b19d-4c4a-9cc7-0d150fa97a18',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/2e1ce152-b19d-4c4a-9cc7-0d150fa97a18',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000001c',
             u'OS-SRV-USG:launched_at': u'2018-08-16T22:09:40.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]}, u'id': u'2e1ce152-b19d-4c4a-9cc7-0d150fa97a18',
             u'user_id': u'***************************50859', u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'',
             u'accessIPv6': u'', u'progress': 0, u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova',
             u'metadata': {}, u'status': u'ACTIVE', u'updated': u'2018-08-30T17:57:11Z',
             u'hostId': u'afd50e73c26264d238f90ad731717d11d1b7dd31f04670c5cb2d1b7c',
             u'OS-EXT-SRV-ATTR:host': u'compute1', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute1.openstack.local', u'name': u'Rocky',
             u'created': u'2018-08-16T22:09:09Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''},
            {u'OS-EXT-STS:task_state': None, u'addresses': {u'net3': [{
                u'OS-EXT-IPS-MAC:mac_addr': u'fa:16:3e:39:02:af', u'version': 4, u'addr': u'10.0.0.6',
                u'OS-EXT-IPS:type': u'fixed'}]},
             u'links': [{u'href': u'http://10.0.2.15:8774/v2.1/***************************4bfc1/servers/f2dd3f90-e738-4135-84d4-1a2d30d04929',  # noqa E501
                         u'rel': u'self'},
                        {u'href': u'http://10.0.2.15:8774/***************************4bfc1/servers/f2dd3f90-e738-4135-84d4-1a2d30d04929',  # noqa E501
                         u'rel': u'bookmark'}],
             u'image': {u'id': u'88479e3e-2b19-4432-8eb0-d041e7ed6f8e',
                        u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/images/88479e3e-2b19-4432-8eb0-d041e7ed6f8e',  # noqa E501
                                    u'rel': u'bookmark'}]},
             u'OS-EXT-STS:vm_state': u'active', u'OS-EXT-SRV-ATTR:instance_name': u'instance-0000001b',
             u'OS-SRV-USG:launched_at': u'2018-08-16T21:31:03.000000',
             u'flavor': {u'id': u'10',
                         u'links': [{u'href': u'http://10.0.2.15:8774/***************************4bfc1/flavors/10',
                                     u'rel': u'bookmark'}]},
             u'id': u'f2dd3f90-e738-4135-84d4-1a2d30d04929', u'user_id': u'***************************50859',
             u'OS-DCF:diskConfig': u'AUTO', u'accessIPv4': u'', u'accessIPv6': u'', u'progress': 0,
             u'OS-EXT-STS:power_state': 1, u'OS-EXT-AZ:availability_zone': u'nova', u'metadata': {},
             u'status': u'ACTIVE', u'updated': u'2018-08-20T16:23:01Z',
             u'hostId': u'afd50e73c26264d238f90ad731717d11d1b7dd31f04670c5cb2d1b7c',
             u'OS-EXT-SRV-ATTR:host': u'compute1', u'OS-SRV-USG:terminated_at': None, u'key_name': None,
             u'OS-EXT-SRV-ATTR:hypervisor_hostname': u'compute1.openstack.local', u'name': u'jenga',
             u'created': u'2018-08-16T21:30:35Z', u'tenant_id': u'***************************3fb11',
             u'os-extended-volumes:volumes_attached': [], u'config_drive': u''}]}
    elif url == "http://10.0.2.15:5000/v3/projects/***************************73dbe":
        return {u'project': {u'is_domain': False, u'description': u'test project',
                             u'links': {
                                 u'self': u'http://10.0.2.15:5000/v3/projects/***************************73dbe'},
                             u'enabled': True, u'domain_id': u'default', u'parent_id': u'default',
                             u'id': u'***************************73dbe', u'name': u'testProj1'}}
        ...
        return {u'project': {u'is_domain': False, u'description': u'Bootstrap project for initializing the cloud.',
                             u'links': {
                                 u'self': u'http://10.0.2.15:5000/v3/projects/***************************3fb11'},
                             u'enabled': True, u'domain_id': u'default', u'parent_id': u'default',
                             u'id': u'***************************3fb11', u'name': u'admin'}}
        ...
        return {u'cpu1_time': 19270000000, u'tap8880f875-12_tx_errors': 0, u'tap8880f875-12_rx_packets': 174,
                ...
                u'tap8880f875-12_rx_drop': 0, u'cpu0_time': 6915020290000000, u'memory': 1048576,
                u'memory-rss': 147684, u'tap8880f875-12_rx_errors': 0, u'tap8880f875-12_tx': 0, u'vda_errors': -1,
                u'vda_read_req': 825}
...
AUTH_TOKENS_RESPONSE = {u'token': {u'is_domain': False, u'methods': [u'token', u'password'],
                                   u'roles': [{u'id': u'***************************91953',
                                               u'name': u'admin_read_only'}],
                                   ...
                                   u'catalog': [{u'endpoints': [{
                                       ...
                                       {u'endpoints': [{
                                           ...
                                           u'region_id': u'RegionOne', u'id': u'***************************9ed89'},
                                           {u'url': u'http://10.0.2.15:8774/v2.1/***************************4bfc1',
                                            u'interface': u'admin', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************e47a2'},
                                           {u'url': u'http://10.0.2.15:8774/v2.1/***************************4bfc1',
                                            u'interface': u'internal', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************b016b'},
                                           {u'url': u'http://10.0.2.15:8774/v2.1/***************************4bfc1',
                                            u'interface': u'public', u'region': None, u'region_id': None,
                                            u'id': u'***************************d7802'}],
                                       ...
                                       {u'endpoints': [{
                                           ...
                                           {u'url': u'http://10.0.2.15:9696', u'interface': u'admin',
                                            u'region': u'RegionOne', u'region_id': u'RegionOne',
                                            u'id': u'***************************8d1ca'},
                                           {u'url': u'http://10.0.2.15:9696', u'interface': u'public',
                                            u'region': None, u'region_id': None,
                                            u'id': u'***************************64be0'}],
                                           u'type': u'network', u'id': u'***************************9a6f4',
                                           u'name': u'neutron'},
                                       {u'endpoints': [{
                                           u'url': u'http://10.0.3.111:8776/v3/***************************4bfc1',
                                           u'interface': u'public', u'region': u'RegionOne',
                                           u'region_id': u'RegionOne', u'id': u'***************************89f4a'},
                                           {u'url': u'http://10.0.2.15:8776/v3/***************************4bfc1',
                                            u'interface': u'internal', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************d9fb1'},
                                           {u'url': u'http://10.0.2.15:8776/v3/***************************4bfc1',
                                            u'interface': u'admin', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************1b330'}],
                                           u'type': u'volumev3', u'id': u'***************************3ac57',
                                           u'name': u'cinderv3'},
                                       {u'endpoints': [{
                                           u'url': u'http://10.0.3.111:8776/v1/***************************4bfc1',
                                           u'interface': u'public', u'region': u'RegionOne',
                                           u'region_id': u'RegionOne', u'id': u'***************************2452f'},
                                           {u'url': u'http://10.0.2.15:8776/v1/***************************4bfc1',
                                            u'interface': u'admin', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************8239f'},
                                           {u'url': u'http://10.0.2.15:8776/v1/***************************4bfc1',
                                            u'interface': u'internal', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************7caa1'}],
                                       ...
                                       {u'endpoints': [
                                           ...
                                           {u'url': u'http://10.0.2.15:35357/v3', u'interface': u'admin',
                                            u'region': u'RegionOne', u'region_id': u'RegionOne',
                                            u'id': u'***************************f0cdb'}],
                                           u'type': u'identity', u'id': u'***************************17167',
                                           u'name': u'keystone'},
                                       {u'endpoints': [{
                                           ...
                                           {u'url': u'http://10.0.3.111:8776/v2/***************************4bfc1',
                                            u'interface': u'public', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************9b358'},
                                           {u'url': u'http://10.0.2.15:8776/v2/***************************4bfc1',
                                            u'interface': u'internal', u'region': u'RegionOne',
                                            u'region_id': u'RegionOne', u'id': u'***************************58920'}],
                                           u'type': u'volumev2', u'id': u'***************************cfa2d',
                                           u'name': u'cinderv2'}],
