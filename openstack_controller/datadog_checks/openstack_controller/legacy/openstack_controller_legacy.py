...
class OpenStackControllerLegacyCheck(AgentCheck):
    ...
    def collect_server_diagnostic_metrics(self, server_details, tags=None, use_shortname=False):
        ...
        try:
            ...
            return
        except (HttpException, HTTPClientStatusError) as e:
    ...
    def check(self, instance):
        ...
        except (HttpException, HTTPClientStatusError, HTTPClientTimeoutError, HTTPClientConnectionError) as e:
            status_code = get_http_status_code(e) if isinstance(e, (HttpException, HTTPClientStatusError)) else None
