...
def instance_domain_id(field, value):
    return 'default'
...
def instance_endpoint_interface(field, value):
    return 'public'


def instance_endpoint_region_id(field, value):
    return get_default_field_value(field, value)
...
def instance_ironic_microversion(field, value):
    return '1.8'
...
def instance_nova_microversion(field, value):
    return get_default_field_value(field, value)
