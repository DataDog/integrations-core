...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'teradata', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-teradata',
    version=ABOUT['__version__'],
    description='The Teradata check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent teradata check',
    ...
    packages=['datadog_checks.teradata'],
