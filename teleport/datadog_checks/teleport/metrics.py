...
AUTH_AUDIT_LOG_METRICS_MAP = {
    ...
    "teleport_audit_parquetlog_batch_processing_seconds": "audit_log.parquetlog_batch_processing_seconds",
    "teleport_audit_parquetlog_s3_flush_seconds": "audit_log.parquetlog_s3_flush_seconds",
    "teleport_audit_parquetlog_delete_events_seconds": "audit_log.parquetlog_delete_events_seconds",
    "teleport_audit_parquetlog_batch_size": "audit_log.parquetlog_batch_size",
    "teleport_audit_parquetlog_batch_count": "audit_log.parquetlog_batch_count",
    "teleport_audit_parquetlog_last_processed_timestamp": "audit_log.parquetlog_last_processed_timestamp",
    "teleport_audit_parquetlog_age_oldest_processed_message": "audit_log.parquetlog_age_oldest_processed_message",
    "teleport_audit_parquetlog_errors_from_collect_count": "audit_log.parquetlog_errors_from_collect_count",
}
