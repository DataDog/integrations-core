...
AUTH_AUDIT_LOG_METRICS = [
    ...
    "audit_log.parquetlog_batch_processing_seconds.bucket",
    "audit_log.parquetlog_batch_processing_seconds.count",
    "audit_log.parquetlog_batch_processing_seconds.sum",
    "audit_log.parquetlog_s3_flush_seconds.bucket",
    "audit_log.parquetlog_s3_flush_seconds.count",
    "audit_log.parquetlog_s3_flush_seconds.sum",
    "audit_log.parquetlog_delete_events_seconds.bucket",
    "audit_log.parquetlog_delete_events_seconds.count",
    "audit_log.parquetlog_delete_events_seconds.sum",
    "audit_log.parquetlog_batch_size.bucket",
    "audit_log.parquetlog_batch_size.count",
    "audit_log.parquetlog_batch_size.sum",
    "audit_log.parquetlog_batch_count.count",
    "audit_log.parquetlog_errors_from_collect_count.count",
]
