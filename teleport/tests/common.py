...
AUTH_AUDIT_LOG_METRICS = [
    "audit_log.failed_disk_monitoring.count",
    "audit_log.failed_emit_events.count",
    "audit_log.emit_events.count",
    "audit_log.parquetlog.batch_processing_seconds.bucket",
    "audit_log.parquetlog.batch_processing_seconds.count",
    "audit_log.parquetlog.batch_processing_seconds.sum",
    "audit_log.parquetlog.s3_flush_seconds.bucket",
    "audit_log.parquetlog.s3_flush_seconds.count",
    "audit_log.parquetlog.s3_flush_seconds.sum",
    "audit_log.parquetlog.delete_events_seconds.bucket",
    "audit_log.parquetlog.delete_events_seconds.count",
    "audit_log.parquetlog.delete_events_seconds.sum",
    "audit_log.parquetlog.batch_size.bucket",
    "audit_log.parquetlog.batch_size.count",
    "audit_log.parquetlog.batch_size.sum",
    "audit_log.parquetlog.batch_count.count",
    "audit_log.parquetlog.errors_from_collect_count.count",
]
...
KUBERNETES_METRICS = [
    ...
    "kubernetes.server.in_flight_requests",
    "kubernetes.server.api_requests.count",
    "kubernetes.server.request_duration_seconds.bucket",
    "kubernetes.server.request_duration_seconds.count",
    "kubernetes.server.request_duration_seconds.sum",
    "kubernetes.server.response_size_bytes.bucket",
    "kubernetes.server.response_size_bytes.count",
    "kubernetes.server.response_size_bytes.sum",
    "kubernetes.server.exec_in_flight_sessions",
    "kubernetes.server.exec_sessions.count",
    "kubernetes.server.portforward_in_flight_sessions",
    "kubernetes.server.portforward_sessions.count",
