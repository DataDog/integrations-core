...
def test_unit(dd_run_check, check, instance, mock_http_client, aggregator):
...
def test_unit_query_metrics(dd_run_check, check, instance_query, mock_http_client, aggregator):
    mock_http_client.get.side_effect = mock_http_responses
