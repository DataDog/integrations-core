...
| `disable_ssl_validation`   | Disables HTTPS certificate validation. If set to `true` this will skip the validation of the SSL certificate of the URL being tested. |
