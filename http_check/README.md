...
**Note:** To monitor HTTP error codes (such as 404) or view the first 400 characters of an HTTP response, create a [Network Monitor][1] based on these service checks.
