...
def instance_check_certificate_expiration(_field, _value):
    return True
...
def instance_http_response_status_code(_field, _value):
    return '(1|2|3)\\d\\d'


def instance_include_content(_field, _value):
    return False


def instance_include_default_headers(_field, _value):
    return True
...
def instance_method(_field, _value):
    return 'get'
...
def instance_reverse_content_match(_field, _value):
    return False
...
def instance_stream(_field, _value):
    return False
...
def instance_tls_retrieve_non_validated_cert(_field, _value):
    return False
