...
setup(
    ...
    packages=['check', 'datadog.http_check'],
    ...
    package_data={b'datadog.http_check': ['http_datadog.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'http_check=datadog.http_check:main',
        ],
    },
)
