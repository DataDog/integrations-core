...
setup(
    ...
    packages=['dd_integrations.http_check'],
    ...
    package_data={b'dd_integrations.http_check': ['http_dd_integrations.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'http_check=dd_integrations.http_check:main',
        ],
    },
)
