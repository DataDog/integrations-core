...
class SecurityMonitoringCheck(AgentCheck):
    def __init__(self, name, init_config, instances):
        # super(SecurityMonitoringCheck, self).__init__(name, init_config, instances)
    ...
    def check(self, _):
        ...
        # except Timeout as e:
        #     self.service_check(
        #         "security_monitoring.can_connect",
        #         AgentCheck.CRITICAL,
        ...
        #     self.service_check(
        #         "security_monitoring.can_connect", AgentCheck.CRITICAL, message=str(e)
        #     )
        #     raise
        ...
        # self.service_check("security_monitoring.can_connect", AgentCheck.OK)
