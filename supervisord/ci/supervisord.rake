...
namespace :ci do
  namespace :supervisord do |flavor|
    ...
    task install: ['ci:common:install'] do
      ...
      # sample docker usage
      # sh %(docker create -p XXX:YYY --name supervisord source/supervisord:supervisord_version)
      # sh %(docker start supervisord)
    end
    ...
    #   sh %(docker stop supervisord)
    #   sh %(docker rm supervisord)
    # end
