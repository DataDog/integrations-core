...
METRIC_MAP = {
    ...
    'queue_job_completed_total': 'queue.job.completed.total',
    'queue_job_delayed_total': 'queue.job.delayed.total',
    'queue_job_dequeued_total': 'queue.job.dequeued.total',
    'queue_job_enqueued_total': 'queue.job.enqueued.total',
    'queue_job_failed_total': 'queue.job.failed.total',
