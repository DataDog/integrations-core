...
METRIC_MAP = {
    ...
    'cache_errors': 'cache.errors.count',
    'cache_hits': 'cache.hits.count',
    'cache_latency_seconds': 'cache.latency.seconds',
    'cache_misses': 'cache.misses.count',
    'cache_operations': 'cache.operations.count',
    'eventbus_connections_total': 'eventbus.connections.total',
    'eventbus_events_failed': 'eventbus.events.failed.count',
    'eventbus_events_processed': 'eventbus.events.processed.count',
    'eventbus_events': 'eventbus.events.count',
    ...
    'process_cpu_system_seconds': 'process.cpu.system.seconds.count',
    ...
    'queue_job_attempts': 'queue.job.attempts.count',
    'queue_job_completed': 'queue.job.completed.count',
    'queue_job_delayed_total': 'queue.job.delayed.total',
    'queue_job_dequeued': 'queue.job.dequeued.count',
    'queue_job_enqueued': 'queue.job.enqueued.count',
    'queue_job_failed': 'queue.job.failed.count',
    ...
    'workflow_executions': 'workflow.executions.count',
    'workflow_failed': 'workflow.failed.count',
    'workflow_started': 'workflow.started.count',
    'workflow_success': 'workflow.success.count',
    'process_cpu_seconds': 'process.cpu.seconds.count',
