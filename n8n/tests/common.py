...
E2E_METRICS = [
    ...
    'n8n.cache.misses',
    'n8n.cache.operations',
    'n8n.eventbus.connections.total',
    'n8n.eventbus.events.failed',
    'n8n.eventbus.events.processed',
    'n8n.eventbus.events',
    ...
    'n8n.process.cpu.system.seconds',
    'n8n.process.cpu.user.seconds',
