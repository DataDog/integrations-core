...
RARE_EVENT_METRIC_NAMES = frozenset(
    {
        'n8n.ai.document.processed.count',
        'n8n.ai.embeddings.embedded.document.count',
        'n8n.ai.embeddings.embedded.query.count',
        'n8n.ai.llm.error.count',
        'n8n.ai.llm.generated.count',
        'n8n.ai.memory.added.message.count',
        'n8n.ai.memory.get.messages.count',
        'n8n.ai.output.parser.parsed.count',
        'n8n.ai.retriever.get.relevant.documents.count',
        'n8n.ai.text.splitter.split.count',
        'n8n.ai.tool.called.count',
        'n8n.ai.vector.store.populated.count',
        'n8n.ai.vector.store.searched.count',
        'n8n.ai.vector.store.updated.count',
        'n8n.audit.execution.data.reveal_failure.count',
        'n8n.audit.execution.data.revealed.count',
        'n8n.audit.package.deleted.count',
        'n8n.audit.package.installed.count',
        'n8n.audit.package.updated.count',
        'n8n.audit.user.api.created.count',
        'n8n.audit.user.api.deleted.count',
        'n8n.audit.user.credentials.created.count',
        'n8n.audit.user.credentials.deleted.count',
        'n8n.audit.user.credentials.shared.count',
        'n8n.audit.user.credentials.updated.count',
        'n8n.audit.user.deleted.count',
        'n8n.audit.user.email.failed.count',
        'n8n.audit.user.execution.deleted.count',
        'n8n.audit.user.invitation.accepted.count',
        'n8n.audit.user.invited.count',
        'n8n.audit.user.login.failed.count',
        'n8n.audit.user.login.success.count',
        'n8n.audit.user.mfa.disabled.count',
        'n8n.audit.user.mfa.enabled.count',
        'n8n.audit.user.reinvited.count',
        'n8n.audit.user.reset.count',
        'n8n.audit.user.reset.requested.count',
        'n8n.audit.user.signedup.count',
        'n8n.audit.user.updated.count',
        'n8n.audit.variable.created.count',
        'n8n.audit.variable.deleted.count',
        'n8n.audit.variable.updated.count',
        ...
        'n8n.runner.response.received.count',
        'n8n.runner.task.requested.count',
        'n8n.token.exchange.failures.count',
        'n8n.workflow.cancelled.count',
    }
)
