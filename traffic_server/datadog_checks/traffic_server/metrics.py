...
GAUGE_METRICS = {
    ...
    "proxy.process.ssl.ssl_ocsp_refreshed_cert": "process.ssl.ssl_ocsp_refreshed_cert",
    "proxy.process.ssl.ssl_ocsp_refresh_cert_failure": "process.ssl.ssl_ocsp_refresh_cert_failure",
