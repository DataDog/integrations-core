...
from .common import METRICS, TLS
...
@pytest.mark.skipif(TLS, reason="Non-TLS FoundationDB cluster only.")
...
@pytest.mark.skipif(not TLS, reason="TLS FoundationDB cluster only.")
@pytest.mark.usefixtures("dd_environment")
