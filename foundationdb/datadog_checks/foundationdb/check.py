...
class FoundationdbCheck(AgentCheck):
    ...
    def construct_database(self):
        ...
        if 'tls_certificate_file' in self.instance:
            ...
            fdb.options.set_tls_cert_path(self.os.validate_path(self.instance.get('tls_certificate_file')))
        ...
        if 'tls_key_file' in self.instance:
            fdb.options.set_tls_key_path(self.os.validate_path(self.instance.get('tls_key_file')))
        ...
        if 'cluster_file' in self.instance:
            self._db = fdb.open(cluster_file=self.os.validate_path(self.instance.get('cluster_file')))
        else:
            self._db = fdb.open()
