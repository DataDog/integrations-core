...
* Total Consul peers
* Services - given a service, how many of its nodes are up, passing, warning, critical?
* Nodes - given a node, how many of its services are up, passing, warning, critical?
