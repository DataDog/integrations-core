...
class ConsulCheck(OpenMetricsBaseCheck):
    ...
    def _check_prometheus_endpoint(self):
        ...
        # /v1/agent/metrics is available since 0.9.1, but /v1/agent/metrics?format=prometheus is available since 1.1.0
            ...
            # HTTPClientRequestError is the translator's fallthrough type and subsumes HTTPClientInvalidURLError,
            ...
            if isinstance(e, (HTTPClientTimeoutError, HTTPClientConnectionError)):
                raise
            self.log.warning(
