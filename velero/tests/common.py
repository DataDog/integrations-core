...
TEST_METRICS = {
    'velero.go.gc_duration_seconds.quantile': 'gauge',
    'velero.go.gc_duration_seconds.sum': 'monotonic_count',
    'velero.go.gc_duration_seconds.count': 'monotonic_count',
    ...
    'velero.go.memstats.buck_hash_sys_bytes': 'gauge',
    'velero.go.memstats.frees.count': 'monotonic_count',
    'velero.go.memstats.gc_sys_bytes': 'gauge',
    ...
    'velero.go.memstats.next_gc_bytes': 'gauge',
    'velero.go.memstats.other_sys_bytes': 'gauge',
    ...
    'velero.podVolume.pod_volume_backup.dequeue.count': 'monotonic_count',
    'velero.podVolume.pod_volume_backup.enqueue.count': 'monotonic_count',
    'velero.process.cpu_seconds.count': 'monotonic_count',
    'velero.process.max_fds': 'gauge',
    'velero.process.open_fds': 'gauge',
    'velero.process.resident_memory_bytes': 'gauge',
    'velero.process.start_time_seconds': 'gauge',
    ...
    # 'velero.backup.duration_seconds.bucket': 'monotonic_count',
    # 'velero.backup.duration_seconds.sum': 'monotonic_count',
    # 'velero.backup.duration_seconds.count': 'monotonic_count',
