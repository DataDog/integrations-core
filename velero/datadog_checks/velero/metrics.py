...
METRIC_MAP = {
    **DEFAULT_GO_METRICS,
    ...
    'podVolume_pod_volume_operation_latency_seconds': 'pod_volume.operation_latency_seconds',
    'podVolume_pod_volume_operation_latency_seconds_gauge': 'pod_volume.operation_latency_seconds.gauge',
