...
METRIC_MAP = {
    ...
    'velero_backup_duration_seconds_bucket': 'backup.duration_seconds.bucket',
    'velero_backup_duration_seconds_sum': 'backup.duration_seconds.sum',
    'velero_backup_duration_seconds_count': 'backup.duration_seconds',
