...
2. Make sure that stats are enabled on your HAProxy configuration. [See this post for guidance on doing this](https://www.datadoghq.com/blog/how-to-collect-haproxy-metrics/).
