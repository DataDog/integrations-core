...
V3_6_PLUS_METRICS = {
    ...
    'argo_workflows_cronworkflows_triggered_total': 'cronworkflows.triggered_total',
    ...
    'argo_workflows_pods_total_count': 'pods.total',
    ...
    'argo_workflows_workflowtemplate_triggered_total': 'workflowtemplate.triggered',
}
