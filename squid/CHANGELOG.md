...
* Add container-based config discovery support. ([#24491](https://github.com/DataDog/integrations-core/pull/24491))
...
* Add `pyproject.toml` file ([#11438](https://github.com/DataDog/integrations-core/pull/11438))
...
* Add runtime configuration validation ([#8988](https://github.com/DataDog/integrations-core/pull/8988))
...
* [Squid] Allow https ([#8122](https://github.com/DataDog/integrations-core/pull/8122))
...
* Fix version collection ([#7898](https://github.com/DataDog/integrations-core/pull/7898))

## 1.8.0 / 2020-09-21 / Agent 7.23.0

***Added***:

* Add config specs ([#7482](https://github.com/DataDog/integrations-core/pull/7482))
...
* Fix formatting of a log line ([#6990](https://github.com/DataDog/integrations-core/pull/6990))
...
* Add version metadata ([#5603](https://github.com/DataDog/integrations-core/pull/5603))

## 1.4.1 / 2019-11-07 / Agent 7.16.0

***Fixed***:

* Adding log section ([#4824](https://github.com/DataDog/integrations-core/pull/4824))
...
* Add requests wrapper to squid ([#4200](https://github.com/DataDog/integrations-core/pull/4200))

## 1.2.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3568](https://github.com/DataDog/integrations-core/pull/3568))
