...
TASK_RUN_METRICS = {
    ...
    "task_runs.pending": "gauge",
    "task_runs.running": "gauge",
    "task_runs.throughput": "count",
    "task_runs.paused": "gauge",
