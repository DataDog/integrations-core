...
ALL_METRIC_CASES = [
    ...
    ("prefect.server.flow_runs.pending.count", 2.0, TAGS_F2, "flow_runs-pending-f2", 1),
    ("prefect.server.flow_runs.scheduled.count", 1.0, TAGS_F1, "flow_runs-scheduled-f1", 1),
    ...
    # ("prefect.server.flow_runs.late_start.rate", 2.0 / 6.0, TAGS_F2, "flow_runs-late_start-rate-f2", 1),
    ...
    ("prefect.server.task_runs.pending.count", 1.0, TAGS_TR1, "task_runs-pending-tr1", 1),
    ("prefect.server.task_runs.paused.count", 1.0, TAGS_TR8, "task_runs-paused-tr8", 1),
