...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'nvidia_triton', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-nvidia_triton',
    version=ABOUT['__version__'],
    description='The Nvidia Triton check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent nvidia_triton check',
    ...
    packages=['datadog_checks.nvidia_triton'],
