...
def test_upgrade_skips_for_dev_versions(app, tmp_path, mock_get, mocker):
    cache_file = tmp_path / "upgrade_check.json"
...
def test_upgrade_fetches_from_pypi_and_notifies_when_upgrade_available(app, tmp_path, mock_get, mocker):
...
def test_upgrade_uses_cache_when_fresh(app, tmp_path, mock_get, mocker):
...
def test_upgrade_no_notification_when_up_to_date(app, tmp_path, mock_get, mocker):
...
def test_upgrade_handles_request_exception_gracefully(app, tmp_path, mocker):
