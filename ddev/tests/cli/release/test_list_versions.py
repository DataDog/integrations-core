...
def test_list_versions(ddev, repository, helpers, network_replay):
    network_replay('network/list_versions/success_disk.yaml', record_mode='none')
...
def test_list_versions_header(ddev, repository, helpers, network_replay):
    network_replay('network/list_versions/success_datadog_checks_base.yaml', record_mode='none')
