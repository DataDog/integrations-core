...
from ddev.utils._compat_fs import write_file_lines
from ddev.tooling.commands.console import CONTEXT_SETTINGS, echo_failure, echo_info, echo_success
from ddev.tooling.constants import AGENT_V5_ONLY, get_agent_release_requirements
from ddev.tooling.release import get_agent_requirement_line
