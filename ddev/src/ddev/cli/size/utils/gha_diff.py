...
def display_diffs_to_html_short(diffs, platform, python_version):
    ...
    text += f"Total added: \n&emsp +{convert_to_human_readable_size(total_added_compressed)} (Compressed) "
    text += f"\n&emsp +{convert_to_human_readable_size(total_added_uncompressed)} (Uncompressed)\n"
    text += f"Total removed: \n&emsp -{convert_to_human_readable_size(total_removed_compressed)} (Compressed)"
    text += f"\n&emsp -{convert_to_human_readable_size(total_removed_uncompressed)} (Uncompressed)\n"
    text += f"Total changed: \n&emsp {total_changed_sign}"
