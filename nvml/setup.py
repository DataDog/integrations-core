...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'nvml', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent nvml check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-core',
    # Author details
    author='Jack Lindamood',
    author_email='cep221@gmail.com',
    # License
