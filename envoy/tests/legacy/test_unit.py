...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            HTTPClientTimeoutError('timed out'),
        ...
        pytest.param(
            HTTPClientRequestError('Req Exception'),
            (
