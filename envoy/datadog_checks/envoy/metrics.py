...
from .utils import create_metric_from_partial, make_metric_tree
...
partial_metrics = {
    'monotonic_count': [
        '_assignment_stale',
        '_assignment_timeout_received',
        '_assignment_use_cached',
        '_bind_errors',
        '_client_ssl_socket_factory_downstream_context_secrets_not_ready',
        '_client_ssl_socket_factory_ssl_context_update_by_sds',
        '_client_ssl_socket_factory_upstream_context_secrets_not_ready',
        '_default_total_match_count',
        '_ext_authz_authenticator_denied',
        '_ext_authz_authenticator_error',
        '_ext_authz_authenticator_failure_mode_allowed',
        '_ext_authz_authenticator_ok',
        '_ext_authz_terminator_error',
        '_ext_authz_terminator_ok',
        '_external_upstream_rq',
        '_external_upstream_rq_completed',
        '_external_upstream_rq_xx',
        '_health_check_attempt',
        '_health_check_failure',
        '_health_check_network_failure',
        '_health_check_passive_failure',
        '_health_check_success',
        '_health_check_verify_cluster',
        '_http2_dropped_headers_with_underscores',
        '_http2_goaway_sent',
        '_http2_header_overflow',
        '_http2_headers_cb_no_stream',
        '_http2_inbound_empty_frames_flood',
        '_http2_inbound_priority_frames_flood',
        '_http2_inbound_window_update_frames_flood',
        '_http2_keepalive_timeout',
        '_http2_metadata_empty_frames',
        '_http2_outbound_control_flood',
        '_http2_outbound_flood',
        '_http2_requests_rejected_with_underscores_in_headers',
        '_http2_rx_messaging_error',
        '_http2_rx_reset',
        '_http2_stream_refused_errors',
        '_http2_trailers',
        '_http2_tx_flush_timeout',
        '_http2_tx_reset',
        '_init_fetch_timeout',
        '_internal_upstream_rq',
        '_internal_upstream_rq_completed',
        '_internal_upstream_rq_xx',
        '_lb_healthy_panic',
        '_lb_local_cluster_not_ok',
        '_lb_recalculate_zone_structures',
        '_lb_subsets_created',
        '_lb_subsets_fallback',
        '_lb_subsets_fallback_panic',
        '_lb_subsets_removed',
        '_lb_subsets_selected',
        '_lb_zone_cluster_too_small',
        '_lb_zone_no_capacity_left',
        '_lb_zone_number_differs',
        '_lb_zone_routing_all_directly',
        '_lb_zone_routing_cross_zone',
        '_lb_zone_routing_sampled',
        '_membership_change',
        '_original_dst_host_invalid',
        '_outlier_detection_ejections_consecutive_5xx',
        '_outlier_detection_ejections_detected_consecutive_5xx',
        '_outlier_detection_ejections_detected_consecutive_gateway_failure',
        '_outlier_detection_ejections_detected_consecutive_local_origin_failure',
        '_outlier_detection_ejections_detected_failure_percentage',
        '_outlier_detection_ejections_detected_local_origin_failure_percentage',
        '_outlier_detection_ejections_detected_local_origin_success_rate',
        '_outlier_detection_ejections_detected_success_rate',
        '_outlier_detection_ejections_enforced_consecutive_5xx',
        '_outlier_detection_ejections_enforced_consecutive_gateway_failure',
        '_outlier_detection_ejections_enforced_consecutive_local_origin_failure',
        '_outlier_detection_ejections_enforced_failure_percentage',
        '_outlier_detection_ejections_enforced_local_origin_failure_percentage',
        '_outlier_detection_ejections_enforced_local_origin_success_rate',
        '_outlier_detection_ejections_enforced_success_rate',
        '_outlier_detection_ejections_enforced_total',
        '_outlier_detection_ejections_overflow',
        '_outlier_detection_ejections_success_rate',
        '_outlier_detection_ejections_total',
        '_ratelimit_error',
        '_ratelimit_failure_mode_allowed',
        '_ratelimit_ok',
        '_ratelimit_over_limit',
        '_retry_or_shadow_abandoned',
        '_ssl_ciphers_TLS_AES_128_GCM_SHA256',
        '_ssl_connection_error',
        '_ssl_curves',
        '_ssl_fail_verify_cert_hash',
        '_ssl_fail_verify_error',
        '_ssl_fail_verify_no_cert',
        '_ssl_fail_verify_san',
        '_ssl_handshake',
        '_ssl_no_certificate',
        '_ssl_ocsp_staple_failed',
        '_ssl_ocsp_staple_omitted',
        '_ssl_ocsp_staple_requests',
        '_ssl_ocsp_staple_responses',
        '_ssl_session_reused',
        '_ssl_sigalgs',
        '_ssl_versions',
        '_ssl_was_key_usage_invalid',
        '_update_attempt',
        '_update_empty',
        '_update_failure',
        '_update_no_rebuild',
        '_update_rejected',
        '_update_success',
        '_upstream_cx_close_notify',
        '_upstream_cx_connect_attempts_exceeded',
        '_upstream_cx_connect_fail',
        '_upstream_cx_connect_timeout',
        '_upstream_cx_connect_with_0_rtt',
        '_upstream_cx_destroy',
        '_upstream_cx_destroy_local',
        '_upstream_cx_destroy_local_with_active_rq',
        '_upstream_cx_destroy_remote',
        '_upstream_cx_destroy_remote_with_active_rq',
        '_upstream_cx_destroy_with_active_rq',
        '_upstream_cx_http1_total',
        '_upstream_cx_http2_total',
        '_upstream_cx_http3_total',
        '_upstream_cx_idle_timeout',
        '_upstream_cx_max_duration_reached',
        '_upstream_cx_max_requests',
        '_upstream_cx_none_healthy',
        '_upstream_cx_overflow',
        '_upstream_cx_pool_overflow',
        '_upstream_cx_protocol_error',
        '_upstream_cx_rx_bytes_total',
        '_upstream_cx_total',
        '_upstream_cx_tx_bytes_total',
        '_upstream_flow_control_backed_up_total',
        '_upstream_flow_control_drained_total',
        '_upstream_flow_control_paused_reading_total',
        '_upstream_flow_control_resumed_reading_total',
        '_upstream_http3_broken',
        '_upstream_internal_redirect_failed_total',
        '_upstream_internal_redirect_succeeded_total',
        '_upstream_rq',
        '_upstream_rq_0rtt',
        '_upstream_rq_cancelled',
        '_upstream_rq_completed',
        '_upstream_rq_maintenance_mode',
        '_upstream_rq_max_duration_reached',
        '_upstream_rq_pending_failure_eject',
        '_upstream_rq_pending_overflow',
        '_upstream_rq_pending_total',
        '_upstream_rq_per_try_idle_timeout',
        '_upstream_rq_per_try_timeout',
        '_upstream_rq_retry',
        '_upstream_rq_retry_backoff_exponential',
        '_upstream_rq_retry_backoff_ratelimited',
        '_upstream_rq_retry_limit_exceeded',
        '_upstream_rq_retry_overflow',
        '_upstream_rq_retry_success',
        '_upstream_rq_rx_reset',
        '_upstream_rq_timeout',
        '_upstream_rq_total',
    ...
    'histogram': [
        ...
        '_upstream_cx_length_ms',
        '_upstream_rq_time',
    ],
    'gauge': [
        '_circuit_breakers_default_cx_open',
        '_circuit_breakers_default_cx_pool_open',
        '_circuit_breakers_default_rq_open',
        '_circuit_breakers_default_rq_pending_open',
        '_circuit_breakers_default_rq_retry_open',
        '_circuit_breakers_high_cx_open',
        '_circuit_breakers_high_cx_pool_open',
        '_circuit_breakers_high_rq_open',
        '_circuit_breakers_high_rq_pending_open',
        '_circuit_breakers_high_rq_retry_open',
        '_health_check_degraded',
        '_health_check_healthy',
        '_http2_deferred_stream_close',
        '_http2_outbound_control_frames_active',
        '_http2_outbound_frames_active',
        '_http2_pending_send_bytes',
        '_http2_streams_active',
        '_lb_subsets_active',
        '_lb_subsets_single_host_per_subset_duplicate',
        '_max_host_weight',
        '_membership_degraded',
        '_membership_excluded',
        '_membership_healthy',
        '_membership_total',
        '_outlier_detection_ejections_active',
        '_update_time',
        '_upstream_cx_active',
        '_upstream_cx_rx_bytes_buffered',
        '_upstream_cx_tx_bytes_buffered',
        '_upstream_rq_active',
...
if PY3:
    # This is only with OMv2 so it's Python3 only
