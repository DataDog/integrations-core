...
def instance_cache_metrics(_field, _value):
    return True
...
def instance_collect_server_info(_field, _value):
    return True
...
def instance_openmetrics_endpoint(_field, _value):
    return 'http://localhost:80/stats/prometheus'


def instance_parse_unknown_metrics(_field, _value):
    return False
...
def instance_stats_url(_field, _value):
