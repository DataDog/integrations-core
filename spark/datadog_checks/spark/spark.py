...
SPARK_STAGE_METRICS = {
    ...
    'executorDeserializeTime': ('spark.stage.executor_deserialize_time', COUNT),
    'executorDeserializeCpuTime': ('spark.stage.executor_deserialize_cpu_time', COUNT),
    'executorRunTime': ('spark.stage.executor_run_time', COUNT),
    'executorCpuTime': ('spark.stage.executor_cpu_time', COUNT),
    'resultSize': ('spark.stage.result_size', GAUGE),
    'jvmGcTime': ('spark.stage.jvm_gc_time', COUNT),
    'resultSerializationTime': ('spark.stage.result_serialization_time', COUNT),
    'peakExecutionMemory': ('spark.stage.peak_execution_memory', COUNT),
    ...
    'shuffleRemoteBlocksFetched': ('spark.stage.shuffle_remote_blocks_fetched', COUNT),
    'shuffleLocalBlocksFetched': ('spark.stage.shuffle_local_blocks_fetched', COUNT),
    'shuffleFetchWaitTime': ('spark.stage.shuffle_fetch_wait_time', COUNT),
    'shuffleRemoteBytesRead': ('spark.stage.shuffle_remote_bytes_read', COUNT),
    'shuffleRemoteBytesReadToDisk': ('spark.stage.shuffle_remote_bytes_read_to_disk', COUNT),
    'shuffleLocalBytesRead': ('spark.stage.shuffle_local_bytes_read', COUNT),
    ...
    'shuffleWriteTime': ('spark.stage.shuffle_write_time', COUNT),
