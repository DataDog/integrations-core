...
def instance_enable_query_name_tag(_field, _value):
    return False


def instance_executor_level_metrics(_field, _value):
    return False
...
def instance_metricsservlet_path(_field, _value):
    return '/metrics/json'
...
def instance_spark_cluster_mode(_field, _value):
    return 'spark_yarn_mode'


def instance_spark_pre_20_mode(_field, _value):
    return False


def instance_spark_proxy_enabled(_field, _value):
    return False
...
def instance_streaming_metrics(_field, _value):
    return True
