...
BASE_METRICS = {
    ...
    'service_latency_seconds': 'service.latency.seconds',
    'service_latency_nouserlatency': 'service.latency.nouserlatency',
    'service_latency_nouserlatency_milliseconds': 'service.latency.nouserlatency',
    'service_latency_nouserlatency_seconds': 'service.latency.nouserlatency.seconds',
    'service_latency_userlatency': 'service.latency.userlatency',
    'service_latency_userlatency_milliseconds': 'service.latency.userlatency',
    'service_latency_userlatency_seconds': 'service.latency.userlatency.seconds',
    'service_authorization_latency': 'service.authorization_latency',
    'service_authorization_latency_milliseconds': 'service.authorization_latency',
    'service_authorization_latency_seconds': 'service.authorization_latency.seconds',
    'service_dial_latency': 'service.dial_latency',
    'service_dial_latency_milliseconds': 'service.dial_latency',
    'service_dial_latency_seconds': 'service.dial_latency.seconds',
    'action': 'action',
    'certificates_expired': 'certificates.expired',
    'certificates_expiring': 'certificates.expiring',
    'event_blob_size': 'event.blob_size',
    'event_blob_size_bytes': 'event.blob_size',
    ...
    'lock_latency_milliseconds': 'lock.latency',
    'lock_latency_seconds': 'lock.latency.seconds',
    'client_requests': 'client.requests',
    'client_errors': 'client.errors',
    'client_latency': 'client.latency',
    'client_latency_milliseconds': 'client.latency',
    'client_latency_seconds': 'client.latency.seconds',
    ...
    'client_redirection_latency_milliseconds': 'client.redirection.latency',
    'client_redirection_latency_seconds': 'client.redirection.latency.seconds',
    'state_transition_count': 'state_transition',
    'history_size': 'history.size',
    'history_size_bytes': 'history.size',
    'history_count': 'history',
    'search_attributes_size': 'search_attributes_size',
    'search_attributes_size_bytes': 'search_attributes_size',
    'memo_size': 'memo_size',
    ...
    'version_check_latency_milliseconds': 'version_check.latency',
    'version_check_latency_seconds': 'version_check.latency.seconds',
    # History
    'cache_requests': 'cache.requests',
    'cache_errors': 'cache.errors',
    'cache_latency': 'cache.latency',
    'cache_latency_milliseconds': 'cache.latency',
    'cache_latency_seconds': 'cache.latency.seconds',
    'cache_miss': 'cache.miss',
    'cache_ttl': 'cache.ttl',
    'cache_ttl_milliseconds': 'cache.ttl',
    'cache_ttl_seconds': 'cache.ttl.seconds',
    'cache_entry_age_on_eviction': 'cache.entry_age_on_eviction',
    'cache_entry_age_on_eviction_milliseconds': 'cache.entry_age_on_eviction',
    'cache_entry_age_on_eviction_seconds': 'cache.entry_age_on_eviction.seconds',
    'cache_entry_age_on_get': 'cache.entry_age_on_get',
    'cache_entry_age_on_get_milliseconds': 'cache.entry_age_on_get',
    'cache_entry_age_on_get_seconds': 'cache.entry_age_on_get.seconds',
    'history_event_notification_queueing_latency': 'history.event_notification.queueing_latency',
    'history_event_notification_queueing_latency_milliseconds': 'history.event_notification.queueing_latency',
    'history_event_notification_queueing_latency_seconds': 'history.event_notification.queueing_latency.seconds',
    'history_event_notification_fanout_latency': 'history.event_notification.fanout_latency',
    'history_event_notification_fanout_latency_milliseconds': 'history.event_notification.fanout_latency',
    'history_event_notification_fanout_latency_seconds': 'history.event_notification.fanout_latency.seconds',
    ...
    'history_workflow_execution_cache_latency_milliseconds': 'history.workflow_execution_cache_latency',
    'history_workflow_execution_cache_latency_seconds': 'history.workflow_execution_cache_latency.seconds',
    'history_workflow_execution_cache_lock_hold_duration': 'history.workflow_execution_cache.lock_hold_duration',
    'history_workflow_execution_cache_lock_hold_duration_milliseconds': 'history.workflow_execution_cache.lock_hold_duration',
    'history_workflow_execution_cache_lock_hold_duration_seconds': 'history.workflow_execution_cache.lock_hold_duration.seconds',
    ...
    'archiver_archive_latency_milliseconds': 'archiver.archive.latency',
    'archiver_archive_latency_seconds': 'archiver.archive.latency.seconds',
    'archiver_archive_target_latency': 'archiver.archive.target_latency',
    'archiver_archive_target_latency_milliseconds': 'archiver.archive.target_latency',
    'archiver_archive_target_latency_seconds': 'archiver.archive.target_latency.seconds',
    'shard_closed_count': 'shard_closed',
    'shard_linger_success': 'shard.linger_success',
    'shard_linger_success_milliseconds': 'shard.linger_success',
    'shard_linger_success_seconds': 'shard.linger_success.seconds',
    ...
    'sharditem_acquisition_latency_milliseconds': 'sharditem.acquisition_latency',
    'sharditem_acquisition_latency_seconds': 'sharditem.acquisition_latency.seconds',
    ...
    'shardinfo_scheduled_queue_lag_milliseconds': 'shardinfo.scheduled_queue.lag',
    'shardinfo_scheduled_queue_lag_seconds': 'shardinfo.scheduled_queue.lag.seconds',
    ...
    'time_between_shardinfo_update_milliseconds': 'time_between_shardinfo_update',
    'time_between_shardinfo_update_seconds': 'time_between_shardinfo_update.seconds',
    'task_requests': 'task.requests',
    'task_latency_load': 'task.latency.load',
    'task_latency_load_milliseconds': 'task.latency.load',
    'task_latency_load_seconds': 'task.latency.load.seconds',
    'task_latency_schedule': 'task.latency.schedule',
    'task_latency_schedule_milliseconds': 'task.latency.schedule',
    'task_latency_schedule_seconds': 'task.latency.schedule.seconds',
    'task_latency_processing': 'task.latency.processing',
    'task_latency_processing_milliseconds': 'task.latency.processing',
    'task_latency_processing_seconds': 'task.latency.processing.seconds',
    'task_latency_user': 'task.latency.user',
    'task_latency': 'task.latency',
    'task_latency_milliseconds': 'task.latency',
    'task_latency_seconds': 'task.latency.seconds',
    'task_latency_queue': 'task.latency.queue',
    'task_latency_queue_milliseconds': 'task.latency.queue',
    'task_latency_queue_seconds': 'task.latency.queue.seconds',
    ...
    'task_schedule_to_start_latency_milliseconds': 'task.schedule_to_start_latency',
    'task_schedule_to_start_latency_seconds': 'task.schedule_to_start_latency.seconds',
    'task_dispatch_latency': 'task.dispatch_latency',
    'task_dispatch_latency_milliseconds': 'task.dispatch_latency',
    'task_dispatch_latency_seconds': 'task.dispatch_latency.seconds',
    'task_dlq_latency': 'task.dlq_latency',
    'task_dlq_latency_milliseconds': 'task.dlq_latency',
    'task_dlq_latency_seconds': 'task.dlq_latency.seconds',
    ...
    'queue_latency_schedule_milliseconds': 'queue.latency_schedule',
    'queue_latency_schedule_seconds': 'queue.latency_schedule.seconds',
    ...
    'activity_end_to_end_latency_milliseconds': 'activity.end_to_end_latency',
    'activity_end_to_end_latency_seconds': 'activity.end_to_end_latency.seconds',
    'activity_schedule_to_close_latency': 'activity.schedule_to_close_latency',
    'activity_schedule_to_close_latency_milliseconds': 'activity.schedule_to_close_latency',
    'activity_schedule_to_close_latency_seconds': 'activity.schedule_to_close_latency.seconds',
    'activity_start_to_close_latency': 'activity.start_to_close_latency',
    'activity_start_to_close_latency_milliseconds': 'activity.start_to_close_latency',
    'activity_start_to_close_latency_seconds': 'activity.start_to_close_latency.seconds',
    ...
    'acquire_shards_latency_milliseconds': 'acquire_shards.latency',
    'acquire_shards_latency_seconds': 'acquire_shards.latency.seconds',
    ...
    'get_engine_for_shard_latency_milliseconds': 'get_engine_for_shard.latency',
    'get_engine_for_shard_latency_seconds': 'get_engine_for_shard.latency.seconds',
    'remove_engine_for_shard_latency': 'remove_engine_for_shard.latency',
    'remove_engine_for_shard_latency_milliseconds': 'remove_engine_for_shard.latency',
    'remove_engine_for_shard_latency_seconds': 'remove_engine_for_shard.latency.seconds',
    'handover_wait_latency': 'handover.wait_latency',
    'handover_wait_latency_milliseconds': 'handover.wait_latency',
    'handover_wait_latency_seconds': 'handover.wait_latency.seconds',
    ...
    'mutable_state_size_bytes': 'mutable_state.size',
    'persisted_mutable_state_size': 'persisted_mutable_state.size',
    'persisted_mutable_state_size_bytes': 'persisted_mutable_state.size',
    'execution_info_size': 'execution_info.size',
    'execution_info_size_bytes': 'execution_info.size',
    'execution_state_size': 'execution_state.size',
    'execution_state_size_bytes': 'execution_state.size',
    'activity_info_size': 'activity_info.size',
    'activity_info_size_bytes': 'activity_info.size',
    'timer_info_size': 'timer_info.size',
    'timer_info_size_bytes': 'timer_info.size',
    'child_info_size': 'child_info.size',
    'child_info_size_bytes': 'child_info.size',
    'request_cancel_info_size': 'request_cancel_info.size',
    'request_cancel_info_size_bytes': 'request_cancel_info.size',
    'signal_info_size': 'signal_info.size',
    'signal_info_size_bytes': 'signal_info.size',
    'signal_request_id_size': 'signal_request_id.size',
    'signal_request_id_size_bytes': 'signal_request_id.size',
    'buffered_events_size': 'buffered_events.size',
    'buffered_events_size_bytes': 'buffered_events.size',
    ...
    'workflow_schedule_to_close_latency': 'workflow.schedule_to_close_latency',
    'workflow_schedule_to_close_latency_milliseconds': 'workflow.schedule_to_close_latency',
    'workflow_schedule_to_close_latency_seconds': 'workflow.schedule_to_close_latency.seconds',
    ...
    'replication_latency_milliseconds': 'replication.latency',
    'replication_latency_seconds': 'replication.latency.seconds',
    ...
    'replication_sender_rate_limit_latency': 'replication.sender_rate_limit_latency',
    'replication_sender_rate_limit_latency_milliseconds': 'replication.sender_rate_limit_latency',
    'replication_sender_rate_limit_latency_seconds': 'replication.sender_rate_limit_latency.seconds',
    'replication_task_generation_latency': 'replication.task_generation_latency',
    'replication_task_generation_latency_milliseconds': 'replication.task_generation_latency',
    'replication_task_generation_latency_seconds': 'replication.task_generation_latency.seconds',
    'replication_task_load_latency': 'replication.task_load_latency',
    'replication_task_load_latency_milliseconds': 'replication.task_load_latency',
    'replication_task_load_latency_seconds': 'replication.task_load_latency.seconds',
    'replication_task_processing_latency': 'replication.task_processing_latency',
    'replication_task_processing_latency_milliseconds': 'replication.task_processing_latency',
    'replication_task_processing_latency_seconds': 'replication.task_processing_latency.seconds',
    'replication_task_queue_latency': 'replication.task_queue_latency',
    'replication_task_queue_latency_milliseconds': 'replication.task_queue_latency',
    'replication_task_queue_latency_seconds': 'replication.task_queue_latency.seconds',
    'replication_task_send_latency': 'replication.task_send_latency',
    'replication_task_send_latency_milliseconds': 'replication.task_send_latency',
    'replication_task_send_latency_seconds': 'replication.task_send_latency.seconds',
    'replication_task_transmission_latency': 'replication.task_transmission_latency',
    'replication_task_transmission_latency_milliseconds': 'replication.task_transmission_latency',
    'replication_task_transmission_latency_seconds': 'replication.task_transmission_latency.seconds',
    'replication_tasks_back_fill_latency': 'replication.tasks_back_fill_latency',
    'replication_tasks_back_fill_latency_milliseconds': 'replication.tasks_back_fill_latency',
    'replication_tasks_back_fill_latency_seconds': 'replication.tasks_back_fill_latency.seconds',
    'generate_replication_tasks_latency': 'generate_replication_tasks.latency',
    'generate_replication_tasks_latency_milliseconds': 'generate_replication_tasks.latency',
    'generate_replication_tasks_latency_seconds': 'generate_replication_tasks.latency.seconds',
    ...
    'direct_query_dispatch_latency_milliseconds': 'direct_query_dispatch.latency',
    'direct_query_dispatch_latency_seconds': 'direct_query_dispatch.latency.seconds',
    'direct_query_dispatch_sticky_latency': 'direct_query_dispatch.sticky.latency',
    'direct_query_dispatch_sticky_latency_milliseconds': 'direct_query_dispatch.sticky.latency',
    'direct_query_dispatch_sticky_latency_seconds': 'direct_query_dispatch.sticky.latency.seconds',
    'direct_query_dispatch_non_sticky_latency': 'direct_query_dispatch.non_sticky.latency',
    'direct_query_dispatch_non_sticky_latency_milliseconds': 'direct_query_dispatch.non_sticky.latency',
    'direct_query_dispatch_non_sticky_latency_seconds': 'direct_query_dispatch.non_sticky.latency.seconds',
    ...
    'direct_query_dispatch_clear_stickiness_latency_milliseconds': 'direct_query_dispatch.clear_stickiness.latency',
    'direct_query_dispatch_clear_stickiness_latency_seconds': 'direct_query_dispatch.clear_stickiness.latency.seconds',
    ...
    'workflow_task_query_latency_milliseconds': 'workflow.task.query_latency',
    'workflow_task_query_latency_seconds': 'workflow.task.query_latency.seconds',
    ...
    'namespace_registry_refresh_latency': 'namespace_registry.refresh_latency',
    'namespace_registry_refresh_latency_milliseconds': 'namespace_registry.refresh_latency',
    'namespace_registry_refresh_latency_seconds': 'namespace_registry.refresh_latency.seconds',
    ...
    'syncmatch_latency_milliseconds': 'syncmatch.latency',
    'syncmatch_latency_seconds': 'syncmatch.latency.seconds',
    'asyncmatch_latency': 'asyncmatch.latency',
    'asyncmatch_latency_milliseconds': 'asyncmatch.latency',
    'asyncmatch_latency_seconds': 'asyncmatch.latency.seconds',
    'poll_success': 'poll.success',
    'poll_timeouts': 'poll.timeouts',
    'poll_success_sync': 'poll.success_sync',
    'poll_latency': 'poll.latency',
    'poll_latency_milliseconds': 'poll.latency',
    'poll_latency_seconds': 'poll.latency.seconds',
    ...
    'task_write_latency_milliseconds': 'task.write.latency',
    'task_write_latency_seconds': 'task.write.latency.seconds',
    ...
    'rate_limited_task_runnable_wait_time_milliseconds': 'rate_limited_task.runnable_wait_time',
    'rate_limited_task_runnable_wait_time_seconds': 'rate_limited_task.runnable_wait_time.seconds',
    # Worker
    ...
    'history_archiver_total_upload_size_bytes': 'history.archiver.total_upload_size',
    'history_archiver_history_size': 'history.archiver.history_size',
    'history_archiver_history_size_bytes': 'history.archiver.history_size',
    ...
    'history_archiver_blob_size_bytes': 'history.archiver.blob_size',
    ...
    'elasticsearch_bulk_processor_request_latency_milliseconds': 'elasticsearch.bulk_processor.request.latency',
    'elasticsearch_bulk_processor_request_latency_seconds': 'elasticsearch.bulk_processor.request.latency.seconds',
    'elasticsearch_bulk_processor_commit_latency': 'elasticsearch.bulk_processor.commit.latency',
    'elasticsearch_bulk_processor_commit_latency_milliseconds': 'elasticsearch.bulk_processor.commit.latency',
    'elasticsearch_bulk_processor_commit_latency_seconds': 'elasticsearch.bulk_processor.commit.latency.seconds',
    'elasticsearch_bulk_processor_wait_add_latency': 'elasticsearch.bulk_processor.wait_add.latency',
    'elasticsearch_bulk_processor_wait_add_latency_milliseconds': 'elasticsearch.bulk_processor.wait_add.latency',
    'elasticsearch_bulk_processor_wait_add_latency_seconds': 'elasticsearch.bulk_processor.wait_add.latency.seconds',
    'elasticsearch_bulk_processor_wait_start_latency': 'elasticsearch.bulk_processor.wait_start.latency',
    'elasticsearch_bulk_processor_wait_start_latency_milliseconds': 'elasticsearch.bulk_processor.wait_start.latency',
    'elasticsearch_bulk_processor_wait_start_latency_seconds': 'elasticsearch.bulk_processor.wait_start.latency.seconds',
    'elasticsearch_bulk_processor_bulk_request_took_latency': 'elasticsearch.bulk_processor.bulk_request_took.latency',
    'elasticsearch_bulk_processor_bulk_request_took_latency_milliseconds': 'elasticsearch.bulk_processor.bulk_request_took.latency',
    'elasticsearch_bulk_processor_bulk_request_took_latency_seconds': 'elasticsearch.bulk_processor.bulk_request_took.latency.seconds',
    ...
    'replicator_latency_milliseconds': 'replicator.latency',
    'replicator_latency_seconds': 'replicator.latency.seconds',
    ...
    'schedule_action_delay': 'schedule.action_delay',
    'schedule_action_delay_milliseconds': 'schedule.action_delay',
    'schedule_action_delay_seconds': 'schedule.action_delay.seconds',
    ...
    'persistence_latency_milliseconds': 'persistence.latency',
    'persistence_latency_seconds': 'persistence.latency.seconds',
    ...
    'visibility_persistence_latency_milliseconds': 'visibility.persistence.latency',
    'visibility_persistence_latency_seconds': 'visibility.persistence.latency.seconds',
    # Cassandra
    'cassandra_init_session_latency': 'cassandra.init_session_latency',
    'cassandra_init_session_latency_milliseconds': 'cassandra.init_session_latency',
    'cassandra_init_session_latency_seconds': 'cassandra.init_session_latency.seconds',
    # Nexus
    'nexus_completion_latency': 'nexus.completion_latency',
    'nexus_completion_latency_milliseconds': 'nexus.completion_latency',
    'nexus_completion_latency_seconds': 'nexus.completion_latency.seconds',
    'nexus_latency': 'nexus.latency',
    'nexus_latency_milliseconds': 'nexus.latency',
    'nexus_latency_seconds': 'nexus.latency.seconds',
    # Memory metrics
    'memory_gc_pause_ms': 'memory.gc_pause_ms',
    'memory_gc_pause_ms_milliseconds': 'memory.gc_pause_ms',
    'memory_gc_pause_ms_seconds': 'memory.gc_pause_ms.seconds',
    'memory_num_gc': 'memory.num_gc',
    'memory_num_gc_bytes': 'memory.num_gc',
    # Semaphore and finalizer
    'semaphore_latency': 'semaphore.latency',
    'semaphore_latency_milliseconds': 'semaphore.latency',
    'semaphore_latency_seconds': 'semaphore.latency.seconds',
    'finalizer_latency': 'finalizer.latency',
    'finalizer_latency_milliseconds': 'finalizer.latency',
    'finalizer_latency_seconds': 'finalizer.latency.seconds',
    # Verification latencies
    'verify_describe_mutable_state_latency': 'verify.describe_mutable_state_latency',
    'verify_describe_mutable_state_latency_milliseconds': 'verify.describe_mutable_state_latency',
    'verify_describe_mutable_state_latency_seconds': 'verify.describe_mutable_state_latency.seconds',
    'verify_replication_tasks_latency': 'verify.replication_tasks_latency',
    'verify_replication_tasks_latency_milliseconds': 'verify.replication_tasks_latency',
    'verify_replication_tasks_latency_seconds': 'verify.replication_tasks_latency.seconds',
    # Versioning
    'versioning_data_propagation_latency': 'versioning.data_propagation_latency',
    'versioning_data_propagation_latency_milliseconds': 'versioning.data_propagation_latency',
    'versioning_data_propagation_latency_seconds': 'versioning.data_propagation_latency.seconds',
    # External payload
    'external_payload_upload_size': 'external_payload.upload_size',
    'external_payload_upload_size_bytes': 'external_payload.upload_size',
    # Chasm
    'chasm_total_size': 'chasm.total_size',
    'chasm_total_size_bytes': 'chasm.total_size',
    # Workflow update registry
    'workflow_update_registry_size': 'workflow_update_registry.size',
    'workflow_update_registry_size_bytes': 'workflow_update_registry.size',
    # DD lock latency metrics
    'dd_cluster_metadata_callback_lock_latency': 'dd.cluster_metadata.callback_lock_latency',
    'dd_cluster_metadata_callback_lock_latency_milliseconds': 'dd.cluster_metadata.callback_lock_latency',
    'dd_cluster_metadata_callback_lock_latency_seconds': 'dd.cluster_metadata.callback_lock_latency.seconds',
    'dd_cluster_metadata_lock_latency': 'dd.cluster_metadata.lock_latency',
    'dd_cluster_metadata_lock_latency_milliseconds': 'dd.cluster_metadata.lock_latency',
    'dd_cluster_metadata_lock_latency_seconds': 'dd.cluster_metadata.lock_latency.seconds',
    'dd_namespace_registry_lock_latency': 'dd.namespace_registry.lock_latency',
    'dd_namespace_registry_lock_latency_milliseconds': 'dd.namespace_registry.lock_latency',
    'dd_namespace_registry_lock_latency_seconds': 'dd.namespace_registry.lock_latency.seconds',
    'dd_shard_controller_lock_latency': 'dd.shard_controller.lock_latency',
    'dd_shard_controller_lock_latency_milliseconds': 'dd.shard_controller.lock_latency',
    'dd_shard_controller_lock_latency_seconds': 'dd.shard_controller.lock_latency.seconds',
    'dd_shard_io_semaphore_latency': 'dd.shard.io_semaphore_latency',
    'dd_shard_io_semaphore_latency_milliseconds': 'dd.shard.io_semaphore_latency',
    'dd_shard_io_semaphore_latency_seconds': 'dd.shard.io_semaphore_latency.seconds',
    'dd_shard_lock_latency': 'dd.shard.lock_latency',
    'dd_shard_lock_latency_milliseconds': 'dd.shard.lock_latency',
    'dd_shard_lock_latency_seconds': 'dd.shard.lock_latency.seconds',
}

METRIC_MAP = {}

METRIC_MAP.update(BASE_METRICS)

TEMPORAL_V1_19_0_METRICS = {
    'elasticsearch_bulk_processor_retries': 'elasticsearch.bulk_processor_retries',
    'namespace_registry_callback_lock_latency': 'namespace_registry.callback_lock_latency',
    'persistence_errors_bad_request': 'persistence.errors.bad_request',
    'persistence_errors_busy': 'persistence.errors.busy',
    'persistence_errors_condition_failed': 'persistence.errors.condition_failed',
    'persistence_errors_current_workflow_condition_failed': 'persistence.errors.current_workflow_condition_failed',
    'persistence_errors_entity_not_exists': 'persistence.errors.entity_not_exists',
    'persistence_errors_namespace_already_exists': 'persistence.errors.namespace_already_exists',
    'persistence_errors_shard_exists': 'persistence.errors.shard_exists',
    'persistence_errors_shard_ownership_lost': 'persistence.errors.shard_ownership_lost',
    'persistence_errors_timeout': 'persistence.errors.timeout',
    'persistence_errors_workflow_condition_failed': 'persistence.errors.workflow_condition_failed',
    'service_errors_authorize_failed': 'service.errors.authorize_failed',
    'service_errors_bad_binary': 'service.errors.bad_binary',
    'service_errors_cancellation_already_requested': 'service.errors.cancellation_already_requested',
    'service_errors_client_version_not_supported': 'service.errors.client_version_not_supported',
    'service_errors_context_cancelled': 'service.errors.context_cancelled',
    ...
    'service_errors_namespace_already_exists': 'service.errors.namespace_already_exists',
    ...
    'service_errors_query_failed': 'service.errors.query_failed',
    'service_errors_retry_task': 'service.errors.retry_task',
    'service_errors_unauthorized': 'service.errors.unauthorized',
    'shardinfo_timer_diff': 'shardinfo.timer_diff',
    'shardinfo_timer_failover_in_progress': 'shardinfo.timer_failover_in_progress',
    'shardinfo_timer_failover_latency': 'shardinfo.timer_failover_latency',
    'shardinfo_transfer_diff': 'shardinfo.transfer.diff',
    'shardinfo_transfer_failover_in_progress': 'shardinfo.transfer.failover_in_progress',
    'shardinfo_transfer_failover_latency': 'shardinfo.transfer.failover_latency',
    'task_throttled_counter': 'task.throttled_counter',
}

METRIC_MAP.update(TEMPORAL_V1_19_0_METRICS)

TEMPORAL_V1_21_0_METRICS = {
    ...
    'protocol_message_command': 'protocol_message_command',
    'queue_action_errors': 'queue.action_errors',
    'replication_dlq_non_empty': 'replication.dlq_non_empty',
    'replication_tasks_recv': 'replication.tasks_recv',
    'replication_tasks_recv_backlog': 'replication.tasks_recv_backlog',
    'replication_tasks_send': 'replication.tasks_send',
    ...
    'signal_request_id_count': 'signal_request_id_count',
    'signal_request_id_size': 'signal_request_id_size',
    'total_activity_count': 'total_activity_count',
    'total_child_execution_count': 'total_child_execution_count',
    'total_request_cancel_external_count': 'total_request_cancel_external_count',
    'total_signal_count': 'total_signal_count',
    'total_signal_external_count': 'total_signal_external_count',
    'total_user_timer_count': 'total_user_timer_count',
    'workflow_delayed_start_backoff_timer': 'workflow_delayed_start.backoff_timer',
}

METRIC_MAP.update(TEMPORAL_V1_21_0_METRICS)

TEMPORAL_V1_22_0_METRICS = {
    ...
    'mutable_state_dirty': 'mutable_state_dirty',
    'replication_outlier_namespace': 'replication.outlier_namespace',
    'replication_tasks_skipped': 'replication.tasks_skipped',
    'service_panics': 'service.panics',
    'shard_linger_success': 'shard.linger_success',
    'shard_linger_timeouts': 'shard.linger_timeouts',
    'unknown_build_polls': 'unknown_build.polls',
    'unknown_build_tasks': 'unknown_build.tasks',
    'verify_describe_mutable_state_latency': 'verify.describe_mutable_state_latency',
...
METRIC_MAP.update(TEMPORAL_V1_22_0_METRICS)

TEMPORAL_V1_23_0_METRICS = {
    'batchable_task_batch_count': 'batchable_task.batch_count',
    'cassandra_init_session_latency': 'cassandra.init_session.latency',
    'cassandra_session_refresh_failures': 'cassandra.session_refresh.failures',
    'command': 'command',
    'dd_cluster_metadata_callback_lock_latency': 'dd.cluster_metadata.callback_lock.latency',
    'dd_cluster_metadata_lock_latency': 'dd.cluster_metadata_lock_latency',
    'dd_namespace_registry_lock_latency': 'dd.namespace_registry_lock_latency',
    'dd_shard_controller_lock_latency': 'dd.shard_controller_lock_latency',
    'dd_shard_io_semaphore_latency': 'dd.shard_io_semaphore_latency',
    'dd_shard_lock_latency': 'dd.shard_lock_latency',
    'dlq_writes': 'dlq_writes',
    'dynamic_rate_limit_multiplier': 'dynamic_rate_limit_multiplier',
    'poll_latency': 'poll_latency',
    'replication_stream_panic': 'replication.stream_panic',
    'replication_task_transmission_latency': 'replication.task_transmission_latency',
    'schedule_action_delay': 'schedule_action_delay',
...
METRIC_MAP.update(TEMPORAL_V1_23_0_METRICS)

TEMPORAL_V1_24_0_METRICS = {
    'cache_entry_age_on_eviction': 'cache_entry.age_on_eviction',
    'cache_entry_age_on_get': 'cache_entry.age_on_get',
    'cache_pinned_usage': 'cache.pinned_usage',
    'cache_size': 'cache.size',
    'cache_ttl': 'cache.ttl',
    'cache_usage': 'cache.usage',
    'gomaxprocs': 'gomaxprocs',
    'host_rps_limit': 'host_rps_limit',
    ...
    'namespace_host_rps_limit': 'namespace_host_rps_limit',
    'nexus_completion_latency': 'nexus.completion_latency',
    'nexus_completion_request_preprocess_errors': 'nexus.completion_request_preprocess_errors',
    'nexus_completion_requests': 'nexus.completion_requests',
    'nexus_latency': 'nexus.latency',
    ...
    'persisted_mutable_state_size': 'persisted_mutable_state_size',
    'reachability_exit_point_count': 'reachability_exit_point_count',
    ...
    'tasks_per_shardinfo_update': 'tasks.per_shardinfo_update',
    'time_between_shardinfo_update': 'time_between_shardinfo_update',
    'utf8_validation_errors': 'utf8_validation_errors',
    'workflow_update_aborted': 'workflow_update.aborted',
    'workflow_update_client_timeout': 'workflow_update.client_timeout',
    'workflow_update_normal_workflow_task': 'workflow_update.normal_workflow_task',
    'workflow_update_registry_size': 'workflow_update.registry_size',
    'workflow_update_request_rate_limited': 'workflow_update.request_rate_limited',
    'workflow_update_request_too_many': 'workflow_update.request_too_many',
    'workflow_update_sent_to_worker': 'workflow_update.sent_to_worker',
    'workflow_update_sent_to_worker_again': 'workflow_update.sent_to_worker_again',
    'workflow_update_server_timeout': 'workflow_update.server_timeout',
    'workflow_update_speculative_workflow_task': 'workflow_update.speculative_workflow_task',
    'workflow_update_wait_stage_accepted': 'workflow_update.wait_stage_accepted',
    'workflow_update_wait_stage_completed': 'workflow_update.wait_stage_completed',
}

METRIC_MAP.update(TEMPORAL_V1_24_0_METRICS)

TEMPORAL_V1_25_0_METRICS = {
    ...
    'finalizer_latency': 'finalizer.latency',
    'history_workflow_execution_cache_lock_hold_duration': 'history_workflow_execution_cache.lock_hold_duration',
    ...
    'schedule_action_attempt': 'schedule_action.attempt',
    ...
    'state_machine_timer_processing_failures': 'state_machine_timer.processing_failures',
    'state_machine_timer_skips': 'state_machine_timer.skips',
    'workflow_backoff_timer': 'workflow_backoff_timer',
}

METRIC_MAP.update(TEMPORAL_V1_25_0_METRICS)

TEMPORAL_V1_26_0_METRICS = {
    ...
    'signal_with_start_skip_delay_count': 'signal_with_start_skip_delay_count',
}

METRIC_MAP.update(TEMPORAL_V1_26_0_METRICS)

TEMPORAL_V1_27_0_METRICS = {
    ...
    'workflow_update_continue_as_new_suggestions': 'workflow_update.continue_as_new_suggestions',
    'workflow_update_registry_size_limited': 'workflow_update.registry_size_limited',
}

METRIC_MAP.update(TEMPORAL_V1_27_0_METRICS)

TEMPORAL_V1_28_0_METRICS = {
    'chasm_total_size': 'chasm.total_size',
    ...
    'replication_task_generation_latency': 'replication.task_generation_latency',
    'replication_task_load_latency': 'replication.task_load_latency',
    'replication_task_load_size': 'replication.task_load_size',
    'replication_task_processing_latency': 'replication.task_processing_latency',
    'replication_task_send_attempt': 'replication.task_send_attempt',
    'replication_task_send_backlog': 'replication.task_send_backlog',
    'replication_task_send_error': 'replication.task_send_error',
    'replication_task_send_latency': 'replication.task_send_latency',
    'replication_tasks_back_fill': 'replication.tasks_back_fill',
    'replication_tasks_back_fill_latency': 'replication.tasks_back_fill_latency',
    'schedule_action_dropped': 'schedule_action.dropped',
    'start_deployment_transition_count': 'start_deployment.transition_count',
    'start_workflow_request_deduped': 'start_workflow_request_deduped',
    'task_rewrites': 'task_rewrites',
    'worker_deployment_created': 'worker_deployment_created',
    'worker_deployment_version_created': 'worker_deployment_version_created',
    'worker_deployment_version_created_managed_by_controller': 'worker_deployment_version_created_managed_by_controller',
    'worker_deployment_version_visibility_query_count': 'worker_deployment_version_visibility_query_count',
    'worker_deployment_versioning_override_count': 'worker_deployment_versioning_override_count',
    'workflow_query_failure_count': 'workflow_query.failure_count',
    'workflow_query_success_count': 'workflow_query.success_count',
    'workflow_query_timeout_count': 'workflow_query.timeout_count',
    'workflow_reset_count': 'workflow_reset_count',
    'workflow_tasks_completed': 'workflow_tasks.completed',
}

METRIC_MAP.update(TEMPORAL_V1_28_0_METRICS)
