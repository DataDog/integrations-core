...
METRIC_MAP = {
    ...
    'service_errors_critical': 'service.errors_critical',
    'service_latency': 'service.latency',
    'service_latency_nouserlatency': 'service.latency_nouserlatency',
    'service_latency_userlatency': 'service.latency_userlatency',
    ...
    'memo_size': 'memo_size',
    'wf_too_many_pending_child_workflows': 'wf.too_many_pending.child_workflows',
    ...
    'history_event_notification_queueing_latency': 'history_event_notification.queueing_latency',
    'history_event_notification_fanout_latency': 'history_event_notification.fanout_latency',
    'history_event_notification_inflight_message_gauge': 'history_event_notification.inflight_message',
    'history_event_notification_fail_delivery_count': 'history_event_notification.fail_delivery',
    ...
    'shard_closed_count': 'shard_closed_count',
    ...
    'task_rescheduler_pending_tasks': 'task.rescheduler_pending_tasks',
    'pending_tasks': 'pending.tasks',
    'task_scheduler_throttled': 'task.scheduler_throttled',
    'queue_latency_schedule': 'queue.latency_schedule',
    'queue_reader_count': 'queue.reader_count',
    'queue_slice_count': 'queue.slice_count',
    'queue_actions': 'queue.actions',
    'activity_end_to_end_latency': 'activity.end_to_end_latency',
    'ack_level_update': 'ack_level.update',
    'ack_level_update_failed': 'ack_level.update_failed',
    ...
    'auto_reset_points_exceed_limit': 'auto_reset_points_exceed_limit',
    'auto_reset_point_corruption': 'auto_reset_point_corruption',
    ...
    'workflow_task_heartbeat_timeout_count': 'workflow_task_heartbeat_timeout.count',
    ...
    'complete_task_fail_count': 'complete_task_fail_count',
    'acquire_lock_failed': 'acquire_lock_failed',
    'workflow_context_cleared': 'workflow_context_cleared',
    'mutable_state_size': 'mutable_state_size',
    'execution_info_size': 'execution_info_size',
    'execution_state_size': 'execution_state_size',
    'activity_info_size': 'activity_info_size',
    'timer_info_size': 'timer_info_size',
    'child_info_size': 'child_info_size',
    'request_cancel_info_size': 'request_cancel_info_size',
    'signal_info_size': 'signal_info_size',
    'buffered_events_size': 'buffered_events_size',
    'activity_info_count': 'activity_info_count',
    'timer_info_count': 'timer_info_count',
    'child_info_count': 'child_info_count',
    'signal_info_count': 'signal_info_count',
    'request_cancel_info_count': 'request_cancel_info_count',
    'buffered_events_count': 'buffered_events_count',
    'task_count': 'task.count',
    'workflow_retry_backoff_timer': 'workflow.retry_backoff_timer',
    'workflow_cron_backoff_timer': 'workflow.cron_backoff_timer',
    ...
    'event_reapply_skipped_count': 'event_reapply_skipped_count',
    ...
    'workflow_task_query_latency': 'workflow.task_query_latency',
    ...
    'workflow_task_timeout_overrides': 'workflow.task_timeout_overrides',
    'workflow_run_timeout_overrides': 'workflow.run_timeout_overrides',
    'replication_task_cleanup_count': 'replication.task_cleanup.count',
    ...
    'sync_throttle_count': 'sync_throttle_count',
    'buffer_throttle_count': 'buffer_throttle_count',
    'tasks_expired': 'tasks_expired',
    'forwarded_per_tl': 'forwarded_per_tl',
    'forward_task_calls': 'forward_task_calls',
    'forward_task_errors': 'forward_task_errors',
    'forward_query_calls': 'forward_query_calls',
    'forward_query_errors': 'forward_query_errors',
    'forward_poll_calls': 'forward_poll_calls',
    'forward_poll_errors': 'forward_poll_errors',
    'forward_task_latency': 'forward_task_latency',
    'forward_query_latency': 'forward_query_latency',
    'forward_poll_latency': 'forward_poll_latency',
    'local_to_local_matches': 'local_to_local_matches',
    'local_to_remote_matches': 'local_to_remote_matches',
    'remote_to_local_matches': 'remote_to_local_matches',
    'remote_to_remote_matches': 'remote_to_remote_matches',
    ...
    'task_write_throttle_count': 'task_write.throttle_count',
    ...
    'history_archiver_archive_non_retryable_error': 'history_archiver.archive.non_retryable_error',
    'history_archiver_archive_transient_error': 'history_archiver.archive.transient_error',
    'history_archiver_archive_success': 'history_archiver.archive.success',
    'history_archiver_history_mutated': 'history_archiver.history_mutated',
    'history_archiver_total_upload_size': 'history_archiver.total_upload_size',
    'history_archiver_history_size': 'history_archiver.history_size',
    'history_archiver_duplicate_archivals': 'history_archiver.duplicate_archivals',
    'history_archiver_blob_exists': 'history_archiver.blob_exists',
    'history_archiver_blob_size': 'history_archiver.blob_size',
    'history_archiver_running_deterministic_construction_check': 'history_archiver.running_deterministic_construction_check',
    'history_archiver_deterministic_construction_check_failed': 'history_archiver.deterministic_construction_check_failed',
    'history_archiver_running_blob_integrity_check': 'history_archiver.running_blob_integrity_check',
    'history_archiver_blob_integrity_check_failed': 'history_archiver.blob_integrity_check_failed',
    'history_workflow_execution_cache_latency': 'history.workflow_execution_cache_latency',
    'visibility_archiver_archive_non_retryable_error': 'visibility_archiver.archive.non_retryable_error',
    'visibility_archiver_archive_transient_error': 'visibility_archiver.archive.transient_error',
    'visibility_archiver_archive_success': 'visibility_archiver.archive.success',
    ...
    'archiver_backlog_size': 'archiver.backlog_size',
    'archiver_pump_timeout': 'archiver.pump_timeout',
    'archiver_pump_signal_threshold': 'archiver.pump_signal_threshold',
    'archiver_pump_timeout_without_signals': 'archiver.pump_timeout_without_signals',
    'archiver_pump_signal_channel_closed': 'archiver.pump_signal_channel_closed',
    'archiver_workflow_started': 'archiver.workflow_started',
    ...
    'archiver_workflow_stopping': 'archiver.workflow_stopping',
    ...
    'add_search_attributes_failures': 'add_search_attributes_failures',
    ...
    'rate_limiter_failures': 'rate_limiter_failures',
    ...
    'schedule_action_success': 'schedule.action_success',
    ...
    'visibility_persistence_requests': 'visibility_persistence.requests',
    'visibility_persistence_error_with_type': 'visibility_persistence.error_with_type',
    'visibility_persistence_errors': 'visibility_persistence.errors',
    'visibility_persistence_resource_exhausted': 'visibility_persistence.resource_exhausted',
    'visibility_persistence_latency': 'visibility_persistence.latency',
}
