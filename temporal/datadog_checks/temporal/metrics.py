...
# Metrics that need seconds to milliseconds conversion
SECONDS_TO_MILLISECONDS_METRICS = {
    'service_latency_seconds': 'service.latency',
    'service_latency_nouserlatency_seconds': 'service.latency.nouserlatency',
    'service_latency_userlatency_seconds': 'service.latency.userlatency',
    'service_authorization_latency_seconds': 'service.authorization_latency',
    'service_dial_latency_seconds': 'service.dial_latency',
    'lock_latency_seconds': 'lock.latency',
    'client_latency_seconds': 'client.latency',
    'client_redirection_latency_seconds': 'client.redirection.latency',
    'version_check_latency_seconds': 'version_check.latency',
    'cache_latency_seconds': 'cache.latency',
    'cache_ttl_seconds': 'cache.ttl',
    'cache_entry_age_on_eviction_seconds': 'cache.entry_age_on_eviction',
    'cache_entry_age_on_get_seconds': 'cache.entry_age_on_get',
    'history_event_notification_queueing_latency_seconds': 'history.event_notification.queueing_latency',
    'history_event_notification_fanout_latency_seconds': 'history.event_notification.fanout_latency',
    'history_workflow_execution_cache_latency_seconds': 'history.workflow_execution_cache_latency',
    'history_workflow_execution_cache_lock_hold_duration_seconds': 'history.workflow_execution_cache.lock_hold_duration',
    'archiver_archive_latency_seconds': 'archiver.archive.latency',
    'archiver_archive_target_latency_seconds': 'archiver.archive.target_latency',
    'shard_linger_success_seconds': 'shard.linger_success',
    'sharditem_acquisition_latency_seconds': 'sharditem.acquisition_latency',
    'shardinfo_scheduled_queue_lag_seconds': 'shardinfo.scheduled_queue.lag',
    'time_between_shardinfo_update_seconds': 'time_between_shardinfo_update',
    'task_latency_load_seconds': 'task.latency.load',
    'task_latency_schedule_seconds': 'task.latency.schedule',
    'task_latency_processing_seconds': 'task.latency.processing',
    'task_latency_seconds': 'task.latency',
    'task_latency_queue_seconds': 'task.latency.queue',
    'task_schedule_to_start_latency_seconds': 'task.schedule_to_start_latency',
    'task_dispatch_latency_seconds': 'task.dispatch_latency',
    'task_dlq_latency_seconds': 'task.dlq_latency',
    'queue_latency_schedule_seconds': 'queue.latency_schedule',
    'activity_end_to_end_latency_seconds': 'activity.end_to_end_latency',
    'activity_schedule_to_close_latency_seconds': 'activity.schedule_to_close_latency',
    'activity_start_to_close_latency_seconds': 'activity.start_to_close_latency',
    'acquire_shards_latency_seconds': 'acquire_shards.latency',
    'get_engine_for_shard_latency_seconds': 'get_engine_for_shard.latency',
    'remove_engine_for_shard_latency_seconds': 'remove_engine_for_shard.latency',
    'handover_wait_latency_seconds': 'handover.wait_latency',
    'workflow_schedule_to_close_latency_seconds': 'workflow.schedule_to_close_latency',
    'replication_latency_seconds': 'replication.latency',
    'replication_sender_rate_limit_latency_seconds': 'replication.sender_rate_limit_latency',
    'replication_task_generation_latency_seconds': 'replication.task_generation_latency',
    'replication_task_load_latency_seconds': 'replication.task_load_latency',
    'replication_task_processing_latency_seconds': 'replication.task_processing_latency',
    'replication_task_queue_latency_seconds': 'replication.task_queue_latency',
    'replication_task_send_latency_seconds': 'replication.task_send_latency',
    'replication_task_transmission_latency_seconds': 'replication.task_transmission_latency',
    'replication_tasks_back_fill_latency_seconds': 'replication.tasks_back_fill_latency',
    'generate_replication_tasks_latency_seconds': 'generate_replication_tasks.latency',
    'direct_query_dispatch_latency_seconds': 'direct_query_dispatch.latency',
    'direct_query_dispatch_sticky_latency_seconds': 'direct_query_dispatch.sticky.latency',
    'direct_query_dispatch_non_sticky_latency_seconds': 'direct_query_dispatch.non_sticky.latency',
    'direct_query_dispatch_clear_stickiness_latency_seconds': 'direct_query_dispatch.clear_stickiness.latency',
    'workflow_task_query_latency_seconds': 'workflow.task.query_latency',
    'namespace_registry_refresh_latency_seconds': 'namespace_registry.refresh_latency',
    'syncmatch_latency_seconds': 'syncmatch.latency',
    'asyncmatch_latency_seconds': 'asyncmatch.latency',
    'poll_latency_seconds': 'poll.latency',
    'task_write_latency_seconds': 'task.write.latency',
    'rate_limited_task_runnable_wait_time_seconds': 'rate_limited_task.runnable_wait_time',
    'elasticsearch_bulk_processor_request_latency_seconds': 'elasticsearch.bulk_processor.request.latency',
    'elasticsearch_bulk_processor_commit_latency_seconds': 'elasticsearch.bulk_processor.commit.latency',
    'elasticsearch_bulk_processor_wait_add_latency_seconds': 'elasticsearch.bulk_processor.wait_add.latency',
    'elasticsearch_bulk_processor_wait_start_latency_seconds': 'elasticsearch.bulk_processor.wait_start.latency',
    'elasticsearch_bulk_processor_bulk_request_took_latency_seconds': 'elasticsearch.bulk_processor.bulk_request_took.latency',
    'replicator_latency_seconds': 'replicator.latency',
    'schedule_action_delay_seconds': 'schedule.action_delay',
    'persistence_latency_seconds': 'persistence.latency',
    'visibility_persistence_latency_seconds': 'visibility.persistence.latency',
    'cassandra_init_session_latency_seconds': 'cassandra.init_session_latency',
    'nexus_completion_latency_seconds': 'nexus.completion_latency',
    'nexus_latency_seconds': 'nexus.latency',
    'memory_gc_pause_ms_seconds': 'memory.gc_pause_ms',
    'semaphore_latency_seconds': 'semaphore.latency',
    'finalizer_latency_seconds': 'finalizer.latency',
    'verify_describe_mutable_state_latency_seconds': 'verify.describe_mutable_state_latency',
    'verify_replication_tasks_latency_seconds': 'verify.replication_tasks_latency',
    'versioning_data_propagation_latency_seconds': 'versioning.data_propagation_latency',
    'dd_cluster_metadata_callback_lock_latency_seconds': 'dd.cluster_metadata.callback_lock_latency',
    'dd_cluster_metadata_lock_latency_seconds': 'dd.cluster_metadata.lock_latency',
    'dd_namespace_registry_lock_latency_seconds': 'dd.namespace_registry.lock_latency',
    'dd_shard_controller_lock_latency_seconds': 'dd.shard_controller.lock_latency',
    'dd_shard_io_semaphore_latency_seconds': 'dd.shard.io_semaphore_latency',
    'dd_shard_lock_latency_seconds': 'dd.shard.lock_latency',
}
