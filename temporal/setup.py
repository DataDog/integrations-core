...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'temporal', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-temporal',
    version=ABOUT['__version__'],
    description='The Temporal check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent temporal check',
    ...
    packages=['datadog_checks.temporal'],
