...
1. Edit the `temporal.d/conf.yaml` file, in the `conf.d/` folder at the root of your Agent's configuration directory to start collecting your temporal performance data. See the [sample temporal.d/conf.yaml][4] for all available configuration options.
...
The Temporal integration does not include any service checks.
