...
from datadog_checks.kyverno.config_models import discovery_overrides
from datadog_checks.kyverno.config_models.instance import InstanceConfig
from datadog_checks.kyverno.config_models.shared import SharedConfig
...
def _generated_candidates(service: Service) -> Iterator[dict[str, Any]]:
    ...
    for port in candidate_ports_by_name(service, ['metrics-port', 'metrics']):
        ctx = {'port': port}
        instance_data = {
