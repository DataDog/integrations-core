...
# DOCKER_USERNAME, DOCKER_ACCESS_TOKEN, ORACLE_DOCKER_USERNAME2, ORACLE_DOCKER_PASSWORD2
...
# =============================================================================
{
  ...
  echo "ORACLE_DOCKER_USERNAME=${ORACLE_DOCKER_USERNAME2}"
  echo "ORACLE_DOCKER_PASSWORD=${ORACLE_DOCKER_PASSWORD2}"
