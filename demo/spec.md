...
While we call each endpoint asynchronously, give some feedback to the user about what is happening so the user is not left in front of an empty screen not knowing what is happening.
