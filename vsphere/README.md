...
- [Can I limit the number of VMs that are pulled in via the VMWare integration?][7]
- [My vSpehre VMs are duplicated in the Infrastructure List view][8]

## Data Collected

Depending of the `collection_level` value you set in your check configuration, not all metrics below are collected. See the [Vsphere Data Collection Levels documentation][9] to discover for a given collection level which metrics are collected.
...
See our [blog post][13] on monitoring vSphere environments with Datadog.
...
[7]: https://docs.datadoghq.com/integrations/faq/can-i-limit-the-number-of-vms-that-are-pulled-in-via-the-vmware-integration/
