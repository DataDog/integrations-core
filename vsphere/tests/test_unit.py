...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            1,
            5,
            ['my_cat_name_2:my_tag_name_2', 'vcenter_server:vsphere_host', 'vsphere_datastore:NFS-Share-1',
             'vsphere_type:datastore',],
            id='New version',
        ),
    ],
...
def test_report_historical_metrics_with_tags(
    aggregator, dd_run_check, instance, expected_count, expected_value, expected_tags, mock_rest_api
):
    with mock.patch('pyVim.connect.SmartConnect') as mock_connect, mock.patch(
        'pyVmomi.vmodl.query.PropertyCollector'
    ) as mock_property_collector:
