...
def test_cisco_metrics(aggregator, session_mock):
    ...
    tags000 = ['cisco', 'medium:broadcast', 'snmpTrapSt:enable', 'fabric_pod_id:1']
    tags101 = tags000 + ['node_id:101']
    tags102 = tags000 + ['node_id:102']
    tags201 = tags000 + ['node_id:201']
    tags202 = tags000 + ['node_id:202']
    tags = ['fabric_state:active', 'fabric_pod_id:1', 'cisco']
    ...
    metric_name = 'cisco_aci.capacity.leaf.vrf.utilized'
    aggregator.assert_metric(metric_name, value=32.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'], hostname=hn101)
    aggregator.assert_metric(metric_name, value=4.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'], hostname=hn201)
    aggregator.assert_metric(metric_name, value=4.0, tags=['fabric_pod_id:1', 'node_id:202', 'cisco'], hostname=hn202)
    aggregator.assert_metric(metric_name, value=27.0, tags=['fabric_pod_id:1', 'node_id:102', 'cisco'], hostname=hn102)
    ...
    metric_name = 'cisco_aci.capacity.leaf.endpoint_group.limit'
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'],
                             hostname=hn101)
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'],
                             hostname=hn201)
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:202', 'cisco'],
                             hostname=hn202)
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:102', 'cisco'],
                             hostname=hn102)
    ...
    aggregator.assert_metric(metric_name, value=8.0, tags=['apic_role:controller', 'node_id:2', 'fabric_state:unknown',
                                                           'fabric_pod_id:1', 'cisco'], hostname='pod-1-node-2')
    ...
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Pay', 'tenant:DataDog',
                                                           'application:DtDg-AP1-EcommerceApp'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-MiscAppVMs', 'tenant:DataDog',
                                                           'application:DtDg-AP1-EcommerceApp'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Inv', 'tenant:DataDog',
                                                           'application:DtDg-AP1-EcommerceApp'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Ord', 'tenant:DataDog',
                                                           'application:DtDg-AP1-EcommerceApp'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Ecomm', 'tenant:DataDog',
                                                           'application:DtDg-AP1-EcommerceApp'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Jeti2', 'tenant:DataDog',
                                                           'application:DtDg-AP2-Jeti'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Jetty_Controller', 'tenant:DataDog',
                                                           'application:DtDg-AP2-Jeti'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:DtDg-Jeti1', 'tenant:DataDog',
                                                           'application:DtDg-AP2-Jeti'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['endpoint_group:Test-EPG', 'tenant:DataDog',
                                                           'application:DtDg-test-AP'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.leaf.bridge_domain.limit'
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'],
                             hostname=hn101)
    aggregator.assert_metric(metric_name, value=3500.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'],
                             hostname=hn201)
    ...
    metric_name = 'cisco_aci.capacity.apic.contract.limit'
    aggregator.assert_metric(metric_name, value=1000.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.leaf.vrf.limit'
    aggregator.assert_metric(metric_name, value=800.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'], hostname=hn101)
    aggregator.assert_metric(metric_name, value=800.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'], hostname=hn201)
    aggregator.assert_metric(metric_name, value=800.0, tags=['fabric_pod_id:1', 'node_id:202', 'cisco'], hostname=hn202)
    aggregator.assert_metric(metric_name, value=800.0, tags=['fabric_pod_id:1', 'node_id:102', 'cisco'], hostname=hn102)
    ...
    metric_name = 'cisco_aci.capacity.apic.endpoint_group.limit'
    aggregator.assert_metric(metric_name, value=15000.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.fabric_node.limit'
    aggregator.assert_metric(metric_name, value=200.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.azure_domain.endpoint_group.limit'
    aggregator.assert_metric(metric_name, value=9000.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.endpoint.utilized'
    aggregator.assert_metric(metric_name, value=76.0, tags=['cisco'], hostname='')

    metric_name = 'cisco_aci.capacity.apic.service_graph.limit'
    aggregator.assert_metric(metric_name, value=600.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.endpoint.limit'
    aggregator.assert_metric(metric_name, value=180000.0, tags=['cisco'], hostname='')
    ...
    aggregator.assert_metric(metric_name, value=99.0, tags=['tenant:DataDog'], hostname='')
    ...
    aggregator.assert_metric(metric_name, value=2.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.bridge_domain.limit'
    aggregator.assert_metric(metric_name, value=15000.0, tags=['cisco'], hostname='')

    metric_name = 'cisco_aci.capacity.apic.endpoint_group.utilized'
    aggregator.assert_metric(metric_name, value=205.0, tags=['cisco'], hostname='')

    metric_name = 'cisco_aci.capacity.apic.private_network.utilized'
    aggregator.assert_metric(metric_name, value=85.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.bridge_domain.utilized'
    aggregator.assert_metric(metric_name, value=154.0, tags=['cisco'], hostname='')
    ...
    aggregator.assert_metric(metric_name, value=0.0, tags=['application:DtDg-AP1-EcommerceApp', 'tenant:DataDog'],
                             hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['application:DtDg-AP2-Jeti', 'tenant:DataDog'], hostname='')
    aggregator.assert_metric(metric_name, value=0.0, tags=['application:DtDg-test-AP', 'tenant:DataDog'], hostname='')
    ...
    aggregator.assert_metric(metric_name, value=37835708.0, tags=['apic_role:controller', 'node_id:3',
                                                                  'fabric_state:unknown', 'fabric_pod_id:1', 'cisco'],
    ...
    metric_name = 'cisco_aci.capacity.apic.vmware_domain.endpoint_group.limit'
    aggregator.assert_metric(metric_name, value=15000.0, tags=['cisco'], hostname='')

    metric_name = 'cisco_aci.capacity.apic.tenant.limit'
    aggregator.assert_metric(metric_name, value=3000.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.tenant.utilized'
    aggregator.assert_metric(metric_name, value=90.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.leaf.endpoint_group.utilized'
    aggregator.assert_metric(metric_name, value=94.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'], hostname=hn101)
    aggregator.assert_metric(metric_name, value=0.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'], hostname=hn201)
    aggregator.assert_metric(metric_name, value=0.0, tags=['fabric_pod_id:1', 'node_id:202', 'cisco'], hostname=hn202)
    aggregator.assert_metric(metric_name, value=78.0, tags=['fabric_pod_id:1', 'node_id:102', 'cisco'], hostname=hn102)

    metric_name = 'cisco_aci.tenant.fault_counter'
    aggregator.assert_metric(metric_name, value=4.0, tags=['tenant:DataDog'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.leaf.bridge_domain.utilized'
    aggregator.assert_metric(metric_name, value=44.0, tags=['fabric_pod_id:1', 'node_id:101', 'cisco'], hostname=hn101)
    aggregator.assert_metric(metric_name, value=1.0, tags=['fabric_pod_id:1', 'node_id:201', 'cisco'], hostname=hn201)
    aggregator.assert_metric(metric_name, value=1.0, tags=['fabric_pod_id:1', 'node_id:202', 'cisco'], hostname=hn202)
    aggregator.assert_metric(metric_name, value=34.0, tags=['fabric_pod_id:1', 'node_id:102', 'cisco'], hostname=hn102)
    ...
    metric_name = 'cisco_aci.capacity.apic.azure_domain.limit'
    aggregator.assert_metric(metric_name, value=5.0, tags=['cisco'], hostname='')
    ...
    metric_name = 'cisco_aci.capacity.apic.vmware_domain.limit'
    aggregator.assert_metric(metric_name, value=5.0, tags=['cisco'], hostname='')

    metric_name = 'cisco_aci.capacity.apic.private_network.limit'
    aggregator.assert_metric(metric_name, value=3000.0, tags=['cisco'], hostname='')
