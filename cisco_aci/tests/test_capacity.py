...
def test_get_contexts(aggregator):
    ...
    aggregator.assert_metric('cisco_aci.capacity.leaf.bridge_domain.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.bridge_domain.utilized', value=0.0,
                   tags=['fabric_pod_id:3', 'node_id:4'] + tags, hostname='pod-3-node-4', count=1) # TODO is this valid?
    ...
    aggregator.assert_metric('cisco_aci.capacity.leaf.vrf.utilized', value=0.0, tags=tags, hostname='', count=5) # TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.vrf.utilized', value=0.0,
                             tags=['fabric_pod_id:3', 'node_id:4'] + tags, hostname='pod-3-node-4') # TODO is this valid?
    ...
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.limit', value=3500.0, tags=tags, hostname='', count=5) # TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.limit', value=3500.0,
                   tags=['fabric_pod_id:3', 'node_id:4'] + tags, hostname='pod-3-node-4', count=1) # TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.limit', value=3500.0,
                   tags=['fabric_pod_id:1', 'node_id:2'] + tags, hostname='pod-1-node-2', count=1)

    aggregator.assert_metric('cisco_aci.capacity.leaf.bridge_domain.limit', value=3500.0, tags=tags, hostname='', count=5)# TODO is this valid?
    ...
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.utilized', value=0.0,
                   tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.utilized', value=0.0, tags=['fabric_pod_id:3', 'node_id:4'] + tags, hostname='pod-3-node-4')# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.leaf.endpoint_group.utilized', value=666.0,
                   tags=['fabric_pod_id:1', 'node_id:2'] + tags, hostname='pod-1-node-2')

    aggregator.assert_metric('cisco_aci.capacity.leaf.vrf.limit', value=800.0, tags=tags, hostname='', count=5)# TODO is this valid?
...
def test_get_apic_capacity_limits(aggregator):
    ...
    aggregator.assert_metric('cisco_aci.capacity.apic.azure_domain.endpoint_group.limit', value=7.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.vmware_domain.endpoint_group.limit', value=11.0, tags=tags, hostname='', count=1)
    ...
    aggregator.assert_metric('cisco_aci.capacity.apic.endpoint_group.limit', value=10.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.private_network.limit', value=5.0, tags=tags, hostname='', count=1)
...
def test_get_apic_capacity_metrics(aggregator):
    ...
    aggregator.assert_metric('cisco_aci.capacity.apic.endpoint.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.apic.endpoint.utilized', value=666.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.bridge_domain.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.apic.bridge_domain.utilized', value=666.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.tenant.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.apic.tenant.utilized', value=666.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.private_network.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.apic.private_network.utilized', value=666.0, tags=tags, hostname='', count=1)
    aggregator.assert_metric('cisco_aci.capacity.apic.endpoint_group.utilized', value=0.0, tags=tags, hostname='', count=5)# TODO is this valid?
    aggregator.assert_metric('cisco_aci.capacity.apic.endpoint_group.utilized', value=666.0, tags=tags, hostname='', count=1)
