...
* New Integration: Cilium. See [#4665](https://github.com/DataDog/integrations-core/pull/4665).
...
* Add `pyproject.toml` file. See [#11325](https://github.com/DataDog/integrations-core/pull/11325).
...
* Fix required config option. See [#10629](https://github.com/DataDog/integrations-core/pull/10629).
...
* Add runtime configuration validation. See [#8894](https://github.com/DataDog/integrations-core/pull/8894).

***Fixed***: 

* Harmonize check and config options. See [#10488](https://github.com/DataDog/integrations-core/pull/10488).
...
* Add config spec. See [#6314](https://github.com/DataDog/integrations-core/pull/6314).
...
* Update request wrapper with password and A6 signature. See [#5684](https://github.com/DataDog/integrations-core/pull/5684).
...
* Ensure only one session object per url. See [#5334](https://github.com/DataDog/integrations-core/pull/5334).
...
* Use RequestsWrapper. See [#5037](https://github.com/DataDog/integrations-core/pull/5037).
...
* Standardize logging format. See [#4902](https://github.com/DataDog/integrations-core/pull/4902).

***Fixed***: 

* Refresh auth token when it expires. See [#5039](https://github.com/DataDog/integrations-core/pull/5039).
...
* Fix event submission call. See [#4044](https://github.com/DataDog/integrations-core/pull/4044).
...
* Improve API logs. See [#3794](https://github.com/DataDog/integrations-core/pull/3794).
...
* Adhere to code style. See [#3489](https://github.com/DataDog/integrations-core/pull/3489).
...
* Support Python 3. See [#3029](https://github.com/DataDog/integrations-core/pull/3029).
...
* Upgrade cryptography. See [#2659][1].
...
* fixes cisco for username and password. See [#2267][3].
...
* Use Certs in the Cisco Check as well as Passwords. See [#1986][4].
...
* Makes the Cisco Check more resilient. See [#1785][6].
