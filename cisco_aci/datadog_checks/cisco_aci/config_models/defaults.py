...
def instance_cert_key(field, value):
    return get_default_field_value(field, value)


def instance_cert_key_password(field, value):
    return get_default_field_value(field, value)


def instance_cert_key_path(field, value):
    return get_default_field_value(field, value)


def instance_cert_name(field, value):
    return get_default_field_value(field, value)
...
def instance_tenant(field, value):
    return get_default_field_value(field, value)
