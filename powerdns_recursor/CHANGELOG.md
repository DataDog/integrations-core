...
* Add `pyproject.toml` file. See [#11418](https://github.com/DataDog/integrations-core/pull/11418).
...
* Add runtime configuration validation. See [#8972](https://github.com/DataDog/integrations-core/pull/8972).
...
* Add config spec. See [#7742](https://github.com/DataDog/integrations-core/pull/7742).
...
* Add version metadata. See [#6916](https://github.com/DataDog/integrations-core/pull/6916).
...
* Add requests wrapper to powerdns_recursor. See [#4261](https://github.com/DataDog/integrations-core/pull/4261).

## 1.3.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style. See [#3558](https://github.com/DataDog/integrations-core/pull/3558).

## 1.2.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3. See [#2789][1].
