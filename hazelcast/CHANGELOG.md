...
* Add `pyproject.toml` file. See [#11360](https://github.com/DataDog/integrations-core/pull/11360).
...
* Add runtime configuration validation. See [#8926](https://github.com/DataDog/integrations-core/pull/8926).
...
* Document `mc_cluster_states` configuration option. See [#6704](https://github.com/DataDog/integrations-core/pull/6704).
...
* Add Hazelcast integration. See [#6236](https://github.com/DataDog/integrations-core/pull/6236).
