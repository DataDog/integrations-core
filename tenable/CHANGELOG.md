...
* Add `pyproject.toml` file ([#11446](https://github.com/DataDog/integrations-core/pull/11446))
...
* Update README.md and example log section ([#5898](https://github.com/DataDog/integrations-core/pull/5898))

## 1.0.0 / 2020-02-22

***Added***:

* Inital commit for Tenable integration ([#5743](https://github.com/DataDog/integrations-core/pull/5743))
