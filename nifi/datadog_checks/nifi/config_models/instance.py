...
class InstanceConfig(BaseModel):
    ...
    bulletin_min_level: Optional[str] = None
    collect_bulletins: Optional[bool] = None
    collect_connection_metrics: Optional[bool] = None
    collect_processor_metrics: Optional[bool] = None
    ...
    max_bulletins_per_cycle: Optional[int] = None
    ...
    process_groups: Optional[tuple[str, ...]] = None
