...
METRICS = [
    ...
    'litellm.auth.latency_created',
    'litellm.auth.total_requests.count',
    'litellm.auth.total_requests_created',
    ...
    'litellm.deployment.failure_responses_created',
    ...
    'litellm.deployment.total_requests_created',
    ...
    'litellm.llm.api.failed_requests.metric_created',
    ...
    'litellm.proxy.total_requests.metric_created',
