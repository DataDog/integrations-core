...
1. Add your `Sub Domain`, `Client ID` and `Secret Key`.
   ...
   | Get Detections | Controls the collection of Detections from Vectra. <br> Enabled by default.|
   | Get Entity Scoring Events | Controls the collection of Entity Scoring Events from Vectra. <br> Enabled by default.|
   | Get Audit Events | Controls the collection of Audit Events from Vectra. <br> Enabled by default.|
2. Click **Save**.
