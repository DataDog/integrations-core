...
COMMON_METRICS = [
    ...
    "varnish.vcl_fail",
    "varnish.vmods",
    "varnish.VBE.bereq_bodybytes",
    "varnish.VBE.bereq_hdrbytes",
    "varnish.VBE.beresp_bodybytes",
    "varnish.VBE.beresp_hdrbytes",
    "varnish.VBE.conn",
    "varnish.VBE.pipe_hdrbytes",
    "varnish.VBE.pipe_in",
    "varnish.VBE.pipe_out",
]
METRICS_5 = [
...
METRICS_6 = [
    ...
    "varnish.VBE.busy",
    "varnish.VBE.fail",
    "varnish.VBE.fail_eacces",
    "varnish.VBE.fail_eaddrnotavail",
    "varnish.VBE.fail_econnrefused",
    "varnish.VBE.fail_enetunreach",
    "varnish.VBE.fail_etimedout",
    "varnish.VBE.fail_other",
    "varnish.VBE.helddown",
    "varnish.VBE.unhealthy",
