...
def test_integration_replicaset_primary_in_shard(instance_integration, aggregator, check, dd_run_check):
    ...
    aggregator.assert_event(
        ...
        tags=[
            ...
            'node:mongo-mongodb-sharded-shard0-data-0.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'replset:mongo-mongodb-sharded-shard-0',
            'node:mongo-mongodb-sharded-shard0-arbiter-0.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'replset:mongo-mongodb-sharded-shard-0',
            'node:mongo-mongodb-sharded-shard0-data-1.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
...
def test_integration_configsvr_primary(instance_integration, aggregator, check, dd_run_check):
    ...
    aggregator.assert_event(
        ...
        tags=[
            ...
            'node:mongo-mongodb-sharded-configsvr-0.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'previous_member_status:PRIMARY',
            'replset:mongo-mongodb-sharded-configsvr',
            'node:mongo-mongodb-sharded-configsvr-1.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'previous_member_status:ARBITER',
            'replset:mongo-mongodb-sharded-configsvr',
            'node:mongo-mongodb-sharded-configsvr-2.mongo-mongodb-sharded-headless.default.svc.cluster.local:27017',
        ],
        count=1,
    )
...
def test_integration_replicaset_primary(instance_integration, aggregator, check, dd_run_check):
    ...
    aggregator.assert_event(
        ...
        tags=[
            ...
            'previous_member_status:SECONDARY',
            'replset:replset',
            'node:replset-data-0.mongo.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'previous_member_status:PRIMARY',
            'replset:replset',
            'node:replset-arbiter-0.mongo.default.svc.cluster.local:27017',
        ],
        count=1,
    )
    aggregator.assert_event(
        ...
        tags=[
            ...
            'previous_member_status:ARBITER',
            'replset:replset',
            'node:replset-data-1.mongo.default.svc.cluster.local:27017',
        ],
        count=1,
    )
