...
* Add deprecated `schemas` option to `config.yaml.example`. This config option is deprecated at Agent 7.69.0 and will be removed in a future release. ([#20783](https://github.com/DataDog/integrations-core/pull/20783))
