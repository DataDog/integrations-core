...
LATENCIES_METRICS = [
    ...
    'aerospike.namespace.latency.read_ops_sec',
    'aerospike.namespace.latency.udf_over_1ms',
    'aerospike.namespace.latency.udf_over_2ms',
    'aerospike.namespace.latency.udf_over_4ms',
    'aerospike.namespace.latency.udf_over_8ms',
    'aerospike.namespace.latency.udf_over_16ms',
    'aerospike.namespace.latency.udf_over_32ms',
    'aerospike.namespace.latency.udf_over_64ms',
    'aerospike.namespace.latency.udf_over_128ms',
    'aerospike.namespace.latency.udf_over_256ms',
    'aerospike.namespace.latency.udf_over_512ms',
    'aerospike.namespace.latency.udf_over_1024ms',
    'aerospike.namespace.latency.udf_over_2048ms',
    'aerospike.namespace.latency.udf_over_4096ms',
    'aerospike.namespace.latency.udf_over_8192ms',
    'aerospike.namespace.latency.udf_over_16384ms',
    'aerospike.namespace.latency.udf_over_32768ms',
    'aerospike.namespace.latency.udf_over_65536ms',
    'aerospike.namespace.latency.udf_ops_sec',
]
