...
COMMON_METRICS = [
    ...
    "geo.ci_secure_files_checksum_failed",
    "geo.ci_secure_files_checksum_total",
    "geo.ci_secure_files_checksummed",
    "geo.ci_secure_files_failed",
    "geo.ci_secure_files_synced",
    "geo.container_repositories_checksum_total",
    "geo.container_repositories_checksummed",
    "geo.dependency_proxy_blobs_checksum_failed",
    "geo.dependency_proxy_blobs_checksum_total",
    "geo.dependency_proxy_blobs_checksummed",
    "geo.dependency_proxy_blobs_failed",
    "geo.dependency_proxy_blobs_synced",
    "geo.dependency_proxy_manifests_checksum_failed",
    "geo.dependency_proxy_manifests_checksum_total",
    "geo.dependency_proxy_manifests_checksummed",
    "geo.dependency_proxy_manifests_failed",
    "geo.dependency_proxy_manifests_synced",
    "geo.design_management_repositories_checksum_failed",
    "geo.design_management_repositories_checksum_total",
    "geo.design_management_repositories_checksummed",
    "geo.design_management_repositories_failed",
    "geo.design_management_repositories_synced",
    "geo.job_artifacts",
    "geo.job_artifacts_checksum_failed",
    "geo.job_artifacts_checksum_total",
    "geo.job_artifacts_checksummed",
    "geo.job_artifacts_failed",
    "geo.job_artifacts_registry",
    "geo.job_artifacts_synced",
    "geo.job_artifacts_verified",
    "geo.packages_helm_metadata_caches_checksum_failed",
    "geo.packages_helm_metadata_caches_checksum_total",
    "geo.packages_helm_metadata_caches_checksummed",
    "geo.packages_helm_metadata_caches_failed",
    "geo.packages_helm_metadata_caches_synced",
    "geo.packages_nuget_symbols_checksum_failed",
    "geo.packages_nuget_symbols_checksum_total",
    "geo.packages_nuget_symbols_checksummed",
    "geo.packages_nuget_symbols_failed",
    "geo.packages_nuget_symbols_synced",
    "geo.pages_deployments_checksum_failed",
    "geo.pages_deployments_checksum_total",
    "geo.pages_deployments_checksummed",
    "geo.pages_deployments_failed",
    "geo.pages_deployments_synced",
    "geo.pipeline_artifacts_checksum_failed",
    "geo.pipeline_artifacts_checksum_total",
    "geo.pipeline_artifacts_checksummed",
    "geo.pipeline_artifacts_failed",
    "geo.pipeline_artifacts_synced",
    "geo.snippet_repositories_checksum_failed",
    "geo.snippet_repositories_checksum_total",
    "geo.snippet_repositories_checksummed",
    "geo.snippet_repositories_failed",
    "geo.snippet_repositories_synced",
    "geo.terraform_state_versions_checksum_failed",
    "geo.terraform_state_versions_checksum_total",
    "geo.terraform_state_versions_checksummed",
    "geo.terraform_state_versions_failed",
    "geo.terraform_state_versions_synced",
    "geo.uploads",
    "geo.uploads_checksum_failed",
    "geo.uploads_checksum_total",
    "geo.uploads_checksummed",
    "geo.uploads_failed",
    "geo.uploads_registry",
    "geo.uploads_synced",
    "geo.uploads_verification_total",
    "geo.uploads_verified",
...
GITALY_METRICS = [
    ...
    "gitaly.catfile_processes.count",
    ...
    "gitaly.go.memstats_alloc_bytes.count",
...
# Collected only when `workhorse_endpoint` is configured.
WORKHORSE_METRICS = [
    "workhorse.http_requests.count",
    "workhorse.http_request_duration_seconds.bucket",
    "workhorse.http_request_duration_seconds.sum",
    "workhorse.http_request_duration_seconds.count",
]

# Collected only when `sidekiq_endpoint` is configured. Distinct from the
# sidekiq_* metrics on the Rails endpoint, which the main scraper handles.
SIDEKIQ_EXPORTER_METRICS = [
    "sidekiq.load_balancing.count",
    "sidekiq.mem_total_bytes",
]
