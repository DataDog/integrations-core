...
GITALY_METRICS_MAP = {
    "gitaly_cacheinvalidator_rpc": "gitaly.cacheinvalidator_rpc",
    "gitaly_catfile_cache_members": "gitaly.catfile_cache_members",
    "gitaly_catfile_processes": "gitaly.catfile_processes",
    "gitaly_command_context_switches": "gitaly.command.context_switches",
    "gitaly_command_cpu_seconds": "gitaly.command.cpu_seconds",
    "gitaly_command_major_page_faults": "gitaly.command.major_page_faults",
    "gitaly_command_minor_page_faults": "gitaly.command.minor_page_faults",
    "gitaly_command_real_seconds": "gitaly.command.real_seconds",
    "gitaly_command_signals_received": "gitaly.command.signals_received",
    "gitaly_command_spawn_token_acquiring_seconds": "gitaly.command.spawn_token_acquiring_seconds",
    "gitaly_commands_running": "gitaly.commands_running",
    "gitaly_concurrency_limiting_acquiring_seconds": "gitaly.concurrency_limiting_acquiring_seconds",
    "gitaly_concurrency_limiting_in_progress": "gitaly.concurrency_limiting_in_progress",
    "gitaly_concurrency_limiting_queued": "gitaly.concurrency_limiting_queued",
    "gitaly_diskcache_bytes_fetched": "gitaly.diskcache.bytes_fetched",
    "gitaly_diskcache_bytes_loser": "gitaly.diskcache.bytes_loser",
    "gitaly_diskcache_bytes_stored": "gitaly.diskcache.bytes_stored",
    "gitaly_diskcache_miss": "gitaly.diskcache.miss",
    "gitaly_diskcache_requests": "gitaly.diskcache.requests",
    "gitaly_diskcache_walker_empty_dir_removal": "gitaly.diskcache.walker_empty_dir_removal",
    "gitaly_diskcache_walker_empty_dir": "gitaly.diskcache.walker_empty_dir",
    "gitaly_diskcache_walker_error": "gitaly.diskcache.walker_error",
    "gitaly_diskcache_walker_removal": "gitaly.diskcache.walker_removal",
    "gitaly_hook_transaction_voting_delay_seconds": "gitaly.hook_transaction_voting_delay_seconds",
    "gitaly_inforef_cache_attempt": "gitaly.inforef_cache_attempt",
    "gitaly_list_commits_by_oid_request_size": "gitaly.list_commits_by_oid_request_size",
    "gitaly_pack_objects_acquiring_seconds": "gitaly.pack_objects.acquiring_seconds",
    "gitaly_pack_objects_generated_bytes": "gitaly.pack_objects.generated_bytes",
    "gitaly_pack_objects_in_progress": "gitaly.pack_objects.in_progress",
    "gitaly_pack_objects_queued": "gitaly.pack_objects.queued",
    "gitaly_pack_objects_served_bytes": "gitaly.pack_objects.served_bytes",
    "gitaly_spawn_timeouts": "gitaly.spawn_timeouts",
    "gitaly_streamcache_sendfile_bytes": "gitaly.streamcache_sendfile_bytes",
    "go_gc_duration_seconds": "gitaly.go.gc_duration_seconds",
    "go_goroutines": "gitaly.go.goroutines",
    "go_info": "gitaly.go.info",
    "go_memstats_alloc_bytes": "gitaly.go.memstats_alloc_bytes",
    "go_memstats_buck_hash_sys_bytes": "gitaly.go.memstats_buck_hash_sys_bytes",
    "go_memstats_frees": "gitaly.go.memstats_frees",
    "go_memstats_gc_sys_bytes": "gitaly.go.memstats_gc_sys_bytes",
    "go_memstats_heap_alloc_bytes": "gitaly.go.memstats_heap_alloc_bytes",
    "go_memstats_heap_idle_bytes": "gitaly.go.memstats_heap_idle_bytes",
    "go_memstats_heap_inuse_bytes": "gitaly.go.memstats_heap_inuse_bytes",
    "go_memstats_heap_objects": "gitaly.go.memstats_heap_objects",
    "go_memstats_heap_released_bytes": "gitaly.go.memstats_heap_released_bytes",
    "go_memstats_heap_sys_bytes": "gitaly.go.memstats_heap_sys_bytes",
    "go_memstats_last_gc_time_seconds": "gitaly.go.memstats_last_gc_time_seconds",
    "go_memstats_lookups": "gitaly.go.memstats_lookups",
    "go_memstats_mallocs": "gitaly.go.memstats_mallocs",
    "go_memstats_mcache_inuse_bytes": "gitaly.go.memstats_mcache_inuse_bytes",
    "go_memstats_mcache_sys_bytes": "gitaly.go.memstats_mcache_sys_bytes",
    "go_memstats_mspan_inuse_bytes": "gitaly.go.memstats_mspan_inuse_bytes",
    "go_memstats_mspan_sys_bytes": "gitaly.go.memstats_mspan_sys_bytes",
    "go_memstats_next_gc_bytes": "gitaly.go.memstats_next_gc_bytes",
    "go_memstats_other_sys_bytes": "gitaly.go.memstats_other_sys_bytes",
    "go_memstats_stack_inuse_bytes": "gitaly.go.memstats_stack_inuse_bytes",
    "go_memstats_stack_sys_bytes": "gitaly.go.memstats_stack_sys_bytes",
    "go_memstats_sys_bytes": "gitaly.go.memstats_sys_bytes",
    "go_threads": "gitaly.go.threads",
    "grpc_server_handled": "gitaly.grpc_server.handled",
    "grpc_server_handling_seconds": "gitaly.grpc_server.handling_seconds",
    "grpc_server_msg_received": "gitaly.grpc_server.msg_received",
    "grpc_server_msg_sent": "gitaly.grpc_server.msg_sent",
    "grpc_server_started": "gitaly.grpc_server.started",
    "process_cpu_seconds": "gitaly.process_cpu_seconds",
    "process_max_fds": "gitaly.process_max_fds",
    "process_open_fds": "gitaly.process_open_fds",
    "process_resident_memory_bytes": "gitaly.process_resident_memory_bytes",
    "process_start_time_seconds": "gitaly.process_start_time_seconds",
    "process_virtual_memory_bytes": "gitaly.process_virtual_memory_bytes",
    "process_virtual_memory_max_bytes": "gitaly.process_virtual_memory_max_bytes",
    "promhttp_metric_handler_requests_in_flight": "gitaly.promhttp_metric_handler_requests_in_flight",
    "promhttp_metric_handler_requests": "gitaly.promhttp_metric_handler_requests",
}
