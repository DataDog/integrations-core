METRICS_MAP = {
    "gitlab_banzai_cached_render_real_duration_seconds_count": "banzai.cached_render_real_duration_seconds.count",
    "gitlab_banzai_cached_render_real_duration_seconds_sum": "banzai.cached_render_real_duration_seconds.sum",
    "gitlab_banzai_cacheless_render_real_duration_seconds_count": "banzai.cacheless_render_real_duration_seconds.count",
    "gitlab_banzai_cacheless_render_real_duration_seconds_sum": "banzai.cacheless_render_real_duration_seconds.sum",
    "gitlab_cache_misses_total": "cache.misses_total",
    "gitlab_cache_operation_duration_seconds_count": "cache.operation_duration_seconds.count",
    "gitlab_cache_operation_duration_seconds_sum": "cache.operation_duration_seconds.sum",
    "gitlab_cache_operations_total": "cache_operations_total",
    "gitlab_database_transaction_seconds_count": "database.transaction_seconds.count",
    "gitlab_database_transaction_seconds_sum": "database.transaction_seconds.sum",
    "gitlab_method_call_duration_seconds_count": "method_call_duration_seconds.count",
    "gitlab_method_call_duration_seconds_sum": "method_call_duration_seconds.sum",
    "gitlab_page_out_of_bounds": "page_out_of_bounds",
    "gitlab_rails_queue_duration_seconds_count": "rails_queue_duration_seconds.count",
    "gitlab_rails_queue_duration_seconds_sum": "rails_queue_duration_seconds.sum",
    "gitlab_sql_duration_seconds_count": "sql_duration_seconds.count",
    "gitlab_sql_duration_seconds_sum": "sql_duration_seconds.sum",
    "gitlab_transaction_allocated_memory_bytes_count": "transaction.allocated_memory_bytes.count",
    "gitlab_transaction_allocated_memory_bytes_sum": "transaction.allocated_memory_bytes.sum",
    ...
    "gitlab_transaction_duration_seconds_count": "transaction.duration_seconds.count",
    "gitlab_transaction_duration_seconds_sum": "transaction_duration_seconds.sum",
    ...
    "ruby_gc_duration_seconds": "ruby_gc_duration",
    "ruby_file_descriptors": "ruby.file_descriptors",
    "ruby_memory_bytes": "ruby.memory",
    "ruby_sampler_duration_seconds": "ruby.sampler_duration",
