...
METRICS_MAP = {
    ...
    'geo_ci_secure_files_checksum_failed': 'geo.ci_secure_files_checksum_failed',
    'geo_ci_secure_files_checksum_total': 'geo.ci_secure_files_checksum_total',
    'geo_ci_secure_files_checksummed': 'geo.ci_secure_files_checksummed',
    'geo_ci_secure_files_failed': 'geo.ci_secure_files_failed',
    'geo_ci_secure_files_synced': 'geo.ci_secure_files_synced',
    'geo_container_repositories_checksum_total': 'geo.container_repositories_checksum_total',
    'geo_container_repositories_checksummed': 'geo.container_repositories_checksummed',
    'geo_dependency_proxy_blobs_checksum_failed': 'geo.dependency_proxy_blobs_checksum_failed',
    'geo_dependency_proxy_blobs_checksum_total': 'geo.dependency_proxy_blobs_checksum_total',
    'geo_dependency_proxy_blobs_checksummed': 'geo.dependency_proxy_blobs_checksummed',
    'geo_dependency_proxy_blobs_failed': 'geo.dependency_proxy_blobs_failed',
    'geo_dependency_proxy_blobs_synced': 'geo.dependency_proxy_blobs_synced',
    'geo_dependency_proxy_manifests_checksum_failed': 'geo.dependency_proxy_manifests_checksum_failed',
    'geo_dependency_proxy_manifests_checksum_total': 'geo.dependency_proxy_manifests_checksum_total',
    'geo_dependency_proxy_manifests_checksummed': 'geo.dependency_proxy_manifests_checksummed',
    'geo_dependency_proxy_manifests_failed': 'geo.dependency_proxy_manifests_failed',
    'geo_dependency_proxy_manifests_synced': 'geo.dependency_proxy_manifests_synced',
    'geo_design_management_repositories_checksum_failed': 'geo.design_management_repositories_checksum_failed',
    'geo_design_management_repositories_checksum_total': 'geo.design_management_repositories_checksum_total',
    'geo_design_management_repositories_checksummed': 'geo.design_management_repositories_checksummed',
    'geo_design_management_repositories_failed': 'geo.design_management_repositories_failed',
    'geo_design_management_repositories_synced': 'geo.design_management_repositories_synced',
    'geo_job_artifacts': 'geo.job_artifacts',
    'geo_job_artifacts_checksum_failed': 'geo.job_artifacts_checksum_failed',
    'geo_job_artifacts_checksum_total': 'geo.job_artifacts_checksum_total',
    'geo_job_artifacts_checksummed': 'geo.job_artifacts_checksummed',
    'geo_job_artifacts_failed': 'geo.job_artifacts_failed',
    'geo_job_artifacts_registry': 'geo.job_artifacts_registry',
    'geo_job_artifacts_synced': 'geo.job_artifacts_synced',
    'geo_job_artifacts_verified': 'geo.job_artifacts_verified',
    'geo_packages_helm_metadata_caches_checksum_failed': 'geo.packages_helm_metadata_caches_checksum_failed',
    'geo_packages_helm_metadata_caches_checksum_total': 'geo.packages_helm_metadata_caches_checksum_total',
    'geo_packages_helm_metadata_caches_checksummed': 'geo.packages_helm_metadata_caches_checksummed',
    'geo_packages_helm_metadata_caches_failed': 'geo.packages_helm_metadata_caches_failed',
    'geo_packages_helm_metadata_caches_synced': 'geo.packages_helm_metadata_caches_synced',
    'geo_packages_nuget_symbols_checksum_failed': 'geo.packages_nuget_symbols_checksum_failed',
    'geo_packages_nuget_symbols_checksum_total': 'geo.packages_nuget_symbols_checksum_total',
    'geo_packages_nuget_symbols_checksummed': 'geo.packages_nuget_symbols_checksummed',
    'geo_packages_nuget_symbols_failed': 'geo.packages_nuget_symbols_failed',
    'geo_packages_nuget_symbols_synced': 'geo.packages_nuget_symbols_synced',
    'geo_pages_deployments_checksum_failed': 'geo.pages_deployments_checksum_failed',
    'geo_pages_deployments_checksum_total': 'geo.pages_deployments_checksum_total',
    'geo_pages_deployments_checksummed': 'geo.pages_deployments_checksummed',
    'geo_pages_deployments_failed': 'geo.pages_deployments_failed',
    'geo_pages_deployments_synced': 'geo.pages_deployments_synced',
    'geo_pipeline_artifacts_checksum_failed': 'geo.pipeline_artifacts_checksum_failed',
    'geo_pipeline_artifacts_checksum_total': 'geo.pipeline_artifacts_checksum_total',
    'geo_pipeline_artifacts_checksummed': 'geo.pipeline_artifacts_checksummed',
    'geo_pipeline_artifacts_failed': 'geo.pipeline_artifacts_failed',
    'geo_pipeline_artifacts_synced': 'geo.pipeline_artifacts_synced',
    'geo_snippet_repositories_checksum_failed': 'geo.snippet_repositories_checksum_failed',
    'geo_snippet_repositories_checksum_total': 'geo.snippet_repositories_checksum_total',
    'geo_snippet_repositories_checksummed': 'geo.snippet_repositories_checksummed',
    'geo_snippet_repositories_failed': 'geo.snippet_repositories_failed',
    'geo_snippet_repositories_synced': 'geo.snippet_repositories_synced',
    'geo_terraform_state_versions_checksum_failed': 'geo.terraform_state_versions_checksum_failed',
    'geo_terraform_state_versions_checksum_total': 'geo.terraform_state_versions_checksum_total',
    'geo_terraform_state_versions_checksummed': 'geo.terraform_state_versions_checksummed',
    'geo_terraform_state_versions_failed': 'geo.terraform_state_versions_failed',
    'geo_terraform_state_versions_synced': 'geo.terraform_state_versions_synced',
    'geo_uploads': 'geo.uploads',
    'geo_uploads_checksum_failed': 'geo.uploads_checksum_failed',
    'geo_uploads_checksum_total': 'geo.uploads_checksum_total',
    'geo_uploads_checksummed': 'geo.uploads_checksummed',
    'geo_uploads_failed': 'geo.uploads_failed',
    'geo_uploads_registry': 'geo.uploads_registry',
    'geo_uploads_synced': 'geo.uploads_synced',
    'geo_uploads_verification_total': 'geo.uploads_verification_total',
    'geo_uploads_verified': 'geo.uploads_verified',
    ...
    'sidekiq_enqueued_jobs_total': 'sidekiq.enqueued_jobs_total',
...
OPENMETRICS_V2_TYPE_OVERRIDES = {
    ...
    "geo_ci_secure_files_checksum_total": "gauge",
    "geo_container_repositories_checksum_total": "gauge",
    "geo_dependency_proxy_blobs_checksum_total": "gauge",
    "geo_dependency_proxy_manifests_checksum_total": "gauge",
    "geo_design_management_repositories_checksum_total": "gauge",
    "geo_job_artifacts_checksum_total": "gauge",
    "geo_packages_helm_metadata_caches_checksum_total": "gauge",
    "geo_packages_nuget_symbols_checksum_total": "gauge",
    "geo_pages_deployments_checksum_total": "gauge",
    "geo_pipeline_artifacts_checksum_total": "gauge",
    "geo_snippet_repositories_checksum_total": "gauge",
    "geo_terraform_state_versions_checksum_total": "gauge",
    "geo_uploads_checksum_total": "gauge",
    "geo_uploads_verification_total": "gauge",
...
GITALY_METRICS_MAP = {
    ...
    "gitaly_catfile_cache": "catfile_cache",
    ...
    "gitaly_concurrency_limiting_current_limit": "concurrency_limiting_current_limit",
    ...
    "gitaly_connections": "connections",
    ...
    "gitaly_service_client_requests": "service_client_requests",
    "gitaly_spawn_timeouts": "spawn_timeouts",
    "gitaly_total_repositories_count": "total_repositories_count",
    "gitaly_streamcache_sendfile_bytes": "streamcache_sendfile_bytes",
    "gitlab_build_info": "build_info",
...
# Workhorse serves these on its own listener, not on the Rails metrics endpoint.
# Passed to the scraper as-is, so counter keys omit the `_total` suffix that
# OpenMetrics v2 strips when matching.
WORKHORSE_METRICS_MAP = {
    "gitlab_workhorse_http_request_duration_seconds": "http_request_duration_seconds",
    "gitlab_workhorse_http_requests": "http_requests",
}


# Served by the Sidekiq exporter (sidekiq['metrics_enabled']), again a separate
# listener from Rails.
SIDEKIQ_METRICS_MAP = {
    # Upstream name already ends in _count and it is a counter, so mapping it
    # verbatim would submit gitlab.sidekiq.load_balancing_count.count.
    "sidekiq_load_balancing_count": "load_balancing",
    "sidekiq_mem_total_bytes": "mem_total_bytes",
}
