...
if TYPE_CHECKING:
    from .remote_query import ClickhouseRemoteQueryHandler
...
class ClickhouseCheck(DatabaseCheck):
    ...
    def get_remote_query_handler(self) -> 'ClickhouseRemoteQueryHandler':
        ...
        return ClickhouseRemoteQueryHandler(self)
