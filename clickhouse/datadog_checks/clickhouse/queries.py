    ...
    'columns': [
        {'name': 'value', 'type': 'source'},
        {
            ...
            'items': {
                ...
                'MaxDDLEntryID': {'name': 'ddl.entry.id.max', 'type': 'gauge'},
    ...
    'columns': [
        {'name': 'value', 'type': 'source'},
        {
            ...
            'items': {
                ...
                'PerfCpuClock': {'name': 'perf.cpu.clock', 'type': 'monotonic_gauge'},
                ...
                'PerfMinEnabledRunningTime': {'name': 'perf.min_enabled.running.time', 'type': 'monotonic_gauge'},
                'PerfMinEnabledTime': {'name': 'perf.min_enabled.time', 'type': 'monotonic_gauge'},
                ...
                'PerfTaskClock': {'name': 'perf.task.clock', 'type': 'monotonic_gauge'},
                ...
                'S3ReadRequestsCount': {'name': 's3.read.requests.count', 'type': 'monotonic_gauge'},
                ...
                'S3WriteRequestsCount': {'name': 's3.write.requests.count', 'type': 'monotonic_gauge'},
