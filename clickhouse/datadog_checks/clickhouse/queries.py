    ...
    'columns': [
        {'name': 'value', 'type': 'source'},
        {
            ...
            'items': {
                ...
                'BackgroundBufferFlushSchedulePoolSize': {'name': 'background_pool.buffer_flush_schedule.task.limit', 'type': 'gauge'},
                ...
                'DatabaseReplicatedCreateTablesThreadsActive': {'name': 'threads.database_replicated.active', 'type': 'gauge'},
                'DatabaseReplicatedCreateTablesThreadsScheduled': {'name': 'threads.database_replicated.scheduled', 'type': 'gauge'},
                ...
                'DiskObjectStorageAsyncThreadsActive': {'name': 'threads.async.disk_object_storage.active', 'type': 'gauge'},
                ...
                'DistrCacheServerConnections': {'name': 'distributed_cache.clickhouse_server.connections.open', 'type': 'gauge'},
                ...
                'MergeTreeBackgroundExecutorThreads': {'name': 'threads.merge_tree_background_executor.total', 'type': 'gauge'},
                'MergeTreeBackgroundExecutorThreadsActive': {'name': 'threads.merge_tree_background_executor.active', 'type': 'gauge'},
                'MergeTreeBackgroundExecutorThreadsScheduled': {'name': 'threads.merge_tree_background_executor.scheduled', 'type': 'gauge'},
                'MergeTreeDataSelectExecutorThreads': {'name': 'threads.merge_tree_data_selector_executor.total', 'type': 'gauge'},
                'MergeTreeDataSelectExecutorThreadsActive': {'name': 'threads.merge_tree_data_selector_executor.active', 'type': 'gauge'},
                'MergeTreeDataSelectExecutorThreadsScheduled': {'name': 'threads.merge_tree_data_selector_executor.scheduled', 'type': 'gauge'},
                'MergeTreeOutdatedPartsLoaderThreads': {'name': 'threads.merge_tree_outdated_parts_loader.total', 'type': 'gauge'},
                'MergeTreeOutdatedPartsLoaderThreadsActive': {'name': 'threads.merge_tree_outdated_parts_loader.active', 'type': 'gauge'},
                'MergeTreeOutdatedPartsLoaderThreadsScheduled': {'name': 'threads.merge_tree_outdated_parts_loader.scheduled', 'type': 'gauge'},
                'MergeTreePartsCleanerThreads': {'name': 'threads.merge_tree_parts_cleaner.total', 'type': 'gauge'},
                'MergeTreePartsCleanerThreadsActive': {'name': 'threads.merge_tree_parts_cleaner.active', 'type': 'gauge'},
                'MergeTreePartsCleanerThreadsScheduled': {'name': 'threads.merge_tree_parts_cleaner.scheduled', 'type': 'gauge'},
                'MergeTreePartsLoaderThreads': {'name': 'threads.merge_tree_parts_loader.total', 'type': 'gauge'},
                'MergeTreePartsLoaderThreadsActive': {'name': 'threads.merge_tree_parts_loader.active', 'type': 'gauge'},
                'MergeTreePartsLoaderThreadsScheduled': {'name': 'threads.merge_tree_parts_loader.scheduled', 'type': 'gauge'},
                ...
                'ObjectStorageAzureThreadsScheduled': {'name': 'threads.azure_object_storage.scheduled', 'type': 'gauge'},
                ...
                'OutdatedPartsLoadingThreadsScheduled': {'name': 'threads.outdated_parts_loading.scheduled', 'type': 'gauge'},
                'ParallelFormattingOutputFormatThreads': {'name': 'threads.parallel_formatting_output.total', 'type': 'gauge'},
                'ParallelFormattingOutputFormatThreadsActive': {'name': 'threads.parallel_formatting_output.active', 'type': 'gauge'},
                'ParallelFormattingOutputFormatThreadsScheduled': {'name': 'threads.parallel_formatting_output.scheduled', 'type': 'gauge'},
                'ParallelParsingInputFormatThreads': {'name': 'threads.parallel_parsing_input.total', 'type': 'gauge'},
                'ParallelParsingInputFormatThreadsActive': {'name': 'threads.parallel_parsing_input.active', 'type': 'gauge'},
                'ParallelParsingInputFormatThreadsScheduled': {'name': 'threads.parallel_parsing_input.scheduled', 'type': 'gauge'},
                ...
                'QueryPipelineExecutorThreadsActive': {'name': 'threads.query_pipeline_executor.active', 'type': 'gauge'},
                'QueryPipelineExecutorThreadsScheduled': {'name': 'threads.query_pipeline_executor.scheduled', 'type': 'gauge'},
                ...
                'StartupSystemTablesThreadsScheduled': {'name': 'threads.startup_system_tables.scheduled', 'type': 'gauge'},
                ...
                'StorageBufferFlushThreadsScheduled': {'name': 'threads.storage_buffer_flush.scheduled', 'type': 'gauge'},
                ...
                'StorageDistributedThreadsScheduled': {'name': 'threads.storage_distributed.scheduled', 'type': 'gauge'},
                ...
                'TablesLoaderBackgroundThreadsActive': {'name': 'threads.tables_loader_background.active', 'type': 'gauge'},
                'TablesLoaderBackgroundThreadsScheduled': {'name': 'threads.tables_loader_background.scheduled', 'type': 'gauge'},
                'TablesLoaderForegroundThreads': {'name': 'threads.tables_loader_foreground.total', 'type': 'gauge'},
                'TablesLoaderForegroundThreadsActive': {'name': 'threads.tables_loader_foreground.active', 'type': 'gauge'},
                'TablesLoaderForegroundThreadsScheduled': {'name': 'threads.tables_loader_foreground.scheduled', 'type': 'gauge'},
                ...
                'ThreadPoolRemoteFSReaderThreadsActive': {'name': 'threads.pool.remote_fs_reader.active', 'type': 'gauge'},
                'ThreadPoolRemoteFSReaderThreadsScheduled': {'name': 'threads.pool.remote_fs_reader.scheduled', 'type': 'gauge'},
    ...
    'columns': [
        {'name': 'value', 'type': 'source'},
        {
            ...
            'items': {
                ...
                'AggregationHashTablesInitializedAsTwoLevel': {'name': 'hash_table.initialized.aggregation.two_level', 'type': 'monotonic_gauge'},
                'AggregationOptimizedEqualRangesOfKeys': {'name': 'blocks.optimization.equal', 'type': 'monotonic_gauge'},
                'AggregationPreallocatedElementsInHashTables': {'name': 'hash_table.elements.allocated.aggregation', 'type': 'monotonic_gauge'},
                ...
                'AsyncLoaderWaitMicroseconds': {'name': 'query.async.loader.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'AsynchronousReadWaitMicroseconds': {'name': 'async.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'AsynchronousReaderIgnoredBytes': {'name': 'async.reader.ignored.bytes', 'type': 'monotonic_gauge'},
                'AsynchronousRemoteReadWaitMicroseconds': {'name': 'async.remote_read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'BackupEntriesCollectorForTablesDataMicroseconds': {'name': 'backup.tables.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'BackupEntriesCollectorMicroseconds': {'name': 'backup.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'BackupEntriesCollectorRunPostTasksMicroseconds': {'name': 'backup.post_tasks.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'BackupReadMetadataMicroseconds': {'name': 'backup.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'BackupWriteMetadataMicroseconds': {'name': 'backup.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'CacheWarmerDataPartsDownloaded': {'name': 'cachewarmer.data_parts.downloaded', 'type': 'monotonic_gauge'},
                'CachedReadBufferCacheWriteBytes': {'name': 'cache.source.write.bytes', 'type': 'monotonic_gauge'},
                'CachedReadBufferCacheWriteMicroseconds': {'name': 'cache.source.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'CachedReadBufferCreateBufferMicroseconds': {'name': 'cache.buffer.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'CachedReadBufferReadFromCacheMicroseconds': {'name': 'cache.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'CachedReadBufferReadFromSourceMicroseconds': {'name': 'cache.source.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'CachedWriteBufferCacheWriteBytes': {'name': 'cache.write.bytes', 'type': 'monotonic_gauge'},
                'CachedWriteBufferCacheWriteMicroseconds': {'name': 'cache.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ConnectionPoolIsFullMicroseconds': {'name': 'pool.connection.slot.wait_time', 'type': 'monotonic_gauge'},
                ...
                'DataAfterMutationDiffersFromReplica': {'name': 'mutated_data.not_equal.replica.num', 'type': 'monotonic_gauge'},
                ...
                'DictCacheKeysRequestedFound': {'name': 'dictionary.cache.keys.requested.found', 'type': 'monotonic_gauge'},
                'DictCacheKeysRequestedMiss': {'name': 'dictionary.cache.keys.requested.missed', 'type': 'monotonic_gauge'},
                'DictCacheLockReadNs': {'name': 'dictionary.cache.read.waiting.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DictCacheLockWriteNs': {'name': 'dictionary.cache.write.waiting.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DictCacheRequestTimeNs': {'name': 'dictionary.cache.request.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DirectorySyncElapsedMicroseconds': {'name': 'syscall.directory.sync.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DiskConnectionsElapsedMicroseconds': {'name': 'disk.connections.created.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DiskS3CompleteMultipartUpload': {'name': 'disk_s3.complete_multipart_upload', 'type': 'monotonic_gauge'},
                ...
                'DiskS3GetRequestThrottlerCount': {'name': 'disk_s3.get_request.throttler.count', 'type': 'monotonic_gauge'},
                'DiskS3GetRequestThrottlerSleepMicroseconds': {'name': 'disk_s3.get_request.throttler.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DiskS3PutRequestThrottlerCount': {'name': 'disk_s3.put_request.throttler.count', 'type': 'monotonic_gauge'},
                'DiskS3PutRequestThrottlerSleepMicroseconds': {'name': 'disk_s3.put_request.throttler.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DiskS3ReadMicroseconds': {'name': 'disk_s3.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DiskS3WriteMicroseconds': {'name': 'disk_s3.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'DiskS3WriteRequestsThrottling': {'name': 'disk_s3.write.requests.throttling', 'type': 'monotonic_gauge'},
                'DiskWriteElapsedMicroseconds': {
                    'name': 'syscall.write.wait',
                    'type': 'temporal_percent',
                    'scale': 'microsecond',
                },
                'DistrCacheConnectAttempts': {'name': 'cache.distributed.connection.attempts', 'type': 'monotonic_gauge'},
                'DistrCacheConnectMicroseconds': {'name': 'cache.distributed.connection.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheFallbackReadMicroseconds': {'name': 'cache.distributed.fallback.read', 'type': 'monotonic_gauge'},
                'DistrCacheGetClient': {'name': 'cache.distributed.client_access', 'type': 'monotonic_gauge'},
                'DistrCacheGetResponseMicroseconds': {'name': 'cache.distributed.response.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheHoldConnections': {'name': 'cache.distributed.connections.used', 'type': 'monotonic_gauge'},
                'DistrCacheLockRegistryMicroseconds': {'name': 'cache.distributed.registry_lock.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheNextImplMicroseconds': {'name': 'cache.distributed.read_buffer_next_impl.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheOpenedConnections': {'name': 'cache.distributed.connections.open', 'type': 'monotonic_gauge'},
                'DistrCachePackets': {'name': 'cache.distributed.packets.received', 'type': 'monotonic_gauge'},
                'DistrCachePrecomputeRangesMicroseconds': {'name': 'cache.distributed.read.compute.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheReadMicroseconds': {'name': 'cache.distributed.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheRegistryUpdateMicroseconds': {'name': 'cache.distributed.registry.update.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheRegistryUpdates': {'name': 'cache.distributed.registry.updates', 'type': 'monotonic_gauge'},
                'DistrCacheReusedConnections': {'name': 'cache.distributed.connections.reused', 'type': 'monotonic_gauge'},
                'DistrCacheServerProcessRequestMicroseconds': {'name': 'cache.distributed.server.requests.process_time', 'type': 'monotonic_gauge'},
                'DistrCacheServerSwitches': {'name': 'cache.distributed.server.switches', 'type': 'monotonic_gauge'},
                'DistrCacheStartRangeMicroseconds': {'name': 'cache.distributed.new_read_range.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'DistrCacheUnusedPackets': {'name': 'cache.distributed.packets.skipped', 'type': 'monotonic_gauge'},
                'DistrCacheUnusedPacketsBytes': {'name': 'cache.distributed.packets.skipped.bytes', 'type': 'monotonic_gauge'},
                'DistributedAsyncInsertionFailures': {'name': 'distributed.async.inserts.failed', 'type': 'monotonic_gauge'},
                ...
                'DistributedConnectionMissingTable': {'name': 'distributed.connection.missing_table', 'type': 'monotonic_gauge'},
                'DistributedConnectionStaleReplica': {'name': 'distributed.connection.stale_replica', 'type': 'monotonic_gauge'},
                ...
                'DistributedSyncInsertionTimeoutExceeded': {'name': 'distributed.inserts.timeout', 'type': 'monotonic_gauge'},
                ...
                'ExternalAggregationCompressedBytes': {'name': 'memory.external.aggregation.bytes', 'type': 'monotonic_gauge'},
                'ExternalAggregationMerge': {'name': 'memory.external.aggregation.files_merged', 'type': 'monotonic_gauge'},
                'ExternalAggregationUncompressedBytes': {'name': 'memory.external.aggregation.uncompressed_bytes', 'type': 'monotonic_gauge'},
                'ExternalAggregationWritePart': {'name': 'memory.external.aggregation.files.num_written', 'type': 'monotonic_gauge'},
                'ExternalDataSourceLocalCacheReadBytes': {'name': 'cache.remote_read_buffer.read.bytes', 'type': 'monotonic_gauge'},
                'ExternalJoinCompressedBytes': {'name': 'memory.external.join.compressed_bytes', 'type': 'monotonic_gauge'},
                'ExternalJoinMerge': {'name': 'memory.external.join.files.merged', 'type': 'monotonic_gauge'},
                'ExternalJoinUncompressedBytes': {'name': 'memory.external.join.uncompressed_bytes', 'type': 'monotonic_gauge'},
                'ExternalJoinWritePart': {'name': 'memory.external.join.files.num_written', 'type': 'monotonic_gauge'},
                'ExternalProcessingCompressedBytesTotal': {'name': 'processing.external.compressed.bytes', 'type': 'monotonic_gauge'},
                'ExternalProcessingFilesTotal': {'name': 'processing.external.files.total', 'type': 'monotonic_gauge'},
                'ExternalProcessingUncompressedBytesTotal': {'name': 'processing.external.uncompressed.bytes', 'type': 'monotonic_gauge'},
                'ExternalSortCompressedBytes': {'name': 'memory.external.sort.compressed_bytes', 'type': 'monotonic_gauge'},
                'ExternalSortMerge': {'name': 'memory.external.sort.files.num_written', 'type': 'monotonic_gauge'},
                'ExternalSortUncompressedBytes': {'name': 'memory.external.sort.uncompressed_bytes', 'type': 'monotonic_gauge'},
                ...
                'FileSegmentCacheWriteMicroseconds': {'name': 'file_segment.cache.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentCompleteMicroseconds': {'name': 'file_segment.cache.complete.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentFailToIncreasePriority': {'name': 'file_segment.cache.priority_increase.fail', 'type': 'monotonic_gauge'},
                'FileSegmentHolderCompleteMicroseconds': {'name': 'file_segment.holder.complete.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentLockMicroseconds': {'name': 'file_segment.lock.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentPredownloadMicroseconds': {'name': 'file_segment.cache.predownload.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentReadMicroseconds': {'name': 'file_segment.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentRemoveMicroseconds': {'name': 'file_segment.remove.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FileSegmentUseMicroseconds': {'name': 'file_segment.use.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'FileSegmentWaitReadBufferMicroseconds': {'name': 'file_segment.read.wait_time', 'type': 'monotonic_gauge'},
                ...
                'FileSyncElapsedMicroseconds': {'name': 'function.filesync.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheEvictMicroseconds': {'name': 'filesystem.cache.eviction.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheEvictedBytes': {'name': 'filesystem.cache.eviction.bytes', 'type': 'monotonic_gauge'},
                'FilesystemCacheEvictedFileSegments': {'name': 'filesystem.cache.eviction.file_segments', 'type': 'monotonic_gauge'},
                'FilesystemCacheEvictionSkippedFileSegments': {'name': 'filesystem.cache.eviction.file_segments.skipped', 'type': 'monotonic_gauge'},
                'FilesystemCacheEvictionTries': {'name': 'filesystem.cache.eviction.attempts', 'type': 'monotonic_gauge'},
                'FilesystemCacheFailToReserveSpaceBecauseOfLockContention': {'name': 'filesystem.cache.lock.fail', 'type': 'monotonic_gauge'},
                'FilesystemCacheGetMicroseconds': {'name': 'filesystem.cache.get.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheGetOrSetMicroseconds': {'name': 'filesystem.cache.get_set.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheHoldFileSegments': {'name': 'filesystem.cache.file_segments.held', 'type': 'monotonic_gauge'},
                'FilesystemCacheLoadMetadataMicroseconds': {'name': 'filesystem.cache.metadata.load.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheLockCacheMicroseconds': {'name': 'filesystem.cache.lock.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheLockKeyMicroseconds': {'name': 'filesystem.cache.lock.key.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheLockMetadataMicroseconds': {'name': 'filesystem.cache.lock.metadata.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheReserveMicroseconds': {'name': 'filesystem.cache.reserve.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'FilesystemCacheUnusedHoldFileSegments': {'name': 'filesystem.cache.file_segments.held.unused', 'type': 'monotonic_gauge'},
                ...
                'HTTPConnectionsElapsedMicroseconds': {'name': 'connections.http.created.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'InsertQueryTimeMicroseconds': {'name': 'insert.query.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'InterfaceInterserverReceiveBytes': {'name': 'interface.interserver.received.bytes', 'type': 'monotonic_gauge'},
                'InterfaceInterserverSendBytes': {'name': 'interface.interserver.sent.bytes', 'type': 'monotonic_gauge'},
                ...
                'InterfacePostgreSQLReceiveBytes': {'name': 'interface.postgresql.received.bytes', 'type': 'monotonic_gauge'},
                'InterfacePostgreSQLSendBytes': {'name': 'interface.postgresql.sent.bytes', 'type': 'monotonic_gauge'},
                'InterfacePrometheusReceiveBytes': {'name': 'interface.prometheus.received.bytes', 'type': 'monotonic_gauge'},
                ...
                'KeeperLogsEntryReadFromCommitCache': {'name': 'keeper.log_entry.commit_cache.read', 'type': 'monotonic_gauge'},
                'KeeperLogsEntryReadFromFile': {'name': 'keeper.log_entry.file.read', 'type': 'monotonic_gauge'},
                'KeeperLogsEntryReadFromLatestCache': {'name': 'keeper.log_entry.latest_cache.read', 'type': 'monotonic_gauge'},
                ...
                'LocalReadThrottlerSleepMicroseconds': {'name': 'throttler.local_read.sleep.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'LocalWriteThrottlerBytes': {'name': 'throttler.local_write.bytes', 'type': 'monotonic_gauge'},
                'LocalWriteThrottlerSleepMicroseconds': {'name': 'throttler.local_write.sleep.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'MemoryAllocatorPurgeTimeMicroseconds': {'name': 'memory.allocator.purge.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MemoryOvercommitWaitTimeMicroseconds': {'name': 'memory.allocator.purge.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'Merge': {'name': 'merge', 'type': 'monotonic_gauge'},
                'MergeTreeAllRangesAnnouncementsSent': {'name': 'table.mergetree.announcements.sent', 'type': 'monotonic_gauge'},
                'MergeTreeAllRangesAnnouncementsSentElapsedMicroseconds': {'name': 'table.mergetree.announcements.sent.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'MergeTreeDataProjectionWriterMergingBlocksMicroseconds': {'name': 'table.mergetree.merging.projection.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataProjectionWriterRows': {
                    'name': 'table.mergetree.insert.write.row.projection',
                    'type': 'monotonic_gauge',
                },
                'MergeTreeDataProjectionWriterSortingBlocksMicroseconds': {'name': 'table.mergetree.sorting.projection.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'MergeTreeDataWriterMergingBlocksMicroseconds': {'name': 'table.mergetree.merging.blocks.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataWriterProjectionsCalculationMicroseconds': {'name': 'table.mergetree.calculating.projections.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataWriterRows': {'name': 'table.mergetree.insert.row', 'type': 'monotonic_gauge'},
                'MergeTreeDataWriterSkipIndicesCalculationMicroseconds': {'name': 'table.mergetree.calculating.skip_indices.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataWriterSortingBlocksMicroseconds': {'name': 'table.mergetree.calculating.sorting.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataWriterStatisticsCalculationMicroseconds': {'name': 'table.mergetree.calculating.statistics.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeDataWriterUncompressedBytes': {
                    'name': 'table.mergetree.insert.write.size.uncompressed',
                    'type': 'monotonic_gauge',
                },
                'MergeTreePrefetchedReadPoolInit': {'name': 'table.mergetree.prefetched_read_pool.tasks.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MergeTreeReadTaskRequestsReceived': {'name': 'table.mergetree.read_task_requests.received', 'type': 'monotonic_gauge'},
                'MergeTreeReadTaskRequestsSent': {'name': 'table.mergetree.read_task_requests.sent', 'type': 'monotonic_gauge'},
                'MergeTreeReadTaskRequestsSentElapsedMicroseconds': {'name': 'table.mergetree.read_task_requests.sent.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'MetadataFromKeeperBackgroundCleanupErrors': {'name': 'keeper.background.cleanup.errors', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperBackgroundCleanupObjects': {'name': 'keeper.background.cleanup.objects', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperBackgroundCleanupTransactions': {'name': 'keeper.background.cleanup.transactions', 'type': 'monotonic_gauge'},
                ...
                'MetadataFromKeeperCacheUpdateMicroseconds': {'name': 'keeper.cache.update.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MetadataFromKeeperCleanupTransactionCommit': {'name': 'keeper.cleanup.transaction.commit', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperCleanupTransactionCommitRetry': {'name': 'keeper.cleanup.transaction.commit.retry', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperIndividualOperations': {'name': 'keeper.individual.operations', 'type': 'monotonic_gauge'},
                ...
                'MetadataFromKeeperTransactionCommit': {'name': 'keeper.transactions.commit', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperTransactionCommitRetry': {'name': 'keeper.trasaction.commit.retry', 'type': 'monotonic_gauge'},
                'MetadataFromKeeperUpdateCacheOneLevel': {'name': 'keeper.update.cache.one_level', 'type': 'monotonic_gauge'},
                'MutateTaskProjectionsCalculationMicroseconds': {'name': 'task.mutate.calculate.projections.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'MutationsAppliedOnFlyInAllParts': {'name': 'mutations.parts.applied.on_fly', 'type': 'monotonic_gauge'},
                ...
                'OpenedFileCacheMicroseconds': {'name': 'cache.opened_file.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'OpenedFileCacheMisses': {'name': 'cache.opened_file.misses', 'type': 'monotonic_gauge'},
                'OtherQueryTimeMicroseconds': {'name': 'query.other.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'PageCacheBytesUnpinnedRoundedToHugePages': {'name': 'cache.page.unpinned.rounded_huge_pages.bytes', 'type': 'monotonic_gauge'},
                'PageCacheBytesUnpinnedRoundedToPages': {'name': 'cache.page.unpinned.rounded_pages.bytes', 'type': 'monotonic_gauge'},
                ...
                'ParallelReplicasCollectingOwnedSegmentsMicroseconds': {'name': 'replicas.parralel.collect_segment.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasDeniedRequests': {'name': 'replicas.parralel.requests.denied', 'type': 'monotonic_gauge'},
                'ParallelReplicasHandleAnnouncementMicroseconds': {'name': 'replicas.parralel.announcement.handle.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasHandleRequestMicroseconds': {'name': 'replicas.parralel.request.handle.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasNumRequests': {'name': 'replicas.parralel.requests', 'type': 'monotonic_gauge'},
                'ParallelReplicasProcessingPartsMicroseconds': {'name': 'replicas.parralel.processing.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasReadAssignedForStealingMarks': {'name': 'replicas.parralel.marks.stealing.assigned', 'type': 'monotonic_gauge'},
                'ParallelReplicasReadAssignedMarks': {'name': 'replicas.parralel.marks.assigned', 'type': 'monotonic_gauge'},
                'ParallelReplicasReadUnassignedMarks': {'name': 'replicas.parralel.marks.unassigned', 'type': 'monotonic_gauge'},
                'ParallelReplicasStealingByHashMicroseconds': {'name': 'replicas.parralel.hash.stealing.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasStealingLeftoversMicroseconds': {'name': 'replicas.parralel.leftover_segment.stealing.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ParallelReplicasUnavailableCount': {'name': 'replicas.parralel.unavailable', 'type': 'monotonic_gauge'},
                'ParallelReplicasUsedCount': {'name': 'replicas.parralel.used', 'type': 'monotonic_gauge'},
                'PartsLockHoldMicroseconds': {'name': 'table.mergetree.partslock.hold.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'PartsLockWaitMicroseconds': {'name': 'table.mergetree.partslock.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'QueryProfilerConcurrencyOverruns': {'name': 'query.signal.dropped.overload', 'type': 'monotonic_gauge'},
                ...
                'RWLockReadersWaitMilliseconds': {'name': 'lock.read.rwlock.acquired.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'RWLockWritersWaitMilliseconds': {'name': 'lock.write.rwlock.acquired.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ReadBufferFromS3InitMicroseconds': {'name': 's3.connect.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ReadBufferFromS3Microseconds': {'name': 's3.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ReadTaskRequestsSentElapsedMicroseconds': {'name': 'task.read.requests.sent.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ReadWriteBufferFromHTTPPreservedSessions': {'name': 'http.sessions.preserved', 'type': 'monotonic_gauge'},
                ...
                'RemoteFSCancelledPrefetches': {'name': 'filesystem.remote.prefetches.cancelled', 'type': 'monotonic_gauge'},
                ...
                'RemoteFSUnprefetchedReads': {'name': 'filesystem.remote.unprefetched.reads', 'type': 'monotonic_gauge'},
                ...
                'RemoteReadThrottlerSleepMicroseconds': {'name': 'remote.query.read_throttler.sleep.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'RemoteWriteThrottlerBytes': {'name': 'remote.write_throttler.bytes', 'type': 'monotonic_gauge'},
                'RemoteWriteThrottlerSleepMicroseconds': {'name': 'remote.query.write_throttler.sleep.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'S3GetRequestThrottlerSleepMicroseconds': {'name': 's3.get_request.throttled.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'S3PutRequestThrottlerSleepMicroseconds': {'name': 's3.put_request.throttled.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueueCleanupMaxSetSizeOrTTLMicroseconds': {'name': 's3.set_file.failed.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueueLockLocalFileStatusesMicroseconds': {'name': 's3.lock_localfile_status.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueuePullMicroseconds': {'name': 's3.read.file.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueueSetFileFailedMicroseconds': {'name': 's3.set.file.failed.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueueSetFileProcessedMicroseconds': {'name': 's3.set.file.processed.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'S3QueueSetFileProcessingMicroseconds': {'name': 's3.set.file.processing.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ScalarSubqueriesGlobalCacheHit': {'name': 'subquery.scalar.read.cache.global', 'type': 'monotonic_gauge'},
                'ScalarSubqueriesLocalCacheHit': {'name': 'subquery.scalar.read.cache.local', 'type': 'monotonic_gauge'},
                ...
                'ServerStartupMilliseconds': {'name': 'server.startup.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'SleepFunctionCalls': {'name': 'sleep_function.calls', 'type': 'monotonic_gauge'},
                'SleepFunctionElapsedMicroseconds': {'name': 'sleep_function.sleep.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'StorageBufferPassedAllMinThresholds': {'name': 'storage.buffer.min_thresholds.passed', 'type': 'monotonic_gauge'},
                'StorageBufferPassedBytesFlushThreshold': {'name': 'storage.buffer.passed_bytes.flush_threshold', 'type': 'monotonic_gauge'},
                'StorageBufferPassedBytesMaxThreshold': {'name': 'storage.buffer.passed_bytes.max_threshold', 'type': 'monotonic_gauge'},
                'StorageBufferPassedRowsFlushThreshold': {'name': 'storage.buffer.passed_rows.flush_threshold', 'type': 'monotonic_gauge'},
                'StorageBufferPassedRowsMaxThreshold': {'name': 'storage.buffer.passed_rows.max_threshold', 'type': 'monotonic_gauge'},
                'StorageBufferPassedTimeFlushThreshold': {'name': 'storage.buffer.passed_time.flush_threshold', 'type': 'monotonic_gauge'},
                'StorageBufferPassedTimeMaxThreshold': {'name': 'storage.buffer.passed_time.max_threshold', 'type': 'monotonic_gauge'},
                'StorageConnectionsCreated': {'name': 'storage.connection.created', 'type': 'monotonic_gauge'},
                'StorageConnectionsElapsedMicroseconds': {'name': 'storage.connection.created.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'SynchronousReadWaitMicroseconds': {'name': 'read.synchronous.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'SynchronousRemoteReadWaitMicroseconds': {'name': 'remote.read.synchronous.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ThreadPoolReaderPageCacheHit': {'name': 'cache.page.thread_pool_reader.read', 'type': 'monotonic_gauge'},
                'ThreadPoolReaderPageCacheHitBytes': {'name': 'cache.page.thread_pool_reader.read.size', 'type': 'monotonic_gauge'},
                'ThreadPoolReaderPageCacheHitElapsedMicroseconds': {'name': 'cache.page.thread_pool_reader.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ThreadPoolReaderPageCacheMiss': {'name': 'cache.page.thread_pool_reader.read.miss', 'type': 'monotonic_gauge'},
                'ThreadPoolReaderPageCacheMissBytes': {'name': 'cache.page.thread_pool_reader.read.miss.size', 'type': 'monotonic_gauge'},
                'ThreadPoolReaderPageCacheMissElapsedMicroseconds': {'name': 'cache.page.thread_pool_reader.read.miss.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ThreadpoolReaderPrepareMicroseconds': {'name': 'cache.page.thread_pool_reader.prepare.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ThreadpoolReaderSubmitLookupInCacheMicroseconds': {'name': 'task.thread_pool_reader.cache.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ThreadpoolReaderSubmitReadSynchronously': {'name': 'task.thread_pool_reader.read.sync', 'type': 'monotonic_gauge'},
                'ThreadpoolReaderSubmitReadSynchronouslyBytes': {'name': 'task.thread_pool_reader.read.sync.size', 'type': 'monotonic_gauge'},
                'ThreadpoolReaderSubmitReadSynchronouslyMicroseconds': {'name': 'task.thread_pool_reader.read.sync.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'ThreadpoolReaderTaskMicroseconds': {'name': 'task.thread_pool_reader.read.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'USearchSearchComputedDistances': {'name': 'index.usearch.search.distance.compute', 'type': 'monotonic_gauge'},
                ...
                'UncompressedCacheWeightLost': {'name': 'cache.uncompressed.block_data.evicted', 'type': 'monotonic_gauge'},
                'UserTimeMicroseconds': {
                    'name': 'thread.user.process_time',
                    'type': 'temporal_percent',
                    'scale': 'microsecond',
                },
                'WaitMarksLoadMicroseconds': {'name': 'marks.load.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'WaitPrefetchTaskMicroseconds': {'name': 'task.prefetch.reader.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'WriteBufferFromS3Microseconds': {'name': 's3.write.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                'WriteBufferFromS3RequestsErrors': {'name': 's3.write.errors', 'type': 'monotonic_gauge'},
                'WriteBufferFromS3WaitInflightLimitMicroseconds': {'name': 's3.write.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
                ...
                'ZooKeeperWaitMicroseconds': {'name': 'zk.wait.time', 'type': 'temporal_percent', 'scale': 'microsecond'},
