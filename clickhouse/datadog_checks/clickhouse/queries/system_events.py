    ...
    'columns': [
        {'name': 'value', 'type': 'source'},
        {
            ...
            'items': {
                ...
                'ApplyPatchesJoinMicroseconds': {
                    'name': 'ClickHouseProfileEvents_ApplyPatchesJoinMicroseconds',
                    'type': 'monotonic_gauge',
                },
                'ApplyPatchesMergeMicroseconds': {
                    'name': 'ClickHouseProfileEvents_ApplyPatchesMergeMicroseconds',
                    'type': 'monotonic_gauge',
                },
