...
# we support (24.8, 25.3, 25.8, 26.3).
BASE_METRICS = [
...
V_26_3_METRICS = [
    'clickhouse.metrics.ASTFuzzerAccumulatedFragments',
    'clickhouse.metrics.AttachedReplicatedTable',
    'clickhouse.metrics.AvroSchemaCacheBytes',
    'clickhouse.metrics.AvroSchemaCacheCells',
    'clickhouse.metrics.AvroSchemaRegistryCacheBytes',
    'clickhouse.metrics.AvroSchemaRegistryCacheCells',
    'clickhouse.metrics.AzureRequests',
    'clickhouse.metrics.BlobCopierThreads',
    'clickhouse.metrics.BlobCopierThreadsActive',
    'clickhouse.metrics.BlobCopierThreadsScheduled',
    'clickhouse.metrics.BlobKillerThreads',
    'clickhouse.metrics.BlobKillerThreadsActive',
    'clickhouse.metrics.BlobKillerThreadsScheduled',
    'clickhouse.metrics.BrokenDisks',
    'clickhouse.metrics.BuildVectorSimilarityIndexThreads',
    'clickhouse.metrics.BuildVectorSimilarityIndexThreadsActive',
    'clickhouse.metrics.BuildVectorSimilarityIndexThreadsScheduled',
    'clickhouse.metrics.ColumnsDescriptionsCacheSize',
    'clickhouse.metrics.CompiledExpressionCacheBytes',
    'clickhouse.metrics.CompiledExpressionCacheCount',
    'clickhouse.metrics.Compressing',
    'clickhouse.metrics.CompressionThread',
    ...
    'clickhouse.metrics.DatabaseBackupThreadsScheduled',
    'clickhouse.metrics.Decompressing',
    'clickhouse.metrics.DeltaLakeSnapshotCacheSizeElements',
    'clickhouse.metrics.DistrCacheAllocatedConnections',
    'clickhouse.metrics.DistrCacheBorrowedConnections',
    'clickhouse.metrics.DistrCacheReadBuffers',
    'clickhouse.metrics.DistrCacheRegisteredServers',
    'clickhouse.metrics.DistrCacheRegisteredServersCurrentAZ',
    'clickhouse.metrics.DistrCacheServerRegistryConnections',
    'clickhouse.metrics.DistrCacheServerS3CachedClients',
    'clickhouse.metrics.DistrCacheSharedLimitCount',
    'clickhouse.metrics.DistrCacheWriteBuffers',
    'clickhouse.metrics.DistributedIndexAnalysisThreads',
    'clickhouse.metrics.DistributedIndexAnalysisThreadsActive',
    'clickhouse.metrics.DistributedIndexAnalysisThreadsScheduled',
    'clickhouse.metrics.DropDistributedCacheThreads',
    'clickhouse.metrics.DropDistributedCacheThreadsActive',
    'clickhouse.metrics.DropDistributedCacheThreadsScheduled',
    'clickhouse.metrics.FilesystemCacheKeys',
    ...
    'clickhouse.metrics.FormatParsingThreadsActive',
    'clickhouse.metrics.FormatParsingThreadsScheduled',
    'clickhouse.metrics.FreezePartThreads',
    'clickhouse.metrics.FreezePartThreadsActive',
    'clickhouse.metrics.FreezePartThreadsScheduled',
    'clickhouse.metrics.HiveFilesCacheBytes',
    'clickhouse.metrics.HiveFilesCacheFiles',
    'clickhouse.metrics.HiveMetadataFilesCacheBytes',
    'clickhouse.metrics.HiveMetadataFilesCacheFiles',
    ...
    'clickhouse.metrics.IcebergMetadataFilesCacheBytes',
    'clickhouse.metrics.IcebergMetadataFilesCacheFiles',
    'clickhouse.metrics.IcebergSchedulePoolSize',
    'clickhouse.metrics.IcebergSchedulePoolTask',
    'clickhouse.metrics.IndexMarkCacheBytes',
    'clickhouse.metrics.IndexMarkCacheFiles',
    'clickhouse.metrics.IndexUncompressedCacheBytes',
    'clickhouse.metrics.IndexUncompressedCacheCells',
    ...
    'clickhouse.metrics.MarkCacheBytes',
    'clickhouse.metrics.MarkCacheFiles',
    'clickhouse.metrics.MaxAllocatedEphemeralLockSequentialNumber',
    'clickhouse.metrics.MemoryTrackingUncorrected',
    'clickhouse.metrics.MergeJoinBlocksCacheBytes',
    'clickhouse.metrics.MergeJoinBlocksCacheCount',
    'clickhouse.metrics.MergeParts',
    ...
    'clickhouse.metrics.MergeTreeFetchPartitionThreadsActive',
    'clickhouse.metrics.MergeTreeFetchPartitionThreadsScheduled',
    'clickhouse.metrics.MergeTreeSnapshotCommitThreads',
    'clickhouse.metrics.MergeTreeSnapshotCommitThreadsActive',
    'clickhouse.metrics.MergeTreeSnapshotCommitThreadsScheduled',
    'clickhouse.metrics.MergeTreeSubcolumnsReaderThreads',
    'clickhouse.metrics.MergeTreeSubcolumnsReaderThreadsActive',
    'clickhouse.metrics.MergeTreeSubcolumnsReaderThreadsScheduled',
    'clickhouse.metrics.MetadataFromKeeperCacheObjects',
    'clickhouse.metrics.NamedCollection',
    'clickhouse.metrics.ObjectStorageQueueMetadataCacheSizeBytes',
    'clickhouse.metrics.ObjectStorageQueueMetadataCacheSizeElements',
    'clickhouse.metrics.ObjectStorageQueueRegisteredServers',
    'clickhouse.metrics.ObjectStorageQueueShutdownThreads',
    'clickhouse.metrics.ObjectStorageQueueShutdownThreadsActive',
    'clickhouse.metrics.ObjectStorageQueueShutdownThreadsScheduled',
    ...
    'clickhouse.metrics.ParallelWithQueryScheduledThreads',
    'clickhouse.metrics.ParallelWithQueryThreads',
    'clickhouse.metrics.ParquetMetadataCacheBytes',
    'clickhouse.metrics.ParquetMetadataCacheFiles',
    'clickhouse.metrics.PolygonDictionaryThreads',
    'clickhouse.metrics.PolygonDictionaryThreadsActive',
    'clickhouse.metrics.PolygonDictionaryThreadsScheduled',
    'clickhouse.metrics.PrimaryIndexCacheBytes',
    ...
    'clickhouse.metrics.QueryConditionCacheBytes',
    'clickhouse.metrics.QueryConditionCacheEntries',
    'clickhouse.metrics.QueryNonInternal',
    'clickhouse.metrics.ReadonlyDisks',
    'clickhouse.metrics.ReplicaReady',
    'clickhouse.metrics.S3CachedCredentialsProviders',
    'clickhouse.metrics.SchedulerIOReadScheduled',
    'clickhouse.metrics.SchedulerIOWriteScheduled',
    'clickhouse.metrics.SharedCatalogDropDetachLocalTablesErrors',
    'clickhouse.metrics.SharedCatalogDropLocalThreads',
    ...
    'clickhouse.metrics.SharedDatabaseCatalogTablesInLocalDropDetachQueue',
    'clickhouse.metrics.SharedMergeTreeAssignedCurrentParts',
    'clickhouse.metrics.SharedMergeTreeBrokenCondemnedPartsInKeeper',
    'clickhouse.metrics.SharedMergeTreeCondemnedPartsInKeeper',
    'clickhouse.metrics.SharedMergeTreeMaxActiveReplicas',
    'clickhouse.metrics.SharedMergeTreeMaxInactiveReplicas',
    'clickhouse.metrics.SharedMergeTreeMaxPartitions',
    'clickhouse.metrics.SharedMergeTreeMaxReplicas',
    'clickhouse.metrics.SharedMergeTreeMinActiveReplicas',
    'clickhouse.metrics.SharedMergeTreeMinInactiveReplicas',
    'clickhouse.metrics.SharedMergeTreeMinPartitions',
    'clickhouse.metrics.SharedMergeTreeMinReplicas',
    'clickhouse.metrics.SharedMergeTreeOutdatedPartsInKeeper',
    'clickhouse.metrics.StartupScriptsExecutionState',
    'clickhouse.metrics.StatelessWorkerThreads',
    'clickhouse.metrics.StatelessWorkerThreadsActive',
    'clickhouse.metrics.StatelessWorkerThreadsScheduled',
    'clickhouse.metrics.SystemDatabaseReplicasThreads',
    'clickhouse.metrics.SystemDatabaseReplicasThreadsActive',
    'clickhouse.metrics.SystemDatabaseReplicasThreadsScheduled',
    'clickhouse.metrics.TaskTrackerThreads',
    'clickhouse.metrics.TaskTrackerThreadsActive',
    'clickhouse.metrics.TaskTrackerThreadsScheduled',
    'clickhouse.metrics.TemporaryFilesForMerge',
    'clickhouse.metrics.TextIndexHeaderCacheBytes',
    'clickhouse.metrics.TextIndexHeaderCacheCells',
    'clickhouse.metrics.TextIndexPostingsCacheBytes',
    'clickhouse.metrics.TextIndexPostingsCacheCells',
    'clickhouse.metrics.TextIndexTokensCacheBytes',
    'clickhouse.metrics.TextIndexTokensCacheCells',
    'clickhouse.metrics.UncompressedCacheBytes',
    'clickhouse.metrics.UncompressedCacheCells',
    'clickhouse.metrics.VectorSimilarityIndexCacheBytes',
    'clickhouse.metrics.VectorSimilarityIndexCacheCells',
    'clickhouse.metrics.ZooKeeperConnectionLossStartedTimestampSeconds',
    'clickhouse.metrics.ZooKeeperSessionExpired',
]
...
V_25_8_OPTIONAL = [
    ...
    'clickhouse.metrics.BcryptCacheBytes',
    'clickhouse.metrics.BcryptCacheSize',
]
...
V_26_3_OPTIONAL = [
    ...
    'clickhouse.asynchronous_metrics.DictionaryTotalFailedUpdates',
    'clickhouse.asynchronous_metrics.FilesystemCacheCapacity',
    'clickhouse.asynchronous_metrics.LongestRunningMerge',
    'clickhouse.asynchronous_metrics.NetworkTCPReceiveQueue',
    'clickhouse.asynchronous_metrics.NetworkTCPSocketRemoteAddresses',
    'clickhouse.asynchronous_metrics.NetworkTCPSockets',
    'clickhouse.asynchronous_metrics.NetworkTCPTransmitQueue',
    ...
    'clickhouse.asynchronous_metrics.OSCPUOverload',
    'clickhouse.asynchronous_metrics.PageCacheMaxBytes',
    'clickhouse.asynchronous_metrics.ProcessSignalQueueLimit',
    'clickhouse.asynchronous_metrics.ProcessSignalQueueSize',
    'clickhouse.asynchronous_metrics.QueriesMemoryUsage',
    'clickhouse.asynchronous_metrics.QueriesPeakMemoryUsage',
    'clickhouse.asynchronous_metrics.TotalIndexGranularityBytesInMemory',
    'clickhouse.asynchronous_metrics.TotalIndexGranularityBytesInMemoryAllocated',
    'clickhouse.asynchronous_metrics.TrackedMemory',
    'clickhouse.asynchronous_metrics.ZooKeeperClientLastZXIDSeen',
    'clickhouse.events.ACMEAPIRequests.count',
    'clickhouse.events.ACMEAPIRequests.total',
    'clickhouse.events.ACMECertificateOrders.count',
    'clickhouse.events.ACMECertificateOrders.total',
    'clickhouse.events.ASTFuzzerQueries.count',
    'clickhouse.events.ASTFuzzerQueries.total',
    'clickhouse.events.AllUsersThrottlerBytes.count',
    'clickhouse.events.AllUsersThrottlerBytes.total',
    'clickhouse.events.AllUsersThrottlerSleepMicroseconds',
    'clickhouse.events.AnalyzePatchRangesMicroseconds.count',
    'clickhouse.events.AnalyzePatchRangesMicroseconds.total',
    'clickhouse.events.ApplyPatchesMicroseconds.count',
    'clickhouse.events.ApplyPatchesMicroseconds.total',
    ...
    'clickhouse.events.AsyncLoggingTextLogTotalMessages.count',
    'clickhouse.events.AsyncLoggingTextLogTotalMessages.total',
    'clickhouse.events.AzureGetRequestThrottlerBlocked.count',
    'clickhouse.events.AzureGetRequestThrottlerBlocked.total',
    'clickhouse.events.AzureGetRequestThrottlerCount.count',
    'clickhouse.events.AzureGetRequestThrottlerCount.total',
    'clickhouse.events.AzureGetRequestThrottlerSleepMicroseconds',
    'clickhouse.events.AzurePutRequestThrottlerBlocked.count',
    'clickhouse.events.AzurePutRequestThrottlerBlocked.total',
    'clickhouse.events.AzurePutRequestThrottlerCount.count',
    'clickhouse.events.AzurePutRequestThrottlerCount.total',
    'clickhouse.events.AzurePutRequestThrottlerSleepMicroseconds',
    'clickhouse.events.AzureReadMicroseconds',
    ...
    'clickhouse.events.BackupsOpenedForUnlock.count',
    'clickhouse.events.BackupsOpenedForUnlock.total',
    'clickhouse.events.BlobCopierThreadLockBlobsErrors.count',
    'clickhouse.events.BlobCopierThreadLockBlobsErrors.total',
    'clickhouse.events.BlobCopierThreadLockedBlobs.count',
    'clickhouse.events.BlobCopierThreadLockedBlobs.total',
    'clickhouse.events.BlobCopierThreadRecordBlobsErrors.count',
    'clickhouse.events.BlobCopierThreadRecordBlobsErrors.total',
    'clickhouse.events.BlobCopierThreadRecordedBlobs.count',
    'clickhouse.events.BlobCopierThreadRecordedBlobs.total',
    'clickhouse.events.BlobCopierThreadReplicateBlobsErrors.count',
    'clickhouse.events.BlobCopierThreadReplicateBlobsErrors.total',
    'clickhouse.events.BlobCopierThreadReplicatedBlobs.count',
    'clickhouse.events.BlobCopierThreadReplicatedBlobs.total',
    'clickhouse.events.BlobCopierThreadRuns.count',
    'clickhouse.events.BlobCopierThreadRuns.total',
    'clickhouse.events.BlobKillerThreadLockBlobsErrors.count',
    'clickhouse.events.BlobKillerThreadLockBlobsErrors.total',
    'clickhouse.events.BlobKillerThreadLockedBlobs.count',
    'clickhouse.events.BlobKillerThreadLockedBlobs.total',
    'clickhouse.events.BlobKillerThreadRecordBlobsErrors.count',
    'clickhouse.events.BlobKillerThreadRecordBlobsErrors.total',
    'clickhouse.events.BlobKillerThreadRecordedBlobs.count',
    'clickhouse.events.BlobKillerThreadRecordedBlobs.total',
    'clickhouse.events.BlobKillerThreadRemoveBlobsErrors.count',
    'clickhouse.events.BlobKillerThreadRemoveBlobsErrors.total',
    'clickhouse.events.BlobKillerThreadRemoveTasks.count',
    'clickhouse.events.BlobKillerThreadRemoveTasks.total',
    'clickhouse.events.BlobKillerThreadRemovedBlobs.count',
    'clickhouse.events.BlobKillerThreadRemovedBlobs.total',
    'clickhouse.events.BlobKillerThreadRuns.count',
    'clickhouse.events.BlobKillerThreadRuns.total',
    'clickhouse.events.BuildPatchesJoinMicroseconds.count',
    'clickhouse.events.BuildPatchesJoinMicroseconds.total',
    'clickhouse.events.BuildPatchesMergeMicroseconds.count',
    'clickhouse.events.BuildPatchesMergeMicroseconds.total',
    'clickhouse.events.CachedReadBufferPredownloadedBytes.count',
    'clickhouse.events.CachedReadBufferPredownloadedBytes.total',
    'clickhouse.events.CachedReadBufferPredownloadedFromSourceBytes.count',
    'clickhouse.events.CachedReadBufferPredownloadedFromSourceBytes.total',
    'clickhouse.events.CachedReadBufferPredownloadedFromSourceMicroseconds',
    'clickhouse.events.CachedReadBufferWaitReadBufferMicroseconds',
    'clickhouse.events.CoalescingSortedMilliseconds',
    'clickhouse.events.CommonBackgroundExecutorTaskCancelMicroseconds',
    'clickhouse.events.CommonBackgroundExecutorTaskExecuteStepMicroseconds',
    ...
    'clickhouse.events.DeltaLakePartitionPrunedFiles.count',
    'clickhouse.events.DeltaLakePartitionPrunedFiles.total',
    'clickhouse.events.DeltaLakeScannedFiles.count',
    'clickhouse.events.DeltaLakeScannedFiles.total',
    'clickhouse.events.DeltaLakeSnapshotInitializations.count',
    'clickhouse.events.DeltaLakeSnapshotInitializations.total',
    'clickhouse.events.DictCacheLockReadHoldNs',
    'clickhouse.events.DictCacheLockWriteHoldNs',
    'clickhouse.events.DiskAzureGetRequestThrottlerBlocked.count',
    'clickhouse.events.DiskAzureGetRequestThrottlerBlocked.total',
    'clickhouse.events.DiskAzureGetRequestThrottlerCount.count',
    'clickhouse.events.DiskAzureGetRequestThrottlerCount.total',
    'clickhouse.events.DiskAzureGetRequestThrottlerSleepMicroseconds',
    'clickhouse.events.DiskAzurePutRequestThrottlerBlocked.count',
    'clickhouse.events.DiskAzurePutRequestThrottlerBlocked.total',
    'clickhouse.events.DiskAzurePutRequestThrottlerCount.count',
    'clickhouse.events.DiskAzurePutRequestThrottlerCount.total',
    'clickhouse.events.DiskAzurePutRequestThrottlerSleepMicroseconds',
    'clickhouse.events.DiskAzureReadMicroseconds',
    ...
    'clickhouse.events.DiskAzureWriteRequestsThrottling.count',
    'clickhouse.events.DiskAzureWriteRequestsThrottling.total',
    'clickhouse.events.DiskObjectStorageWaitBlobRemovalMicroseconds',
    'clickhouse.events.DiskPlainRewritableLegacyLayoutDiskCount.count',
    'clickhouse.events.DiskPlainRewritableLegacyLayoutDiskCount.total',
    'clickhouse.events.DiskS3GetObjectTagging.count',
    'clickhouse.events.DiskS3GetObjectTagging.total',
    'clickhouse.events.DiskS3GetRequestThrottlerBlocked.count',
    'clickhouse.events.DiskS3GetRequestThrottlerBlocked.total',
    'clickhouse.events.DiskS3PutRequestThrottlerBlocked.count',
    'clickhouse.events.DiskS3PutRequestThrottlerBlocked.total',
    'clickhouse.events.DiskS3ReadRequestAttempts.count',
    'clickhouse.events.DiskS3ReadRequestAttempts.total',
    'clickhouse.events.DiskS3ReadRequestRetryableErrors.count',
    'clickhouse.events.DiskS3ReadRequestRetryableErrors.total',
    ...
    'clickhouse.events.DistrCacheReadErrors.count',
    'clickhouse.events.DistrCacheReadErrors.total',
    'clickhouse.events.DistrCacheReadThrottlerBytes.count',
    'clickhouse.events.DistrCacheReadThrottlerBytes.total',
    'clickhouse.events.DistrCacheReadThrottlerSleepMicroseconds',
    'clickhouse.events.DistrCacheReceiveResponseErrors.count',
    'clickhouse.events.DistrCacheReceiveResponseErrors.total',
    'clickhouse.events.DistrCacheReceivedCredentialsRefreshPackets.count',
    'clickhouse.events.DistrCacheReceivedCredentialsRefreshPackets.total',
    'clickhouse.events.DistrCacheReceivedDataPackets.count',
    'clickhouse.events.DistrCacheReceivedDataPackets.total',
    'clickhouse.events.DistrCacheReceivedDataPacketsBytes.count',
    'clickhouse.events.DistrCacheReceivedDataPacketsBytes.total',
    'clickhouse.events.DistrCacheReceivedErrorPackets.count',
    'clickhouse.events.DistrCacheReceivedErrorPackets.total',
    'clickhouse.events.DistrCacheReceivedOkPackets.count',
    'clickhouse.events.DistrCacheReceivedOkPackets.total',
    'clickhouse.events.DistrCacheReceivedStopPackets.count',
    'clickhouse.events.DistrCacheReceivedStopPackets.total',
    'clickhouse.events.DistrCacheReconnectsAfterTimeout.count',
    'clickhouse.events.DistrCacheReconnectsAfterTimeout.total',
    'clickhouse.events.DistrCacheSentDataPackets.count',
    'clickhouse.events.DistrCacheSentDataPackets.total',
    'clickhouse.events.DistrCacheSentDataPacketsBytes.count',
    'clickhouse.events.DistrCacheSentDataPacketsBytes.total',
    'clickhouse.events.DistrCacheServerAckRequestPackets.count',
    'clickhouse.events.DistrCacheServerAckRequestPackets.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheHits.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheHits.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheMisses.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheMisses.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferCachePredownloadBytes.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferCachePredownloadBytes.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheReadBytes.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheReadBytes.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheWrittenBytes.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferCacheWrittenBytes.total',
    'clickhouse.events.DistrCacheServerCachedReadBufferObjectStorageReadBytes.count',
    'clickhouse.events.DistrCacheServerCachedReadBufferObjectStorageReadBytes.total',
    'clickhouse.events.DistrCacheServerContinueRequestPackets.count',
    'clickhouse.events.DistrCacheServerContinueRequestPackets.total',
    'clickhouse.events.DistrCacheServerCredentialsRefresh.count',
    'clickhouse.events.DistrCacheServerCredentialsRefresh.total',
    ...
    'clickhouse.events.DistrCacheServerReusedS3CachedClients.count',
    'clickhouse.events.DistrCacheServerReusedS3CachedClients.total',
    'clickhouse.events.DistrCacheServerSkipped.count',
    'clickhouse.events.DistrCacheServerSkipped.total',
    'clickhouse.events.DistrCacheServerStartRequestPackets.count',
    'clickhouse.events.DistrCacheServerStartRequestPackets.total',
    'clickhouse.events.DistrCacheServerUpdates.count',
    'clickhouse.events.DistrCacheServerUpdates.total',
    'clickhouse.events.DistrCacheSuccessfulConnectAttempts.count',
    'clickhouse.events.DistrCacheSuccessfulConnectAttempts.total',
    'clickhouse.events.DistrCacheSuccessfulRegistryUpdates.count',
    'clickhouse.events.DistrCacheSuccessfulRegistryUpdates.total',
    'clickhouse.events.DistrCacheTemporaryFilesBytesWritten.count',
    'clickhouse.events.DistrCacheTemporaryFilesBytesWritten.total',
    'clickhouse.events.DistrCacheTemporaryFilesCreated.count',
    'clickhouse.events.DistrCacheTemporaryFilesCreated.total',
    'clickhouse.events.DistrCacheUnsuccessfulConnectAttempts.count',
    'clickhouse.events.DistrCacheUnsuccessfulConnectAttempts.total',
    'clickhouse.events.DistrCacheUnsuccessfulRegistryUpdates.count',
    'clickhouse.events.DistrCacheUnsuccessfulRegistryUpdates.total',
    'clickhouse.events.DistrCacheUnusedDataPacketsBytes.count',
    'clickhouse.events.DistrCacheUnusedDataPacketsBytes.total',
    'clickhouse.events.DistrCacheUnusedPacketsBufferAllocations.count',
    'clickhouse.events.DistrCacheUnusedPacketsBufferAllocations.total',
    'clickhouse.events.DistrCacheWriteErrors.count',
    'clickhouse.events.DistrCacheWriteErrors.total',
    'clickhouse.events.DistrCacheWriteThrottlerBytes.count',
    'clickhouse.events.DistrCacheWriteThrottlerBytes.total',
    'clickhouse.events.DistrCacheWriteThrottlerSleepMicroseconds',
    'clickhouse.events.DistributedConnectionConnectCount.count',
    'clickhouse.events.DistributedConnectionConnectCount.total',
    'clickhouse.events.DistributedConnectionReconnectCount.count',
    'clickhouse.events.DistributedConnectionReconnectCount.total',
    'clickhouse.events.DistributedIndexAnalysisMicroseconds',
    'clickhouse.events.DistributedIndexAnalysisMissingParts.count',
    'clickhouse.events.DistributedIndexAnalysisMissingParts.total',
    'clickhouse.events.DistributedIndexAnalysisParts.count',
    'clickhouse.events.DistributedIndexAnalysisParts.total',
    'clickhouse.events.DistributedIndexAnalysisReplicaFallback.count',
    'clickhouse.events.DistributedIndexAnalysisReplicaFallback.total',
    'clickhouse.events.DistributedIndexAnalysisReplicaUnavailable.count',
    'clickhouse.events.DistributedIndexAnalysisReplicaUnavailable.total',
    'clickhouse.events.DistributedIndexAnalysisScheduledReplicas.count',
    'clickhouse.events.DistributedIndexAnalysisScheduledReplicas.total',
    'clickhouse.events.DuplicatedAsyncInserts.count',
    'clickhouse.events.DuplicatedAsyncInserts.total',
    'clickhouse.events.DuplicationElapsedMicroseconds',
    'clickhouse.events.FailedInitialQuery.count',
    'clickhouse.events.FailedInitialQuery.total',
    'clickhouse.events.FailedInitialSelectQuery.count',
    'clickhouse.events.FailedInitialSelectQuery.total',
    'clickhouse.events.FailedInternalInsertQuery.count',
    'clickhouse.events.FailedInternalInsertQuery.total',
    'clickhouse.events.FailedInternalQuery.count',
    'clickhouse.events.FailedInternalQuery.total',
    'clickhouse.events.FailedInternalSelectQuery.count',
    'clickhouse.events.FailedInternalSelectQuery.total',
    'clickhouse.events.FetchBackgroundExecutorTaskCancelMicroseconds',
    'clickhouse.events.FetchBackgroundExecutorTaskExecuteStepMicroseconds',
    'clickhouse.events.FetchBackgroundExecutorTaskResetMicroseconds',
    'clickhouse.events.FetchBackgroundExecutorWaitMicroseconds',
    'clickhouse.events.FileSegmentIncreasePriorityMicroseconds',
    'clickhouse.events.FilesystemCacheBackgroundDownloadQueuePush.count',
    'clickhouse.events.FilesystemCacheBackgroundDownloadQueuePush.total',
    'clickhouse.events.FilesystemCacheBackgroundEvictedBytes.count',
    'clickhouse.events.FilesystemCacheBackgroundEvictedBytes.total',
    'clickhouse.events.FilesystemCacheBackgroundEvictedFileSegments.count',
    'clickhouse.events.FilesystemCacheBackgroundEvictedFileSegments.total',
    'clickhouse.events.FilesystemCacheCheckCorrectness.count',
    'clickhouse.events.FilesystemCacheCheckCorrectness.total',
    'clickhouse.events.FilesystemCacheCheckCorrectnessMicroseconds',
    'clickhouse.events.FilesystemCacheCreatedKeyDirectories.count',
    'clickhouse.events.FilesystemCacheCreatedKeyDirectories.total',
    'clickhouse.events.FilesystemCacheEvictedFileSegmentsDuringPriorityIncrease.count',
    'clickhouse.events.FilesystemCacheEvictedFileSegmentsDuringPriorityIncrease.total',
    'clickhouse.events.FilesystemCacheEvictionReusedIterator.count',
    'clickhouse.events.FilesystemCacheEvictionReusedIterator.total',
    'clickhouse.events.FilesystemCacheEvictionSkippedMovingFileSegments.count',
    'clickhouse.events.FilesystemCacheEvictionSkippedMovingFileSegments.total',
    'clickhouse.events.FilesystemCacheFailedEvictionCandidates.count',
    'clickhouse.events.FilesystemCacheFailedEvictionCandidates.total',
    'clickhouse.events.FilesystemCachePriorityReadLockMicroseconds',
    'clickhouse.events.FilesystemCachePriorityWriteLockMicroseconds',
    'clickhouse.events.FilesystemCacheReserveAttempts.count',
    'clickhouse.events.FilesystemCacheReserveAttempts.total',
    'clickhouse.events.FilesystemCacheStateLockMicroseconds',
    'clickhouse.events.FilterPartsByVirtualColumnsMicroseconds',
    'clickhouse.events.FilterTransformPassedBytes.count',
    'clickhouse.events.FilterTransformPassedBytes.total',
    'clickhouse.events.FilterTransformPassedRows.count',
    'clickhouse.events.FilterTransformPassedRows.total',
    ...
    'clickhouse.events.IcebergMetadataFilesCacheMisses.count',
    'clickhouse.events.IcebergMetadataFilesCacheMisses.total',
    'clickhouse.events.IcebergMetadataFilesCacheStaleMisses.count',
    'clickhouse.events.IcebergMetadataFilesCacheStaleMisses.total',
    'clickhouse.events.IcebergMetadataFilesCacheWeightLost.count',
    'clickhouse.events.IcebergMetadataFilesCacheWeightLost.total',
    'clickhouse.events.IcebergMetadataReadWaitTimeMicroseconds',
    'clickhouse.events.IcebergMetadataReturnedObjectInfos.count',
    ...
    'clickhouse.events.IcebergMinMaxIndexPrunedFiles.count',
    'clickhouse.events.IcebergMinMaxIndexPrunedFiles.total',
    'clickhouse.events.IcebergMinMaxNonPrunedDeleteFiles.count',
    'clickhouse.events.IcebergMinMaxNonPrunedDeleteFiles.total',
    'clickhouse.events.IcebergMinMaxPrunedDeleteFiles.count',
    'clickhouse.events.IcebergMinMaxPrunedDeleteFiles.total',
    'clickhouse.events.IcebergPartitionPrunedFiles.count',
    'clickhouse.events.IcebergPartitionPrunedFiles.total',
    'clickhouse.events.IcebergTrivialCountOptimizationApplied.count',
    'clickhouse.events.IcebergTrivialCountOptimizationApplied.total',
    'clickhouse.events.IcebergVersionHintUsed.count',
    'clickhouse.events.IcebergVersionHintUsed.total',
    'clickhouse.events.IndexAnalysisRounds.count',
    'clickhouse.events.IndexAnalysisRounds.total',
    'clickhouse.events.IndexBinarySearchAlgorithm.count',
    'clickhouse.events.IndexBinarySearchAlgorithm.total',
    'clickhouse.events.IndexGenericExclusionSearchAlgorithm.count',
    'clickhouse.events.IndexGenericExclusionSearchAlgorithm.total',
    'clickhouse.events.InitialSelectQuery.count',
    'clickhouse.events.InitialSelectQuery.total',
    'clickhouse.events.JemallocFailedAllocationSampleTracking.count',
    'clickhouse.events.JemallocFailedAllocationSampleTracking.total',
    'clickhouse.events.JemallocFailedDeallocationSampleTracking.count',
    'clickhouse.events.JemallocFailedDeallocationSampleTracking.total',
    'clickhouse.events.JoinBuildTableRowCount.count',
    'clickhouse.events.JoinBuildTableRowCount.total',
    'clickhouse.events.JoinOptimizeMicroseconds',
    'clickhouse.events.JoinProbeTableRowCount.count',
    'clickhouse.events.JoinProbeTableRowCount.total',
    'clickhouse.events.JoinReorderMicroseconds',
    'clickhouse.events.JoinResultRowCount.count',
    'clickhouse.events.JoinResultRowCount.total',
    'clickhouse.events.KafkaMVNotReady.count',
    'clickhouse.events.KafkaMVNotReady.total',
    'clickhouse.events.KeeperAddWatchRequest.count',
    'clickhouse.events.KeeperAddWatchRequest.total',
    'clickhouse.events.KeeperChangelogFileSyncMicroseconds',
    'clickhouse.events.KeeperChangelogLockHoldMicroseconds',
    'clickhouse.events.KeeperChangelogLockWaitMicroseconds',
    'clickhouse.events.KeeperChangelogWrittenBytes.count',
    'clickhouse.events.KeeperChangelogWrittenBytes.total',
    'clickhouse.events.KeeperCheckWatchRequest.count',
    'clickhouse.events.KeeperCheckWatchRequest.total',
    'clickhouse.events.KeeperLiveSessionsLockHoldMicroseconds',
    'clickhouse.events.KeeperLiveSessionsLockWaitMicroseconds',
    'clickhouse.events.KeeperProcessAndResponsesLockHoldMicroseconds',
    'clickhouse.events.KeeperProcessAndResponsesLockWaitMicroseconds',
    'clickhouse.events.KeeperReadRequestQueueLockHoldMicroseconds',
    'clickhouse.events.KeeperReadRequestQueueLockWaitMicroseconds',
    'clickhouse.events.KeeperRemoveWatchRequest.count',
    'clickhouse.events.KeeperRemoveWatchRequest.total',
    'clickhouse.events.KeeperRequestRejectedDueToSoftMemoryLimitCount.count',
    'clickhouse.events.KeeperRequestRejectedDueToSoftMemoryLimitCount.total',
    'clickhouse.events.KeeperRequestTotalWithSubrequests.count',
    'clickhouse.events.KeeperRequestTotalWithSubrequests.total',
    'clickhouse.events.KeeperServerWriteLockHoldMicroseconds',
    'clickhouse.events.KeeperServerWriteLockWaitMicroseconds',
    'clickhouse.events.KeeperSessionCallbackLockHoldMicroseconds',
    'clickhouse.events.KeeperSessionCallbackLockWaitMicroseconds',
    'clickhouse.events.KeeperSetWatchesRequest.count',
    'clickhouse.events.KeeperSetWatchesRequest.total',
    'clickhouse.events.KeeperSnapshotFileSyncMicroseconds',
    'clickhouse.events.KeeperSnapshotWrittenBytes.count',
    'clickhouse.events.KeeperSnapshotWrittenBytes.total',
    'clickhouse.events.KeeperStaleRequestsSkipped.count',
    'clickhouse.events.KeeperStaleRequestsSkipped.total',
    'clickhouse.events.KeeperStorageLockHoldMicroseconds',
    'clickhouse.events.KeeperStorageSharedLockHoldMicroseconds',
    'clickhouse.events.KeeperStorageSharedLockWaitMicroseconds',
    'clickhouse.events.LoadedDataParts.count',
    'clickhouse.events.LoadedDataParts.total',
    'clickhouse.events.LoadedDataPartsMicroseconds',
    'clickhouse.events.LoadedMarksFiles.count',
    ...
    'clickhouse.events.LoadedPrimaryIndexRows.count',
    'clickhouse.events.LoadedPrimaryIndexRows.total',
    'clickhouse.events.LoadedStatisticsMicroseconds',
    'clickhouse.events.LoadingMarksTasksCanceled.count',
    'clickhouse.events.LoadingMarksTasksCanceled.total',
    'clickhouse.events.LocalThreadPoolBusyMicroseconds',
    'clickhouse.events.LocalThreadPoolExpansions.count',
    ...
    'clickhouse.events.MarkCacheEvictedMarks.count',
    'clickhouse.events.MarkCacheEvictedMarks.total',
    'clickhouse.events.MarksTasksFromCache.count',
    'clickhouse.events.MarksTasksFromCache.total',
    'clickhouse.events.MemoryAllocatedWithoutCheck.count',
    'clickhouse.events.MemoryAllocatedWithoutCheck.total',
    'clickhouse.events.MemoryAllocatedWithoutCheckBytes.count',
    'clickhouse.events.MemoryAllocatedWithoutCheckBytes.total',
    'clickhouse.events.MemoryWorkerRun.count',
    'clickhouse.events.MemoryWorkerRun.total',
    'clickhouse.events.MemoryWorkerRunElapsedMicroseconds',
    'clickhouse.events.MergeMutateBackgroundExecutorTaskCancelMicroseconds',
    ...
    'clickhouse.events.MergeSourceParts.count',
    'clickhouse.events.MergeSourceParts.total',
    'clickhouse.events.MergeTextIndexStageExecuteMilliseconds',
    'clickhouse.events.MergeTextIndexStageTotalMilliseconds',
    'clickhouse.events.MergeWrittenRows.count',
    'clickhouse.events.MergeWrittenRows.total',
    'clickhouse.events.MergerMutatorPartsInRangesForMergeCount.count',
    'clickhouse.events.MergerMutatorPartsInRangesForMergeCount.total',
    'clickhouse.events.MergerMutatorPrepareRangesForMergeElapsedMicroseconds',
    'clickhouse.events.MergerMutatorRangesForMergeCount.count',
    ...
    'clickhouse.events.MergerMutatorSelectRangePartsCount.total',
    'clickhouse.events.MergerMutatorsGetPartsForMergeElapsedMicroseconds',
    'clickhouse.events.MergesRejectedByMemoryLimit.count',
    'clickhouse.events.MergesRejectedByMemoryLimit.total',
    'clickhouse.events.MergesThrottlerBytes.count',
    'clickhouse.events.MergesThrottlerBytes.total',
    'clickhouse.events.MergesThrottlerSleepMicroseconds',
    'clickhouse.events.MetadataFromKeeperBackgroundCleanupBlobs.count',
    'clickhouse.events.MetadataFromKeeperBackgroundCleanupBlobs.total',
    'clickhouse.events.MetadataFromKeeperCacheTooManyInvalidated.count',
    'clickhouse.events.MetadataFromKeeperCacheTooManyInvalidated.total',
    'clickhouse.events.MetadataFromKeeperIndividualOperationsMicroseconds',
    'clickhouse.events.MoveBackgroundExecutorTaskCancelMicroseconds',
    'clickhouse.events.MoveBackgroundExecutorTaskExecuteStepMicroseconds',
    'clickhouse.events.MoveBackgroundExecutorTaskResetMicroseconds',
    ...
    'clickhouse.events.MutationsThrottlerBytes.total',
    'clickhouse.events.MutationsThrottlerSleepMicroseconds',
    'clickhouse.events.NaiveBayesClassifierModelsAllocatedBytes.count',
    'clickhouse.events.NaiveBayesClassifierModelsAllocatedBytes.total',
    'clickhouse.events.NaiveBayesClassifierModelsLoaded.count',
    'clickhouse.events.NaiveBayesClassifierModelsLoaded.total',
    'clickhouse.events.ObjectStorageGlobFilteredObjects.count',
    'clickhouse.events.ObjectStorageGlobFilteredObjects.total',
    'clickhouse.events.ObjectStorageListedObjects.count',
    'clickhouse.events.ObjectStorageListedObjects.total',
    'clickhouse.events.ObjectStoragePredicateFilteredObjects.count',
    'clickhouse.events.ObjectStoragePredicateFilteredObjects.total',
    'clickhouse.events.ObjectStorageQueueCancelledFiles.count',
    'clickhouse.events.ObjectStorageQueueCancelledFiles.total',
    'clickhouse.events.ObjectStorageQueueCommitRequests.count',
    'clickhouse.events.ObjectStorageQueueCommitRequests.total',
    ...
    'clickhouse.events.ObjectStorageQueueListedFiles.count',
    'clickhouse.events.ObjectStorageQueueListedFiles.total',
    'clickhouse.events.ObjectStorageQueueMovedObjects.count',
    'clickhouse.events.ObjectStorageQueueMovedObjects.total',
    'clickhouse.events.ObjectStorageQueueProcessedRows.count',
    'clickhouse.events.ObjectStorageQueueProcessedRows.total',
    'clickhouse.events.ObjectStorageQueueReadBytes.count',
    'clickhouse.events.ObjectStorageQueueReadBytes.total',
    ...
    'clickhouse.events.ObjectStorageQueueSuccessfulCommits.count',
    'clickhouse.events.ObjectStorageQueueSuccessfulCommits.total',
    'clickhouse.events.ObjectStorageQueueTaggedObjects.count',
    'clickhouse.events.ObjectStorageQueueTaggedObjects.total',
    'clickhouse.events.ObjectStorageQueueTrySetProcessingFailed.count',
    'clickhouse.events.ObjectStorageQueueTrySetProcessingFailed.total',
    'clickhouse.events.ObjectStorageQueueTrySetProcessingRequests.count',
    'clickhouse.events.ObjectStorageQueueTrySetProcessingRequests.total',
    ...
    'clickhouse.events.ObjectStorageQueueUnsuccessfulCommits.count',
    'clickhouse.events.ObjectStorageQueueUnsuccessfulCommits.total',
    'clickhouse.events.ObjectStorageReadObjects.count',
    'clickhouse.events.ObjectStorageReadObjects.total',
    'clickhouse.events.PageCacheHits.count',
    'clickhouse.events.PageCacheHits.total',
    'clickhouse.events.PageCacheMisses.count',
    'clickhouse.events.PageCacheMisses.total',
    ...
    'clickhouse.events.ParallelReplicasReadMarks.total',
    'clickhouse.events.ParallelReplicasReadRequestMicroseconds',
    'clickhouse.events.ParquetColumnsFilterExpression.count',
    'clickhouse.events.ParquetColumnsFilterExpression.total',
    'clickhouse.events.ParquetDecodingTaskBatches.count',
    'clickhouse.events.ParquetDecodingTaskBatches.total',
    'clickhouse.events.ParquetDecodingTasks.count',
    'clickhouse.events.ParquetDecodingTasks.total',
    'clickhouse.events.ParquetFetchWaitTimeMicroseconds',
    'clickhouse.events.ParquetMetadataCacheHits.count',
    'clickhouse.events.ParquetMetadataCacheHits.total',
    'clickhouse.events.ParquetMetadataCacheMisses.count',
    'clickhouse.events.ParquetMetadataCacheMisses.total',
    'clickhouse.events.ParquetMetadataCacheWeightLost.count',
    'clickhouse.events.ParquetMetadataCacheWeightLost.total',
    'clickhouse.events.ParquetPrefetcherReadEntireFile.count',
    'clickhouse.events.ParquetPrefetcherReadEntireFile.total',
    'clickhouse.events.ParquetPrefetcherReadRandomRead.count',
    'clickhouse.events.ParquetPrefetcherReadRandomRead.total',
    'clickhouse.events.ParquetPrefetcherReadSeekAndRead.count',
    'clickhouse.events.ParquetPrefetcherReadSeekAndRead.total',
    'clickhouse.events.ParquetPrunedRowGroups.count',
    'clickhouse.events.ParquetPrunedRowGroups.total',
    'clickhouse.events.ParquetReadRowGroups.count',
    'clickhouse.events.ParquetReadRowGroups.total',
    'clickhouse.events.ParquetRowsFilterExpression.count',
    'clickhouse.events.ParquetRowsFilterExpression.total',
    'clickhouse.events.PartsLocks.count',
    'clickhouse.events.PartsLocks.total',
    'clickhouse.events.PatchesAcquireLockMicroseconds.count',
    'clickhouse.events.PatchesAcquireLockMicroseconds.total',
    'clickhouse.events.PatchesAcquireLockTries.count',
    'clickhouse.events.PatchesAcquireLockTries.total',
    ...
    'clickhouse.events.PatchesJoinAppliedInAllReadTasks.count',
    'clickhouse.events.PatchesJoinAppliedInAllReadTasks.total',
    'clickhouse.events.PatchesJoinRowsAddedToHashTable.count',
    'clickhouse.events.PatchesJoinRowsAddedToHashTable.total',
    'clickhouse.events.PatchesMergeAppliedInAllReadTasks.count',
    'clickhouse.events.PatchesMergeAppliedInAllReadTasks.total',
    'clickhouse.events.PatchesReadRows.count',
    'clickhouse.events.PatchesReadRows.total',
    'clickhouse.events.PatchesReadUncompressedBytes.count',
    'clickhouse.events.PatchesReadUncompressedBytes.total',
    'clickhouse.events.PrimaryIndexCacheHits.count',
    'clickhouse.events.PrimaryIndexCacheHits.total',
    ...
    'clickhouse.events.QueryBackupThrottlerBytes.total',
    'clickhouse.events.QueryBackupThrottlerSleepMicroseconds',
    'clickhouse.events.QueryCacheAgeSeconds.count',
    'clickhouse.events.QueryCacheAgeSeconds.total',
    'clickhouse.events.QueryCacheReadBytes.count',
    'clickhouse.events.QueryCacheReadBytes.total',
    'clickhouse.events.QueryCacheReadRows.count',
    'clickhouse.events.QueryCacheReadRows.total',
    'clickhouse.events.QueryCacheWrittenBytes.count',
    'clickhouse.events.QueryCacheWrittenBytes.total',
    'clickhouse.events.QueryCacheWrittenRows.count',
    'clickhouse.events.QueryCacheWrittenRows.total',
    'clickhouse.events.QueryConditionCacheHits.count',
    'clickhouse.events.QueryConditionCacheHits.total',
    'clickhouse.events.QueryConditionCacheMisses.count',
    'clickhouse.events.QueryConditionCacheMisses.total',
    ...
    'clickhouse.events.QueryLocalWriteThrottlerBytes.total',
    'clickhouse.events.QueryLocalWriteThrottlerSleepMicroseconds',
    'clickhouse.events.QueryPlanOptimizeMicroseconds',
    'clickhouse.events.QueryPreempted.count',
    'clickhouse.events.QueryPreempted.total',
    'clickhouse.events.QueryRemoteReadThrottlerBytes.count',
    'clickhouse.events.QueryRemoteReadThrottlerBytes.total',
    ...
    'clickhouse.events.QueryRemoteWriteThrottlerBytes.total',
    'clickhouse.events.QueryRemoteWriteThrottlerSleepMicroseconds',
    'clickhouse.events.QuorumFailedInserts.count',
    'clickhouse.events.QuorumFailedInserts.total',
    'clickhouse.events.QuorumParts.count',
    'clickhouse.events.QuorumParts.total',
    'clickhouse.events.QuorumWaitMicroseconds',
    'clickhouse.events.QuotaCacheRecalculationMicroseconds',
    'clickhouse.events.QuotaCacheRecalculations.count',
    'clickhouse.events.QuotaCacheRecalculations.total',
    'clickhouse.events.ReadPatchesMicroseconds.count',
    'clickhouse.events.ReadPatchesMicroseconds.total',
    'clickhouse.events.ReadTasksWithAppliedMutationsOnFly.count',
    'clickhouse.events.ReadTasksWithAppliedMutationsOnFly.total',
    ...
    'clickhouse.events.RestorePartsSkippedFiles.count',
    'clickhouse.events.RestorePartsSkippedFiles.total',
    'clickhouse.events.RoleCacheRecalculationMicroseconds',
    'clickhouse.events.RoleCacheRecalculations.count',
    'clickhouse.events.RoleCacheRecalculations.total',
    'clickhouse.events.RowPolicyCacheRecalculationMicroseconds',
    'clickhouse.events.RowPolicyCacheRecalculations.count',
    'clickhouse.events.RowPolicyCacheRecalculations.total',
    'clickhouse.events.RuntimeDataflowStatisticsInputBytes.count',
    'clickhouse.events.RuntimeDataflowStatisticsInputBytes.total',
    'clickhouse.events.RuntimeDataflowStatisticsOutputBytes.count',
    'clickhouse.events.RuntimeDataflowStatisticsOutputBytes.total',
    'clickhouse.events.RuntimeFilterBlocksProcessed.count',
    'clickhouse.events.RuntimeFilterBlocksProcessed.total',
    'clickhouse.events.RuntimeFilterBlocksSkipped.count',
    'clickhouse.events.RuntimeFilterBlocksSkipped.total',
    'clickhouse.events.RuntimeFilterRowsChecked.count',
    'clickhouse.events.RuntimeFilterRowsChecked.total',
    'clickhouse.events.RuntimeFilterRowsPassed.count',
    'clickhouse.events.RuntimeFilterRowsPassed.total',
    'clickhouse.events.RuntimeFilterRowsSkipped.count',
    'clickhouse.events.RuntimeFilterRowsSkipped.total',
    'clickhouse.events.RuntimeFiltersCreated.count',
    'clickhouse.events.RuntimeFiltersCreated.total',
    'clickhouse.events.S3CachedCredentialsProvidersAdded.count',
    'clickhouse.events.S3CachedCredentialsProvidersAdded.total',
    'clickhouse.events.S3CachedCredentialsProvidersReused.count',
    'clickhouse.events.S3CachedCredentialsProvidersReused.total',
    'clickhouse.events.S3GetObjectTagging.count',
    'clickhouse.events.S3GetObjectTagging.total',
    'clickhouse.events.S3GetRequestThrottlerBlocked.count',
    'clickhouse.events.S3GetRequestThrottlerBlocked.total',
    'clickhouse.events.S3PutRequestThrottlerBlocked.count',
    'clickhouse.events.S3PutRequestThrottlerBlocked.total',
    'clickhouse.events.S3ReadRequestAttempts.count',
    'clickhouse.events.S3ReadRequestAttempts.total',
    'clickhouse.events.S3ReadRequestRetryableErrors.count',
    'clickhouse.events.S3ReadRequestRetryableErrors.total',
    ...
    'clickhouse.events.SchedulerIOWriteRequests.total',
    'clickhouse.events.SchedulerIOWriteWaitMicroseconds',
    'clickhouse.events.SelfDuplicatedAsyncInserts.count',
    'clickhouse.events.SelfDuplicatedAsyncInserts.total',
    'clickhouse.events.SettingsProfileCacheRecalculationMicroseconds',
    'clickhouse.events.SettingsProfileCacheRecalculations.count',
    'clickhouse.events.SettingsProfileCacheRecalculations.total',
    'clickhouse.events.SharedDatabaseCatalogFailedToApplyState.count',
    'clickhouse.events.SharedDatabaseCatalogFailedToApplyState.total',
    'clickhouse.events.SharedDatabaseCatalogStateApplicationMicroseconds',
    'clickhouse.events.SharedMergeTreeCondemnedPartsKillRequest.count',
    'clickhouse.events.SharedMergeTreeCondemnedPartsKillRequest.total',
    'clickhouse.events.SharedMergeTreeCondemnedPartsLockConflict.count',
    'clickhouse.events.SharedMergeTreeCondemnedPartsLockConflict.total',
    'clickhouse.events.SharedMergeTreeCondemnedPartsRemoved.count',
    'clickhouse.events.SharedMergeTreeCondemnedPartsRemoved.total',
    'clickhouse.events.SharedMergeTreeDataPartsFetchAttempt.count',
    'clickhouse.events.SharedMergeTreeDataPartsFetchAttempt.total',
    ...
    'clickhouse.events.SharedMergeTreeOutdatedPartsHTTPResponse.count',
    'clickhouse.events.SharedMergeTreeOutdatedPartsHTTPResponse.total',
    'clickhouse.events.SharedMergeTreePartsKillerMicroseconds',
    'clickhouse.events.SharedMergeTreePartsKillerParts.count',
    'clickhouse.events.SharedMergeTreePartsKillerParts.total',
    'clickhouse.events.SharedMergeTreePartsKillerPartsMicroseconds',
    'clickhouse.events.SharedMergeTreePartsKillerRuns.count',
    'clickhouse.events.SharedMergeTreePartsKillerRuns.total',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeper.count',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeper.total',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeperMicroseconds.count',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeperMicroseconds.total',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeperRequests.count',
    'clickhouse.events.SharedMergeTreeReplicaSetUpdatesFromZooKeeperRequests.total',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJob.count',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJob.total',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJobMicroseconds.count',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJobMicroseconds.total',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJobNothingToScheduled.count',
    'clickhouse.events.SharedMergeTreeScheduleDataProcessingJobNothingToScheduled.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForCoordinatedFetchMicroseconds.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForCoordinatedFetchMicroseconds.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForCoordinatedFetchParts.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForCoordinatedFetchParts.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForFullFetchMicroseconds.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForFullFetchMicroseconds.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForFullFetchParts.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForFullFetchParts.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForRendezvousFetchMicroseconds.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForRendezvousFetchMicroseconds.total',
    'clickhouse.events.SharedMergeTreeSelectPartsForRendezvousFetchParts.count',
    'clickhouse.events.SharedMergeTreeSelectPartsForRendezvousFetchParts.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanRequest.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanRequest.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerMicroseconds.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerMicroseconds.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerParts.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerParts.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerPartsMicroseconds.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerPartsMicroseconds.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerRuns.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsCleanerRuns.total',
    'clickhouse.events.SharedMergeTreeSnapshotPartsRemoved.count',
    'clickhouse.events.SharedMergeTreeSnapshotPartsRemoved.total',
    'clickhouse.events.SharedMergeTreeTryUpdateDiskMetadataCacheForPartMicroseconds.count',
    'clickhouse.events.SharedMergeTreeTryUpdateDiskMetadataCacheForPartMicroseconds.total',
    'clickhouse.events.SharedMergeTreeVirtualPartsUpdateMicroseconds',
    'clickhouse.events.SharedMergeTreeVirtualPartsUpdates.count',
    ...
    'clickhouse.events.SharedMergeTreeVirtualPartsUpdatesPeerNotFound.count',
    'clickhouse.events.SharedMergeTreeVirtualPartsUpdatesPeerNotFound.total',
    'clickhouse.events.SharedPartsLockHoldMicroseconds',
    'clickhouse.events.SharedPartsLockWaitMicroseconds',
    'clickhouse.events.SharedPartsLocks.count',
    'clickhouse.events.SharedPartsLocks.total',
    'clickhouse.events.SystemLogErrorOnFlush.count',
    'clickhouse.events.SystemLogErrorOnFlush.total',
    'clickhouse.events.TextIndexDiscardHint.count',
    'clickhouse.events.TextIndexDiscardHint.total',
    'clickhouse.events.TextIndexHeaderCacheHits.count',
    'clickhouse.events.TextIndexHeaderCacheHits.total',
    'clickhouse.events.TextIndexHeaderCacheMisses.count',
    'clickhouse.events.TextIndexHeaderCacheMisses.total',
    'clickhouse.events.TextIndexPostingsCacheHits.count',
    'clickhouse.events.TextIndexPostingsCacheHits.total',
    'clickhouse.events.TextIndexPostingsCacheMisses.count',
    'clickhouse.events.TextIndexPostingsCacheMisses.total',
    'clickhouse.events.TextIndexReadDictionaryBlocks.count',
    'clickhouse.events.TextIndexReadDictionaryBlocks.total',
    'clickhouse.events.TextIndexReadGranulesMicroseconds',
    'clickhouse.events.TextIndexReadPostings.count',
    'clickhouse.events.TextIndexReadPostings.total',
    'clickhouse.events.TextIndexReadSparseIndexBlocks.count',
    'clickhouse.events.TextIndexReadSparseIndexBlocks.total',
    'clickhouse.events.TextIndexReaderTotalMicroseconds',
    'clickhouse.events.TextIndexTokensCacheHits.count',
    'clickhouse.events.TextIndexTokensCacheHits.total',
    'clickhouse.events.TextIndexTokensCacheMisses.count',
    'clickhouse.events.TextIndexTokensCacheMisses.total',
    'clickhouse.events.TextIndexUseHint.count',
    'clickhouse.events.TextIndexUseHint.total',
    'clickhouse.events.TextIndexUsedEmbeddedPostings.count',
    'clickhouse.events.TextIndexUsedEmbeddedPostings.total',
    'clickhouse.events.UserThrottlerBytes.count',
    'clickhouse.events.UserThrottlerBytes.total',
    'clickhouse.events.UserThrottlerSleepMicroseconds',
    'clickhouse.events.VectorSimilarityIndexCacheHits.count',
    'clickhouse.events.VectorSimilarityIndexCacheHits.total',
    'clickhouse.events.VectorSimilarityIndexCacheMisses.count',
    'clickhouse.events.VectorSimilarityIndexCacheMisses.total',
    'clickhouse.events.VectorSimilarityIndexCacheWeightLost.count',
    'clickhouse.events.VectorSimilarityIndexCacheWeightLost.total',
    'clickhouse.events.WasmDeserializationMicroseconds',
    'clickhouse.events.WasmGuestExecuteMicroseconds',
    'clickhouse.events.WasmMemoryAllocated.count',
    'clickhouse.events.WasmMemoryAllocated.total',
    'clickhouse.events.WasmModuleInstatiate.count',
    'clickhouse.events.WasmModuleInstatiate.total',
    'clickhouse.events.WasmSerializationMicroseconds',
    'clickhouse.events.WasmTotalExecuteMicroseconds',
    'clickhouse.events.WriteBufferFromHTTPBytes.count',
    'clickhouse.events.WriteBufferFromHTTPBytes.total',
    'clickhouse.events.WriteBufferFromHTTPRequestsSent.count',
    'clickhouse.events.WriteBufferFromHTTPRequestsSent.total',
...
BASE_VERSION_MAPPER = {'24.8': V_24_8_METRICS, '25.3': V_25_3_METRICS, '25.8': V_25_8_METRICS, '26.3': V_26_3_METRICS}

OPTIONAL_VERSION_MAPPER = {
    '24.8': V_24_8_OPTIONAL,
    '25.3': V_25_3_OPTIONAL,
    '25.8': V_25_8_OPTIONAL,
    '26.3': V_26_3_OPTIONAL,
}
