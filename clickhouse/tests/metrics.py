...
OPTIONAL_METRICS = [
    ...
    # Metrics introduced in ClickHouse 23.x but not present in 23.2;
    # kept here (at_least=0) so assert_all_metrics_covered() passes if
    # a 23.2 instance happens to emit them.
