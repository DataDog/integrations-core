...
BASE_METRICS = [
    ...
    'clickhouse.threads.query.soft_page_faults',
    'clickhouse.zk.connection',
    'clickhouse.zk.connection.established',
    'clickhouse.zk.create',
    'clickhouse.zk.exist',
    'clickhouse.zk.get',
    'clickhouse.zk.list',
    'clickhouse.zk.multi',
    'clickhouse.zk.node.ephemeral',
    'clickhouse.zk.operation',
    'clickhouse.zk.received.size',
    'clickhouse.zk.remove',
    'clickhouse.zk.request',
    'clickhouse.zk.sent.size',
    'clickhouse.zk.set',
