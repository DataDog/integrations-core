...
@pytest.mark.e2e
@pytest.mark.fips_on
def test_connection_fips(clean_fips_environment, dd_environment, dd_agent_check, instance_e2e_fips):
    """
...
@pytest.mark.e2e
@pytest.mark.fips_on
def test_connection_non_fips(clean_fips_environment, dd_environment, dd_agent_check, instance_e2e_non_fips):
    """
