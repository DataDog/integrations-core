...
METRIC_MAP = {
    ...
    'arangodb_agency_callback_registered_total': 'agency.callback.registered',
    ...
    'arangodb_agency_read_no_leader_total': 'agency.read.no_leader',
    'arangodb_agency_read_ok_total': 'agency.read.ok',
    'arangodb_agency_supervision_failed_server_total': 'agency.supervision.failed.server',
    'arangodb_agency_write_hist': 'agency.write',
    'arangodb_agency_write_no_leader_total': 'agency.write.no_leader',
    'arangodb_agency_write_ok_total': 'agency.write.ok',
    'arangodb_agencycomm_request_time_msec': 'agency.request.time',
    # network
    'arangodb_network_forwarded_requests_total': 'network.forwarded.requests',
    'arangodb_network_request_timeouts_total': 'network.request.timeouts',
    'arangodb_network_requests_in_flight': 'network.requests.in.flight',
    # aql
    'arangodb_aql_all_query_total': 'aql.all.query',
    ...
    'arangodb_aql_global_query_memory_limit_reached_total': 'aql.global.query.memory.limit.reached',
    'arangodb_aql_local_query_memory_limit_reached_total': 'aql.local.query.memory.limit.reached',
    ...
    # http
    'arangodb_http_request_statistics_async_requests_total': 'http.async.requests',
    'arangodb_http_request_statistics_http_delete_requests_total': 'http.delete.requests',
    'arangodb_http_request_statistics_http_get_requests_total': 'http.get.requests',
    'arangodb_http_request_statistics_http_head_requests_total': 'http.head.requests',
    'arangodb_http_request_statistics_http_options_requests_total': 'http.options.requests',
    'arangodb_http_request_statistics_http_patch_requests_total': 'http.patch.requests',
    'arangodb_http_request_statistics_http_post_requests_total': 'http.post.requests',
    'arangodb_http_request_statistics_http_put_requests_total': 'http.put.requests',
    'arangodb_http_request_statistics_other_http_requests_total': 'http.other.requests',
    'arangodb_http_request_statistics_total_requests_total': 'http.total.requests',
    'arangodb_http_request_statistics_user_requests_total': 'http.user.requests',
    # process
    'arangodb_process_statistics_major_page_faults_total': 'process.page.faults.major',
    'arangodb_process_statistics_minor_page_faults_total': 'process.page.faults.minor',
    ...
    # collection
    'arangodb_collection_lock_acquisition_micros_total': 'collection.lock.acquisition',
    'arangodb_collection_lock_sequential_mode_total': 'collection.lock.sequential_mode',
    'arangodb_collection_lock_timeouts_exclusive_total': 'collection.lock.timeouts_exclusive',
    'arangodb_collection_lock_timeouts_write_total': 'collection.lock.timeouts_write',
    # transaction
    'arangodb_read_transactions_total': 'transactions.read',
    'arangodb_transactions_aborted_total': 'transactions.aborted',
    'arangodb_transactions_committed_total': 'transactions.committed',
    'arangodb_transactions_expired_total': 'transactions.expired',
    'arangodb_transactions_started_total': 'transactions.started',
    # rocksDB
    'arangodb_collection_lock_acquisition_time': 'rocksdb.collection_lock.acquisition_time',
    'arangodb_rocksdb_write_stalls_total': 'rocksdb.write.stalls',
    'arangodb_rocksdb_write_stops_total': 'rocksdb.write.stops',
    ...
    # health:
    'arangodb_dropped_followers_total': 'health.dropped_followers',
    'arangodb_heartbeat_failures_total': 'health.heartbeat_failures',
