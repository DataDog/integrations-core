...
class TestReadMessagesAction:
    ...
    def test_read_messages_with_filter(self, aggregator, dd_run_check):
        ...
        # Run check with mocked kafka_client.consume_messages and get_cluster_id
        ...
        with (
            ...
            assert call_kwargs['max_messages'] == 100  # max_scanned_messages
        ...
        # Verify first event (JSON format)
        event1 = events[0]
        ...
        # Verify second event (JSON format)
        event2 = events[1]
