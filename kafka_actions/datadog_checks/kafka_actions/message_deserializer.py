...
class MessageDeserializer:
    """Handles deserialization of Kafka messages with support for JSON, Protobuf, and Avro."""

    def __init__(self, log, schema_registry_client=None):
        """Initialize the deserializer.

        Args:
            log: Logger instance
            schema_registry_client: Optional SchemaRegistryClient for fetching schemas
        """
        self.log = log
    ...
    def deserialize_message(
        ...
        Args:
            ...
            format_type: 'json', 'protobuf', or 'avro'
    ...
    def _deserialize_bytes(self, message: bytes, message_format: str, schema) -> str | None:
        ...
        Args:
            ...
            message_format: 'json', 'protobuf', 'avro', or 'string'
