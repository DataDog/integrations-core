...
setup(
    ...
    packages=['dd_integrations.win32_event_log'],
    ...
    package_data={b'dd_integrations.win32_event_log': ['win32_event_log.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'win32_event_log=dd_integrations.win32_event_log:main',
        ],
    },
)
