...
class InstanceConfig(BaseModel):
    ...
    catalyst_center_host: str
    catalyst_center_password: str
    catalyst_center_username: str
    ...
    collect_sda_fabric: Optional[bool] = None
    collect_security: Optional[bool] = None
    collect_site_health: Optional[bool] = None
    collect_stacks: Optional[bool] = None
    collect_topology: Optional[bool] = None
    collect_wireless: Optional[bool] = None
    ...
    token_refresh_buffer_seconds: Optional[int] = Field(None, ge=30)
