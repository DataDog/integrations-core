...
* Add `pyproject.toml` file. See [#11341](https://github.com/DataDog/integrations-core/pull/11341).
...
* Add runtime configuration validation. See [#8908](https://github.com/DataDog/integrations-core/pull/8908).
...
* Add config specs. See [#6728](https://github.com/DataDog/integrations-core/pull/6728).
...
* Add druid logs. See [#4561](https://github.com/DataDog/integrations-core/pull/4561).
