...
1. Add this configuration block to your `couch.d/conf.yaml` file to start gathering your [CouchDB Metrics](#metrics):
...
2. Add this configuration block to your `couch.d/conf.yaml` file to start collecting your Apache Logs:
