...
setup(
    ...
    packages=['dd_integrations.hdfs_namenode'],
    ...
    package_data={b'dd_integrations.hdfs_namenode': ['hdfs_namenode.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'hdfs_namenode=dd_integrations.hdfs_namenode:main',
        ],
    },
)
