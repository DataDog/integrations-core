...
The HDFS NameNode check is included in the [Datadog Agent][2] package, so you don't need to install anything else on your NameNodes.
...
Edit the `hdfs_namenode.d/conf.yaml` file, in the `conf.d/` folder at the root of your [Agent's configuration directory][3]. See the [sample hdfs_namenode.d/conf.yaml][4] for all available configuration options:
...
[Restart the Agent][5] to begin sending NameNode metrics to Datadog.

### Validation

[Run the Agent's `status` subcommand][6] and look for `hdfs_namenode` under the Checks section.
...
[4]: https://github.com/DataDog/integrations-core/blob/master/hdfs_namenode/datadog_checks/hdfs_namenode/data/conf.yaml.example
[5]: https://docs.datadoghq.com/agent/faq/agent-commands/#start-stop-restart-the-agent
[6]: https://docs.datadoghq.com/agent/faq/agent-commands/#agent-status-and-information
[7]: https://github.com/DataDog/integrations-core/blob/master/hdfs_namenode/metadata.csv
