...
def instance_only_query_enabled_endpoints(_field, _value):
    return False
...
def instance_plus_api_version(_field, _value):
    return 2
...
def instance_use_plus_api(_field, _value):
    return False


def instance_use_plus_api_stream(_field, _value):
    return True


def instance_use_vts(_field, _value):
    return False
