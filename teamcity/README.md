...
This integration connects to your TeamCity server to submit metrics, ![Enable Guest Login][17] service checks, and events, allowing you to monitor the health of your TeamCity projects' build configurations, build runs, server resources, and more.
