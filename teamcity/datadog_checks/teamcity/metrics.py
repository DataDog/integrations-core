...
METRIC_MAP = {
    ...
    'finishingBuild_buildFinishDelay_milliseconds_total': 'finishingbuild.buildfinishdelay.milliseconds.total',
    'httpSessions_active_number': 'httpSessions.active',
    'http_requests_duration_milliseconds': 'http.requests.duration.milliseconds',
    'http_requests_duration_milliseconds_bucket': 'http.requests.duration.ms.bucket',
    'http_requests_duration_milliseconds_count': 'http.requests.duration.ms.count',
    'http_requests_duration_milliseconds_total': 'http.requests.duration.ms.total',
    ...
    'process_queue_milliseconds_count': 'process.queue.ms.count',
    'process_queue_milliseconds_total': 'process.queue.ms.total',
    'process_queue_parts_milliseconds': 'process.queue.parts.milliseconds',
    'process_queue_parts_milliseconds_count': 'process.queue.parts.ms.count',
    'process_queue_parts_milliseconds_total': 'process.queue.parts.ms.total',
    'process_websocket_send_pending_messages_milliseconds': 'process.websocket.send.pending.messages.milliseconds',
    'process_websocket_send_pending_messages_milliseconds_count': 'process.websocket.send.pending.messages.ms.count',
    'process_websocket_send_pending_messages_milliseconds_total': 'process.websocket.send.pending.messages.ms.total',
    ...
    'pullRequests_batch_time_milliseconds_count': 'pullRequests.batch.time.ms.count',
    'pullRequests_batch_time_milliseconds_total': 'pullRequests.batch.time.ms.total',
    'pullRequests_single_time_milliseconds': 'pullrequests.single.time.milliseconds',
    'pullRequests_single_time_milliseconds_count': 'pullRequests.single.time.ms.count',
    'pullRequests_single_time_milliseconds_total': 'pullRequests.single.time.ms.total',
    'queuedBuild_waitingTime_milliseconds': 'queuedbuild.waitingtime.milliseconds',
    'queuedBuild_waitingTime_milliseconds_count': 'queuedbuild.waitingtime.milliseconds.count',
    'queuedBuild_waitingTime_milliseconds_total': 'queuedbuild.waitingtime.milliseconds.total',
    ...
    'startingBuild_buildStartDelay_milliseconds_total': 'startingbuild.buildstartdelay.milliseconds.total',
    'startingBuild_runBuildDelay_milliseconds': 'startingbuild.runbuilddelay.milliseconds',
    'startingBuild_runBuildDelay_milliseconds_total': 'startingbuild.runbuilddelay.milliseconds.total',
    ...
    'vcsChangesCollection_delay_milliseconds_count': 'vcsChangesCollection.delay.ms.count',
    'vcsChangesCollection_delay_milliseconds_total': 'vcsChangesCollection.delay.ms.total',
    ...
    'vcs_changes_checking_milliseconds_count': 'vcs.changes.checking.milliseconds.count',
    ...
    'vcs_git_fetch_duration_milliseconds_total': 'vcs.git.fetch.duration.milliseconds.total',
}
...
def construct_metrics_config(metric_map):
    ...
    for raw_metric_name, metric_name in metric_map.items():
        if raw_metric_name.endswith('_total') or raw_metric_name.endswith('_count'):
