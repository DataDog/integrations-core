...
def instance_build_config_metrics(_field, _value):
    return True
...
def instance_build_problem_health_check(_field, _value):
    return True
...
def instance_collect_events(_field, _value):
    return True
...
def instance_default_build_configs_limit(_field, _value):
    return 5


def instance_default_projects_limit(_field, _value):
    return 5
...
def instance_experimental_metrics(_field, _value):
    return False
...
def instance_projects_refresh_interval(_field, _value):
    return 3600
...
def instance_tests_health_check(_field, _value):
    return True
