...
HISTOGRAM_METRICS = [
    {'nginx_ingress_controller_connect_duration_seconds': 'controller.connect.duration'},
    {'nginx_ingress_controller_header_duration_seconds': 'controller.header.duration'},
