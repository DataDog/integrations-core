...
class DocumentQuery(object):
    ...
    def _make_metric_from_spec(self, document, spec, tags):
        ...
        logger.debug('make_metric_from_spec %r', spec)
        ...
        if 'modifier' in spec and spec['modifier'] is not None:
            value = self._modify(value, modifier=spec['modifier'])
    ...
    def _make_metrics_from_group(self, document, group, tags):
        ...
        logger.debug('make_metrics_from_group group=%r', group)
