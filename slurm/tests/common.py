...
SINFO_MAP = {
    'metrics': [
        ...
        # PARTITION |AVAIL |NODELIST |NODES(A/I/O/T) |MEMORY |CLUSTER |CPU_LOAD |FREE_MEM |TMP_DISK |STATE |REASON |ACTIVE_FEATURES |THREADS |GRES        |GRES_USED    # noqa: E501
        # normal    |up    |c3       |1/2/3/4        |  5000 |bar     |    2.46 |    5076 |       5 |idle  |test   |foo             |      6 |(null)      |(null)   # noqa: E501
        {
            'name': 'slurm.node.tmp_disk',
            'value': 0,
            'tags': [
        ...
        # partition metrics
        # PARTITION |NODELIST |CPUS |AVAIL |MEMORY |CLUSTER |NODES(A/I/O/T) |GRES        |GRES_USED    # noqa: E501
        # normal*   |c[1-2]   |   1 |up    |  1000 |N/A     |0/2/0/2        |gpu:tesla:4 |gpu:tesla:3(IDX:0,2-3)    # noqa: E501
        {
        ...
        # PARTITION |NODELIST |CPUS |AVAIL |MEMORY |CLUSTER |NODES(A/I/O/T) |GRES        |GRES_USED   # noqa: E501
        # foo       |c[3-4]   |   1 |down  |  2000 |N/A     |1/2/3/4        |(null)      |(null)    # noqa: E501
        {
            'name': 'slurm.partition.cpu.allocated',
            'value': 1,
            'tags': [
