...
METRIC_MAP = {
    ...
    'admission_admitted_sql_kv_response': 'admission.admitted.sql_kv_response',
    ...
    'admission_admitted_sql_leaf_start': 'admission.admitted.sql_leaf_start',
    ...
    'admission_admitted_sql_root_start': 'admission.admitted.sql_root_start',
    ...
    'admission_admitted_sql_sql_response': 'admission.admitted.sql_sql_response',
    ...
    'admission_errored_sql_kv_response': 'admission.errored.sql_kv_response',
    ...
    'admission_errored_sql_leaf_start': 'admission.errored.sql_leaf_start',
    ...
    'admission_errored_sql_root_start': 'admission.errored.sql_root_start',
    ...
    'admission_errored_sql_sql_response': 'admission.errored.sql_sql_response',
    ...
    'admission_granter_used_slots_sql_leaf_start': 'admission.granter.used_slots.sql_leaf_start',
    'admission_granter_used_slots_sql_root_start': 'admission.granter.used_slots.sql_root_start',
    ...
    'admission_requested_sql_kv_response': 'admission.requested.sql_kv_response',
    ...
    'admission_requested_sql_leaf_start': 'admission.requested.sql_leaf_start',
    ...
    'admission_requested_sql_sql_response': 'admission.requested.sql_sql_response',
    ...
    'admission_wait_durations_kv_stores': 'admission.wait_durations.kv_stores',
    ...
    'admission_wait_durations_kv_stores_bulk_normal_pri_bucket': 'admission.wait_durations.kv_stores.bulk_normal_pri.bucket',
    'admission_wait_durations_kv_stores_bulk_normal_pri_count': 'admission.wait_durations.kv_stores.bulk_normal_pri.count',
    'admission_wait_durations_kv_stores_bulk_normal_pri_sum': 'admission.wait_durations.kv_stores.bulk_normal_pri.sum',
    ...
    'admission_wait_durations_kv_stores_ttl_low_pri_bucket': 'admission.wait_durations.kv_stores.ttl_low_pri.bucket',
    'admission_wait_durations_kv_stores_ttl_low_pri_count': 'admission.wait_durations.kv_stores.ttl_low_pri.count',
    'admission_wait_durations_kv_stores_ttl_low_pri_sum': 'admission.wait_durations.kv_stores.ttl_low_pri.sum',
    ...
    'admission_wait_durations_sql_kv_response': 'admission.wait_durations.sql_kv_response',
    ...
    'admission_wait_durations_sql_leaf_start': 'admission.wait_durations.sql_leaf_start',
    ...
    'admission_wait_durations_sql_sql_response': 'admission.wait_durations.sql_sql_response',
    ...
    'admission_wait_queue_length_kv_stores': 'admission.wait_queue_length.kv_stores',
    ...
    'admission_wait_queue_length_sql_kv_response': 'admission.wait_queue_length.sql_kv_response',
    ...
    'admission_wait_queue_length_sql_leaf_start': 'admission.wait_queue_length.sql_leaf_start',
    ...
    'admission_wait_queue_length_sql_root_start': 'admission.wait_queue_length.sql_root_start',
    ...
    'admission_wait_queue_length_sql_sql_response': 'admission.wait_queue_length.sql_sql_response',
    ...
    'clock_offset_meannanos': 'clock_offset.meannanos',
    'clock_offset_stddevnanos': 'clock_offset.stddevnanos',
    ...
    'rocksdb_memtable_total_size': 'rocksdb.memtable.total_size',
    'rocksdb_num_sstables': 'rocksdb.num_sstables',
    'rocksdb_read_amplification': 'rocksdb.read_amplification',
    'rocksdb_table_readers_mem_estimate': 'rocksdb.table_readers_mem_estimate',
    ...
    'schedules_scheduled_row_level_ttl_executor_failed': 'schedules.scheduled_row_level_ttl_executor.failed',
    ...
    'seconds_until_enterprise_license_expiry': 'seconds_until_enterprise_license_expiry',
    'security_certificate_expiration_ca': 'security.certificate.expiration.ca',
    ...
    'security_certificate_expiration_client_ca': 'security.certificate.expiration.client_ca',
    'security_certificate_expiration_client_tenant': 'security.certificate.expiration.client_tenant',
    'security_certificate_expiration_node': 'security.certificate.expiration.node',
    'security_certificate_expiration_node_client': 'security.certificate.expiration.node_client',
    'security_certificate_expiration_ui': 'security.certificate.expiration.ui',
    'security_certificate_expiration_ui_ca': 'security.certificate.expiration.ui_ca',
    ...
    'sql_stats_flush_duration_bucket': 'sql.stats.flush.duration.bucket',
    'sql_stats_flush_duration_count': 'sql.stats.flush.duration.count',
    'sql_stats_flush_duration_sum': 'sql.stats.flush.duration.sum',
    ...
    'storage_write_stalls': 'storage.write_stalls',
    'sys_cgo_allocbytes': 'sys.cgo.allocbytes',
    'sys_cgo_totalbytes': 'sys.cgo.totalbytes',
    'sys_cgocalls': 'sys.cgocalls',
    'sys_cpu_combined_percent_normalized': 'sys.cpu.combined.percent_normalized',
