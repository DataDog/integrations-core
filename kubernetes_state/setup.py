...
setup(
    ...
    packages=['dd_integrations.kubernetes_state'],
    ...
    package_data={b'dd_integrations.kubernetes_state': ['kubernetes_state.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'kubernetes_state=dd_integrations.kubernetes_state:main',
        ],
    },
)
