...
class vLLMCheck(OpenMetricsBaseCheckV2):
    ...
    def __init__(self, name, init_config, instances):
        ...
        self.version_endpoint = DEFAULT_VERSION_ENDPOINT
        ...
        if self.collect_server_info and self.openmetrics_endpoint:
    ...
    def _submit_version_metadata(self):
        ...
        endpoint = self.instance.get("openmetrics_endpoint").replace("/metrics", DEFAULT_VERSION_ENDPOINT)
