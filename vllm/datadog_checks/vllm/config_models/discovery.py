...
from datadog_checks.vllm.config_models.instance import InstanceConfig
from datadog_checks.vllm.config_models.shared import SharedConfig
...
def _generated_candidates(service: Service) -> Iterator[dict[str, Any]]:
    ...
    for port in candidate_ports(service, [8000, 9090, 8081]):
        ctx = {'port': port}
        instance_data = {
