...
1. Also include an *Overview* group containing service checks (e.g. liveness or readiness checks, where the integration has any), a few of the most important metrics, and a monitor summary if you have pre-existing monitors for this integration, and place it at the top of the dashboard. The *Overview* section should contain data.
