...
1. Label every PR merged between code freeze and release with a `category/X` label. Changes unrelated to the release (such as dashboard updates) don't need a label.
