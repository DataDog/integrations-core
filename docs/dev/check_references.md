...
| `display_name`              | String          | Mandatory          | The title displayed on the corresponding integration tile on the Datadog site and public documentation [Integrations][4] page.                                                                                  |
