...
| `tile[classifier_tags]`                              | Array of String             | Mandatory, can be `[ ]`                   | Some classifier information about this app. This includes information such as `categories`, `submmited/queried data types`, `supported_os` and `available_offerings`.                                                                                                                     |
