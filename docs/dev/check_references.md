...
| `assets[monitors["monitor_short_name"]]`             | String                      | Mandatory                                 | Key/value pairs for any recommended monitors. The key is the globally unique short name of the dashboard and the value is the relative path to the monitors JSON definition in relation to this manifest.                                   |
