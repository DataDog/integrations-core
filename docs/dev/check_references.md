...
| `app_id`                                             | String                                                                  | Mandatory                                  | The unique identifying name of this offering. Usually kebab case of the display name.              |   |
...
| `author[vendor_id]`                                  | String                                                                  | Mandatory                                  | The vendor ID to use for subscription purposes. Must be globally unique and cannot be changed. Should follow the strict standards of `integration_id` where only dashes and alphabetic chars are allowed. This value is provided to partners. |   |
...
| `pricing`                                            | Array of Object                                                         | Mandatory                                  | List of objects representing the pricing model of the integration. See [Marketplace GitHub repository][1] for pricing details. The Marketplace GitHub repository is private, email marketplace@datadog.com for access.                                                                                                                                                                                          |   || `tile`                                               | Object                                                                  | Mandatory                                  | Information about this offering                                                                                                                                                                                                                                |   |
...
| `tile[media[media_type]]`                            | String or Enum                                                          | Mandatory                                  | The type of media this is. If you're setting this field as an Enum, only `image` and `video` are accepted.                                                                                                               |   |
