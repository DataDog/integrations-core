...
`spec.yaml`
: This is used to generate `conf.yaml.example` using the `ddev` tooling (see the "Configuration template" tab below). [See the configuration specification documentation to learn more.][16]

`conf.yaml.example`
: This contains default (or example) configuration options for your Agent Check. Do not edit this file by hand! It is generated from the contents of `spec.yaml`. [See the configuration file reference documentation to learn its logic.][10]

`manifest.json`
: This contains the metadata for your Agent Check such as the title, categories, etc… [See the manifest reference documentation to learn more.][11]

`metadata.csv`
: This contains the list of all metrics collected by your Agent Check. [See the metrics metadata reference documentation to learn more.][12]

`service_check.json`
: This contains the list of all Service Checks collected by your Agent Check. [See the Service Check reference documentation to learn more.][13]
