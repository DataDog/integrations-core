...
METRIC_MAP = {
    ...
    'ray_serve_deployment_error_counter_total': 'serve.deployment.error',
    ...
    'ray_serve_deployment_replica_starts_total': 'serve.deployment.replica.starts',
    'ray_serve_deployment_request_counter': 'serve.deployment.request.counter',
    'ray_serve_deployment_request_counter_total': 'serve.deployment.request.counter',
    'ray_serve_grpc_request_latency_ms': 'serve.grpc_request_latency',
    'ray_serve_handle_request_counter': 'serve.handle_request',
    'ray_serve_handle_request_counter_total': 'serve.handle_request',
    ...
    'ray_serve_multiplexed_get_model_requests_counter_total': 'serve.multiplexed_get_model_requests',
    ...
    'ray_serve_multiplexed_models_load_counter_total': 'serve.multiplexed_models_load',
    'ray_serve_multiplexed_models_unload_counter': 'serve.multiplexed_models_unload',
    'ray_serve_multiplexed_models_unload_counter_total': 'serve.multiplexed_models_unload',
    'ray_serve_num_deployment_grpc_error_requests': 'serve.num_deployment_grpc_error_requests',
    'ray_serve_num_deployment_grpc_error_requests_total': 'serve.num_deployment_grpc_error_requests',
    'ray_serve_num_deployment_http_error_requests': 'serve.num_deployment_http_error_requests',
    'ray_serve_num_deployment_http_error_requests_total': 'serve.num_deployment_http_error_requests',
    'ray_serve_num_grpc_error_requests': 'serve.num_grpc_error_requests',
    'ray_serve_num_grpc_error_requests_total': 'serve.num_grpc_error_requests',
    'ray_serve_num_grpc_requests': 'serve.num_grpc_requests',
    'ray_serve_num_grpc_requests_total': 'serve.num_grpc_requests',
    'ray_serve_num_http_error_requests': 'serve.num_http_error_requests',
    'ray_serve_num_http_error_requests_total': 'serve.num_http_error_requests',
    'ray_serve_num_http_requests': 'serve.num_http_requests',
    'ray_serve_num_http_requests_total': 'serve.num_http_requests',
    ...
    'ray_serve_num_router_requests_total': 'serve.num_router_requests',
