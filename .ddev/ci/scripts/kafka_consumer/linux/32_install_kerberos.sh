...
sudo apt install -y --no-install-recommends build-essential libkrb5-dev libsasl2-dev wget software-properties-common lsb-release gcc make python3 python3-pip python3-dev libsasl2-modules-gssapi-mit krb5-user
