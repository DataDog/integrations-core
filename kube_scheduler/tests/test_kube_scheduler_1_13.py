...
def mock_metrics(mock_openmetrics_http):
    return make_mock_metrics(mock_openmetrics_http, 'metrics_1.13.3.txt')
...
def test_check_metrics_1_13(aggregator, mock_metrics, mock_leader, mock_healthcheck_wrapper):
