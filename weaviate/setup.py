...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'weaviate', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-weaviate',
    version=ABOUT['__version__'],
    description='The Weaviate check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent weaviate check',
    ...
    packages=['datadog_checks.weaviate'],
