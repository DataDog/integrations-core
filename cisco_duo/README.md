...
**Note**: *The Administrator and Offline Enrollment log endpoints and dashboards will be deprecated in the future. Migrate your use of these endpoints, in any related custom assets, to the Activity Logs endpoint to avoid service disruption.*
