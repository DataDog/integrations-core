...
version = find_version("datadog_checks", "ecs_fargate", "__init__.py")
...
setup(
    ...
    keywords='datadog agent ecs fargate check',
    ...
    package_data={b'datadog_checks.ecs_fargate': ['conf.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'ecs_fargate=datadog_checks.ecs_fargate:main',
        ],
    },
)
