...
**Note**: This page describes the ECS Fargate integration. For EKS Fargate, see the documentation for Datadog's [EKS Fargate integration][35].
...
[35]: http://docs.datadoghq.com/integrations/eks_fargate
