...
class ProbesPrometheusScraperMixin(object):
    ...
    def _create_probes_prometheus_instance(self, instance):
        ...
        endpoint = kubelet_conn_info.get('url') if kubelet_conn_info is not None else "dummy_url/probes" # dummy needed in case kubelet isn't running when the check is first
