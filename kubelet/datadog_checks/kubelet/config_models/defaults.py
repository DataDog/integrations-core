...
def instance_cadvisor_metrics_endpoint(field, value):
    return 'http://10.8.0.1:10255/metrics/cadvisor'


def instance_cadvisor_port(field, value):
    return 4194
...
def instance_enabled_gauges(field, value):
    return get_default_field_value(field, value)


def instance_enabled_rates(field, value):
    return get_default_field_value(field, value)
...
def instance_kubelet_metrics_endpoint(field, value):
...
def instance_probes_metrics_endpoint(field, value):
