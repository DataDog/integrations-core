...
class InstanceConfig(BaseModel):
    ...
    cadvisor_metrics_endpoint: Optional[str]
    cadvisor_port: Optional[int]
    connect_timeout: Optional[float]
    disable_generic_tags: Optional[bool]
    empty_default_hostname: Optional[bool]
    enabled_gauges: Optional[Sequence[str]]
    enabled_rates: Optional[Sequence[str]]
    ...
    kubelet_metrics_endpoint: Optional[str]
    ...
    probes_metrics_endpoint: Optional[str]
