            ...
            if parsed:
                ...
                if t == "SERVICE ALERT":
                    ...
                    assert event["msg_title"] == \
                        "event_soft_hard|,event_type|,check_name|cassandra JVM Heap,\
                        event_state|,payload|yes,ack_author|nagiosadmin" or \
                        "event_soft_hard|,event_type|,check_name|cassandra JVM Heap,\
                        event_state|,payload| will look into it tomorrow,ack_author|nagiosadmin" or \
                        "event_soft_hard|,event_type|,check_name|cassandra JVM Heap,\
                        event_state|,payload|alq,ack_author|nagiosadmin"
