...
AGENT_V2_METRICS_1_14 = [
    ...
    # Envoy XDS
    "cilium.xds.events.count",
    # Disabled by default
    "cilium.datapath.nat_gc.entries",
    "cilium.fqdn.semaphore_rejected.count",
    "cilium.hive.degraded_status",
    "cilium.neighbor.entry_refresh.count",
    "cilium.neighbor.nexthop_lookup.count",
    "cilium.neighbor.entry_insert.count",
    "cilium.neighbor.entry_delete.count",
    "cilium.statedb.write_txn_duration.seconds.bucket",
...
AGENT_V1_METRICS_1_14 = [
    ...
    "cilium.policy.selector_cache.operation_duration.seconds.count",
    "cilium.policy.selector_cache.operation_duration.seconds.sum",
    # Active Connection Tracking (ACT) - gauges + histogram V1 + counter V1
    "cilium.act.new_connections",
    "cilium.act.active_connections",
    "cilium.act.failed_connections",
    "cilium.act.processing_time.seconds.count",
    ...
    "cilium.statedb.table_graveyard_low_watermark",
    "cilium.reconciler.errors_current",
    # Feature metrics (V1 names - gauges same, counters use .total)
    "cilium.feature.controlplane.ipam",
    "cilium.feature.controlplane.identity_allocation",
    "cilium.feature.controlplane.cilium_endpoint_slices_enabled",
    "cilium.feature.datapath.network",
...
OPERATOR_V2_METRICS_1_14 = [
    ...
    # Operator k8s workqueue (distinct DD names from agent workqueue)
