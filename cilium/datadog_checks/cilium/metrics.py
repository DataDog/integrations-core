...
AGENT_METRICS = {
    ...
    'cilium_datapath_errors_total': 'datapath.errors.total', # Cilium <= 1.9
    'cilium_drop_bytes_total': 'drop_bytes.total',
    'cilium_drop_count_total': 'drop_count.total',
    'cilium_endpoint_count': 'endpoint.count', # Cilium <= 1.9
    ...
    'cilium_identity_count': 'identity.count', # Cilium <= 1.9
    ...
    'cilium_policy_l7_denied_total': 'policy.l7_denied.total', # Cilium <= 1.7
    'cilium_policy_l7_forwarded_total': 'policy.l7_forwarded.total', # Cilium <= 1.7
    'cilium_policy_l7_parse_errors_total': 'policy.l7_parse_errors.total', # Cilium <= 1.7
    'cilium_policy_l7_received_total': 'policy.l7_received.total', # Cilium <= 1.7
...
OPERATOR_METRICS = {
    ...
    'cilium_operator_eni_aws_api_duration_seconds': 'operator.eni.aws_api_duration.seconds', # Cilium <= 1.8
    ...
    'cilium_operator_eni_ec2_rate_limit_duration_seconds': 'operator.eni_ec2.rate_limit.duration.seconds', # Cilium <= 1.9
    'cilium_operator_eni_ec2_resync_duration_seconds': 'operator.eni.ec2_resync.duration.seconds', # Cilium <= 1.9
    'cilium_operator_eni_ec2_resync_folds': 'operator.eni.ec2_resync.folds', # Cilium <= 1.9
    'cilium_operator_eni_ec2_resync_latency_seconds': 'operator.eni.ec2_resync.latency.seconds', # Cilium <= 1.9
    'cilium_operator_eni_ec2_resync_queued_total': 'operator.eni.ec2_resync.queued.total', # Cilium <= 1.9
    'cilium_operator_eni_interface_creation_ops': 'operator.eni.interface_creation_ops', # Cilium <= 1.9
    'cilium_operator_eni_ips': 'operator.eni.ips.total', # Cilium <= 1.9
    'cilium_operator_eni_k8s_sync_duration_seconds': 'operator.eni.k8s_sync.duration.seconds', # Cilium <= 1.9
    'cilium_operator_eni_k8s_sync_folds': 'operator.eni.k8s_sync.folds', # Cilium <= 1.9
    'cilium_operator_eni_k8s_sync_latency_seconds': 'operator.eni.k8s_sync.latency.seconds', # Cilium <= 1.9
    'cilium_operator_eni_k8s_sync_queued_total': 'operator.eni.k8s_sync.queued.total', # Cilium <= 1.9
    'cilium_operator_eni_nodes': 'operator.eni.nodes.total', # Cilium <= 1.9
    'cilium_operator_eni_resync_total': 'operator.eni.resync.total', # Cilium <= 1.9
    'cilium_operator_ec2_api_duration_seconds': 'operator.ec2.api.duration.seconds', # Cilium 1.9+
    'cilium_operator_ec2_api_rate_limit_duration_seconds': 'operator.ec2.api.rate_limit.duration.seconds', # Cilium 1.9+
    'cilium_operator_ipam_api_duration_seconds': 'operator.ipam.api.duration.seconds', # Cilium 1.9+
    'cilium_operator_ipam_api_rate_limit_duration_seconds': 'operator.ipam.api.rate_limit.duration.seconds', # Cilium 1.9+
    'cilium_operator_ipam_available': 'operator.ipam.available', # Cilium 1.8+
    'cilium_operator_ipam_available_ips_per_subnet': 'operator.ipam.available.ips_per_subnet', # Cilium 1.8+
    'cilium_operator_ipam_deficit_resolver_duration_seconds': 'operator.ipam.deficit_resolver.duration.seconds', # Cilium 1.8+
    'cilium_operator_ipam_deficit_resolver_folds': 'operator.ipam.deficit_resolver.folds', # Cilium 1.8+
    'cilium_operator_ipam_deficit_resolver_latency_seconds': 'operator.ipam.deficit_resolver.latency.seconds', # Cilium 1.8+
    'cilium_operator_ipam_deficit_resolver_queued_total': 'operator.ipam.deficit_resolver.queued.total', # Cilium 1.8+
    'cilium_operator_ipam_ips': 'operator.ipam.ips', # Cilium 1.8+
    'cilium_operator_ipam_allocation_ops': 'operator.ipam.allocation_ops', # Cilium 1.8+
    'cilium_operator_ipam_release_ops': 'operator.ipam.release_ops', # Cilium 1.8+
    'cilium_operator_ipam_interface_creation_ops': 'operator.ipam.interface_creation_ops', # Cilium 1.8+
    'cilium_operator_ipam_k8s_sync_duration_seconds': 'operator.ipam.k8s_sync.duration.seconds', # Cilium 1.8+
    'cilium_operator_ipam_k8s_sync_folds': 'operator.ipam.k8s_sync.folds', # Cilium 1.8+
    'cilium_operator_ipam_k8s_sync_latency_seconds': 'operator.ipam.k8s_sync.latency.seconds', # Cilium 1.8+
    'cilium_operator_ipam_k8s_sync_queued_total': 'operator.ipam.k8s_sync.queued.total', # Cilium 1.8+
    'cilium_operator_ipam_nodes': 'operator.ipam.nodes', # Cilium 1.8+
    'cilium_operator_ipam_resync_duration_seconds': 'operator.ipam.resync.duration.seconds', # Cilium 1.9+
    'cilium_operator_ipam_resync_folds': 'operator.ipam.resync.folds', # Cilium 1.9+
    'cilium_operator_ipam_resync_latency_seconds': 'operator.ipam.resync.latency.seconds', # Cilium 1.9+
    'cilium_operator_ipam_resync_queued_total': 'operator.ipam.resync.queued.total', # Cilium 1.9+
    'cilium_operator_ipam_resync_total': 'operator.ipam.resync.total', # Cilium 1.8+
    'cilium_operator_identity_gc_entries': 'operator.identity_gc.entries', # Cilium 1.11+
    'cilium_operator_identity_gc_runs': 'operator.identity_gc.runs', # Cilium 1.11+
    'cilium_operator_number_of_ceps_per_ces': 'operator.num_ceps_per_ces', # Cilium 1.11+
    'cilium_operator_ces_queueing_delay_seconds': 'operator.ces.queueing_delay.seconds', # Cilium 1.11+
    'cilium_operator_ces_sync_errors_total': 'operator.ces.sync_errors.total', # Cilium 1.11+
}
