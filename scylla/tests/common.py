...
INSTANCE_3_2_METRIC_GROUP_MAP = {
    ...
    'scylla.transport': [
        ...
        'scylla.transport.requests_blocked_memory',
        'scylla.transport.requests_blocked_memory_current',
        'scylla.transport.requests_memory_avaiable',
        'scylla.transport.requests_served',
        'scylla.transport.requests_serving',
    ],
}
...
INSTANCE_5_2_METRIC_GROUP_MAP = {
    ...
    'scylla.cache': [
        ...
        'scylla.cache.bytes_used',
        'scylla.cache.concurrent_misses_same_key',
        'scylla.cache.dropped_by_tombstones',
    ...
    'scylla.raft': [
        ...
        'scylla_raft_persisted_log_entriespersisted_log_entries',
        'scylla_raft_polls',
...
INSTANCE_5_2_ADDITIONAL_GROUPS = [
    'scylla.alien',
    'scylla.batchlog_manager',
    'scylla.commitlog',
    'scylla.cdc',
...
if os.environ['SCYLLA_VERSION'] == '5.2.6':
    INSTANCE_ADDITIONAL_METRICS = get_metrics(INSTANCE_5_2_ADDITIONAL_GROUPS)
else:
