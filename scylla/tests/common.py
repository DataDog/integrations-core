...
if os.environ['SCYLLA_VERSION'] == '5.2.6':
    INSTANCE_ADDITIONAL_GROUPS = INSTANCE_5_ADDITIONAL_GROUPS
    INSTANCE_ADDITIONAL_METRICS = get_metrics(INSTANCE_5_ADDITIONAL_GROUPS)
    FLAKY_METRICS = FLAKY_METRICS_5
else:
    INSTANCE_ADDITIONAL_GROUPS = INSTANCE_3_ADDITIONAL_GROUPS
    INSTANCE_ADDITIONAL_METRICS = get_metrics(INSTANCE_3_ADDITIONAL_GROUPS)
