...
MANAGER_METRICS = {
    ...
    'go_memstats_heap_released_bytes_total': 'go.memstats.heap_released_bytes_total',
    ...
    'scylla_manager_healthcheck_cql_rtt_ms': 'healthcheck_cql_rtt_ms',
    'scylla_manager_healthcheck_cql_status': 'healthcheck_cql_status',
    'scylla_manager_task_active_count': 'task_active_count',
    'scylla_manager_task_run_total': 'task_run_total',
}
