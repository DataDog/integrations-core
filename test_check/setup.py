...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'test_check', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-test_check',
    version=ABOUT['__version__'],
    description='The Test Check check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent test_check check',
    ...
    packages=['datadog_checks.test_check'],
