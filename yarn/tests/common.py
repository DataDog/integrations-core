...
# Service URLs
YARN_CLUSTER_METRICS_URL = "{}{}".format(RM_ADDRESS, YarnCheck.YARN_CLUSTER_METRICS_PATH)
YARN_APPS_URL = "{}{}?states={}".format(RM_ADDRESS, YarnCheck.YARN_APPS_PATH, YarnCheck.YARN_APPLICATION_STATES)
YARN_NODES_URL = "{}{}".format(RM_ADDRESS, YarnCheck.YARN_NODES_PATH)
YARN_SCHEDULER_URL = "{}{}".format(RM_ADDRESS, YarnCheck.YARN_SCHEDULER_PATH)
