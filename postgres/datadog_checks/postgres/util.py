...
# pg_replication_slots columns, collected on PG 10+. two_phase_at was added in PG 18 and reports the
# LSN from which a two-phase slot must retain WAL, so it is gated to PG 18+ with a VersionRange.
