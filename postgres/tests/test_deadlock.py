...
#                 host=HOST, dbname=DB_NAME, user="bob", password="bob", autocommit=False, cursor_factory=ClientCursor
#         ) as tconn:
...
#
#     taskOne = threading.Thread(target=execute_in_thread, args=(appname_sql, appname1,))
#     # cur1.execute(appname_sql, (appname1,))
#     taskTwo = threading.Thread(target=execute_in_thread, args=(update_sql, 1,))
