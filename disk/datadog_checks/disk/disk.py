...
class Disk(AgentCheck):
    ...
    def _get_devices_label_from_lsblk(self):
        ...
        try:
            ...
            lsblk_out, _, _ = self.os.get_subprocess_output(
    ...
    def _get_devices_label_from_blkid(self):
        devices_label = {}
        try:
            blkid_out, _, _ = self.os.get_subprocess_output(['blkid'], self.log)
    ...
    def _get_devices_label_from_blkid_cache(self):
        devices_label = {}
        try:
            with self.os.open(self._blkid_cache_file, 'r') as blkid_cache_file_handler:
