...
@pytest.mark.parametrize(
    ...
    [
        ...
        },
        {
            ...
            'query_start': '2023-10-06T19:36:10.553+00:00',
            'user_name': 'shopper_3',
            'last_request_start_time': datetime.datetime(2023, 10, 6, 19, 36, 10, 553000),
            'id': 71,
            'database_name': 'dbmorders_1',
            'session_status': 'running',
            ...
            'wait_type': None,
            'wait_time': 0,
            'last_wait_type': 'MEMORY_ALLOCATION_EXT',
            'wait_resource': '',
            'open_transaction_count': 0,
            'transaction_id': 966590374704,
            'percent_complete': 0.0,
            'estimated_completion_time': 0,
            'cpu_time': 2,
            ...
            'deadlock_priority': 0,
            'row_count': 1,
            'query_hash': b'Y\xaf\x17\xe3\xf5\x94\x1c\xb3',
            'query_plan_hash': b'@\xff\x1d\xb4O\xeaG\r',
        },
    ],
)
def test_sanitize_activity_row(dbm_instance, row):
    check = SQLServer(CHECK_NAME, {}, [dbm_instance])
    check.activity._remove_null_vals(row)
