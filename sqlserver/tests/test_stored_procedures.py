...
#     with check.connection.open_managed_default_connection(key_prefix=_conn_key_prefix):
#         with check.connection.get_managed_cursor(key_prefix=_conn_key_prefix) as cursor:
#             statement_metrics_query = check.procedure_metrics._get_statement_metrics_query_cached(cursor)
...
#     with mock.patch.object(check.procedure_metrics, '_load_plan', passthrough=True) as mock_obj:
