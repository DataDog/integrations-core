...
# only bounds how stale a selection and its caller's discovery snapshot may get before the worker
# reconsiders both. Keep it independent of any check interval: tying the two truncated the pacing
# of small estates and undid the spreading on exactly the configurations cheapest to spread.
