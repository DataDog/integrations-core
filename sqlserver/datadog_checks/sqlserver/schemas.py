...
class SQLServerSchemaCollector(SchemaCollector):
    ...
    def _get_databases(self):
        ...
        with self._check.connection.open_managed_default_connection(key_prefix="dbm-schemas-"):
            with self._check.connection.get_managed_cursor(key_prefix="dbm-schemas-") as cursor:
    ...
    def _map_row(self, database: DatabaseInfo, cursor_row) -> DatabaseObject:
        ...
        if self._is_2016_or_earlier:
            ...
            with self._check.connection.open_managed_default_connection(key_prefix="dbm-schemas-pre-2017"):
                with self._check.connection.get_managed_cursor(key_prefix="dbm-schemas-pre-2017") as cursor:
