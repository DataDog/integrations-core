...
COLUMN_QUERY = "SET STATISTICS TIME ON; SELECT COLUMN_NAME AS name, DATA_TYPE AS data_type, COLUMN_DEFAULT, IS_NULLABLE AS nullable , TABLE_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME IN ({}) and TABLE_SCHEMA='{}'; SET STATISTICS TIME OFF;"
