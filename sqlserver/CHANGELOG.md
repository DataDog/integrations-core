...
* [Added] sqlserver: Add statement metadata to events and metrics payload. See [#10881](https://github.com/DataDog/integrations-core/pull/10881).
...
* [Fixed] Properly filter databases when using database autodiscovery. See [#10416](https://github.com/DataDog/integrations-core/pull/10416).
