...
version = find_version("datadog_checks", "kube_proxy", "__init__.py")
...
setup(
    name='datadog-kube_proxy',
    version=version,
    description='The kube proxy check',
    long_description=long_description,
    keywords='datadog agent kube proxy check',
    ...
    package_data={b'datadog_checks.kube_proxy': ['conf.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'kube_proxy=datadog_checks.kube_proxy:main',
        ],
    },
)
