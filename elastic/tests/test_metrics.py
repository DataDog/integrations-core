...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param([2, 0, 0], False, 237, id='v2.0.0'),
        pytest.param([2, 1, 0], False, 242, id='v2.1.0'),
        pytest.param([5, 0, 0], False, 247, id='v5'),
        pytest.param([6, 3, 0], False, 247, id='v6.3.0'),
        pytest.param([7, 2, 0], False, 241, id='v7.2.0'),
        ...
        pytest.param([2, 0, 0], True, 241, id='jmx-rate-v2.0.0'),
        pytest.param([2, 1, 0], True, 246, id='jmx-rate-v2.1.0'),
        pytest.param([5, 0, 0], True, 251, id='jmx-rate-v5'),
        pytest.param([6, 3, 0], True, 251, id='jmx-rate-v6.3.0'),
        pytest.param([7, 2, 0], True, 245, id='jmx-rate-v7.2.0'),
        pytest.param([7, 9, 0], True, 248, id='jmx-rate-v7.9.0'),
    ],
)
