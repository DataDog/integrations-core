...
STATS_METRICS = {
    ...
    'elasticsearch.get.exists.time.count': ('monotonic_count', 'indices.get.exists_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.get.missing.time.count': ('monotonic_count', 'indices.get.missing_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.search.query.time.count': ('monotonic_count', 'indices.search.query_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.search.fetch.time.count': ('monotonic_count', 'indices.search.fetch_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.merges.total.time.count': ('monotonic_count', 'indices.merges.total_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.refresh.total.time.count': ('monotonic_count', 'indices.refresh.total_time_in_millis', lambda ms: ms_to_second(ms)),
    ...
    'elasticsearch.flush.total.time.count': ('monotonic_count', 'indices.flush.total_time_in_millis', lambda ms: ms_to_second(ms)),
...
ADDITIONAL_METRICS_5_x = {
    ...
    'elasticsearch.search.scroll.time.count': ('monotonic_count', 'indices.search.scroll_time_in_millis', lambda ms: ms_to_second(ms)),
