...
STATS_METRICS = {
    ...
    'elasticsearch.thread_pool.warmer.rejected': ('gauge', 'thread_pool.warmer.rejected'),
...
ADDITIONAL_METRICS_BY_VERSION = {
    ...
    (1, 4, 0): {
        ...
        'elasticsearch.thread_pool.listener.rejected': ('gauge', 'thread_pool.listener.rejected'),
    ...
    (1, 6, 0): {
        ...
        'elasticsearch.thread_pool.fetch_shard_store.rejected': ('gauge', 'thread_pool.fetch_shard_store.rejected'),
    },
    (2, 0, 0): {
        ...
        'elasticsearch.indices.request_cache.evictions': ('gauge', 'indices.request_cache.evictions'),
        'elasticsearch.indices.request_cache.evictions.count': (
            'monotonic_count',
            'indices.request_cache.evictions',
        ),
        'elasticsearch.indices.request_cache.hit_count': ('gauge', 'indices.request_cache.hit_count'),
        'elasticsearch.indices.request_cache.hit_count.count': (
            'monotonic_count',
            'indices.request_cache.hit_count',
        ),
        'elasticsearch.indices.request_cache.miss_count': ('gauge', 'indices.request_cache.miss_count'),
    ...
    (2, 1, 0): {
        ...
        'elasticsearch.indices.indexing.index_failed': ('gauge', 'indices.indexing.index_failed'),
    ...
    (5, 0, 0): {
        'elasticsearch.fs.total.disk_io_op': ('gauge', 'fs.io_stats.total.operations'),
        'elasticsearch.fs.total.disk_reads': ('gauge', 'fs.io_stats.total.read_operations'),
        'elasticsearch.fs.total.disk_writes': ('gauge', 'fs.io_stats.total.write_operations'),
    ...
    (6, 3, 0): {
        ...
        'elasticsearch.thread_pool.write.rejected': ('gauge', 'thread_pool.write.rejected'),
        'elasticsearch.thread_pool.write.rejected.count': ('monotonic_count', 'thread_pool.write.rejected'),
        'elasticsearch.thread_pool.write.completed': ('gauge', 'thread_pool.write.completed'),
