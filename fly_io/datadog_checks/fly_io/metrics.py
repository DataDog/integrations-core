...
FLY_INSTANCE_METRICS = {
    ...
    'fly_instance_cpu': {'name': 'instance.cpu', 'type': 'gauge'},
}
...
FLY_INSTANCE_DISK_METRICS = {
    'fly_instance_disk_reads_completed': {'name': 'instance.disk.reads_completed', 'type': 'gauge'},
    'fly_instance_disk_reads_merged': {'name': 'instance.disk.reads_merged', 'type': 'gauge'},
    'fly_instance_disk_sectors_read': {'name': 'instance.disk.sectors_read', 'type': 'gauge'},
    'fly_instance_disk_time_reading': {'name': 'instance.disk.time_reading', 'type': 'gauge'},
    'fly_instance_disk_writes_completed': {'name': 'instance.disk.writes_completed', 'type': 'gauge'},
    'fly_instance_disk_writes_merged': {'name': 'instance.disk.writes_merged', 'type': 'gauge'},
    'fly_instance_disk_sectors_written': {'name': 'instance.disk.sectors_written', 'type': 'gauge'},
    'fly_instance_disk_time_writing': {'name': 'instance.disk.time_writing', 'type': 'gauge'},
    'fly_instance_disk_io_in_progress': {'name': 'instance.disk.io_in_progress', 'type': 'gauge'},
    'fly_instance_disk_time_io': {'name': 'instance.disk.time_io', 'type': 'gauge'},
    'fly_instance_disk_time_io_weighted': {'name': 'instance.disk.time_io_weighted', 'type': 'gauge'},
}

FLY_INSTANCE_NET_METRICS = {
    'fly_instance_net_recv_bytes': {'name': 'instance.net.recv_bytes', 'type': 'gauge'},
    'fly_instance_net_recv_packets': {'name': 'instance.net.recv_packets', 'type': 'gauge'},
    'fly_instance_net_recv_errs': {'name': 'instance.net.recv_errs', 'type': 'gauge'},
    'fly_instance_net_recv_drop': {'name': 'instance.net.recv_drop', 'type': 'gauge'},
    'fly_instance_net_recv_fifo': {'name': 'instance.net.recv_fifo', 'type': 'gauge'},
    'fly_instance_net_recv_frame': {'name': 'instance.net.recv_frame', 'type': 'gauge'},
    'fly_instance_net_recv_compressed': {'name': 'instance.net.recv_compressed', 'type': 'gauge'},
    'fly_instance_net_recv_multicast': {'name': 'instance.net.recv_multicast', 'type': 'gauge'},
    'fly_instance_net_sent_bytes': {'name': 'instance.net.sent_bytes', 'type': 'gauge'},
    'fly_instance_net_sent_packets': {'name': 'instance.net.sent_packets', 'type': 'gauge'},
    'fly_instance_net_sent_errs': {'name': 'instance.net.sent_errs', 'type': 'gauge'},
    'fly_instance_net_sent_drop': {'name': 'instance.net.sent_drop', 'type': 'gauge'},
    'fly_instance_net_sent_fifo': {'name': 'instance.net.sent_fifo', 'type': 'gauge'},
    'fly_instance_net_sent_colls': {'name': 'instance.net.sent_colls', 'type': 'gauge'},
    'fly_instance_net_sent_carrier': {'name': 'instance.net.sent_carrier', 'type': 'gauge'},
    'fly_instance_net_sent_compressed': {'name': 'instance.net.sent_compressed', 'type': 'gauge'},
}
...
FLY_POSTGRES_METRICS = {
    ...
    'pg_stat_bgwriter_buffers_checkpoint': {'name': 'pg_stat.bgwriter.buffers_checkpoint', 'type': 'gauge'},
    'pg_stat_bgwriter_buffers_clean': {'name': 'pg_stat.bgwriter.buffers_clean', 'type': 'gauge'},
    'pg_stat_bgwriter_checkpoint_sync_time': {'name': 'pg_stat.bgwriter.checkpoint_sync_time', 'type': 'gauge'},
    'pg_stat_bgwriter_checkpoint_write_time': {'name': 'pg_stat.bgwriter.checkpoint_write_time', 'type': 'gauge'},
    'pg_stat_bgwriter_checkpoints_req': {'name': 'pg_stat.bgwriter.checkpoints_req', 'type': 'gauge'},
    'pg_stat_bgwriter_checkpoints_timed': {'name': 'pg_stat.bgwriter.checkpoints_timed', 'type': 'gauge'},
    'pg_stat_bgwriter_maxwritten_clean': {'name': 'pg_stat.bgwriter.maxwritten_clean', 'type': 'gauge'},
    'pg_stat_bgwriter_stats_reset': {'name': 'pg_stat.bgwriter.stats_reset', 'type': 'gauge'},
    'pg_stat_database_blk_read_time': {'name': 'pg_stat.database.blk_read_time', 'type': 'gauge'},
    'pg_stat_database_blk_write_time': {'name': 'pg_stat.database.blk_write_time', 'type': 'gauge'},
    'pg_stat_database_blks_hit': {'name': 'pg_stat.database.blks_hit', 'type': 'gauge'},
    'pg_stat_database_blks_read': {'name': 'pg_stat.database.blks_read', 'type': 'gauge'},
    ...
    'pg_stat_database_conflicts': {'name': 'pg_stat.database.conflicts', 'type': 'gauge'},
    'pg_stat_database_deadlocks': {'name': 'pg_stat.database.deadlocks', 'type': 'gauge'},
    'pg_stat_database_numbackends': {'name': 'pg_stat.database.numbackends', 'type': 'gauge'},
    'pg_stat_database_stats_reset': {'name': 'pg_stat.database.stats_reset', 'type': 'gauge'},
    'pg_stat_database_tup_deleted': {'name': 'pg_stat.database.tup_deleted', 'type': 'gauge'},
    'pg_stat_database_tup_fetched': {'name': 'pg_stat.database.tup_fetched', 'type': 'gauge'},
    'pg_stat_database_tup_inserted': {'name': 'pg_stat.database.tup_inserted', 'type': 'gauge'},
    'pg_stat_database_tup_returned': {'name': 'pg_stat.database.tup_returned', 'type': 'gauge'},
    'pg_stat_database_tup_updated': {'name': 'pg_stat.database.tup_updated', 'type': 'gauge'},
    'pg_stat_database_xact_commit': {'name': 'pg_stat.database.xact_commit', 'type': 'gauge'},
    'pg_stat_database_xact_rollback': {'name': 'pg_stat.database.xact_rollback', 'type': 'gauge'},
