...
4. Click **Save**.
5. Identify your subdomain by checking the hostname suffix of your ExtraHop Platform URL. For example, if `<example>.cloud.extrahop.com` is your platform URL, then `example` is your subdomain.
