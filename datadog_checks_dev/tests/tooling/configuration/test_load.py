...
def test_template_array():
    ...
    assert options[12]['name'] == 'aws_host'
    assert options[13]['name'] == 'aws_region'
    assert options[14]['name'] == 'tls_verify'
    assert options[15]['name'] == 'tls_ignore_warning'
    assert options[16]['name'] == 'tls_cert'
    assert options[17]['name'] == 'tls_private_key'
    assert options[18]['name'] == 'tls_ca_cert'
    assert options[19]['name'] == 'headers'
    assert options[20]['name'] == 'extra_headers'
    assert options[21]['name'] == 'timeout'
    assert options[22]['name'] == 'connect_timeout'
    assert options[23]['name'] == 'read_timeout'
    assert options[24]['name'] == 'log_requests'
    assert options[25]['name'] == 'persist_connections'
    assert options[26]['name'] == 'bar'
