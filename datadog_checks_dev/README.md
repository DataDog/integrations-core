...
Options:
  -a, --agent TEXT  The agent build to use e.g. a Docker tag. For Docker
                    environments you can use an integer corresponding to
                    fields in the config (agent5, agent6, etc.)
