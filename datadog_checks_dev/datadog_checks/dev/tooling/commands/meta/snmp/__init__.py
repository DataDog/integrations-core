...
from .check_duplicate_metrics import check_duplicate_metrics

ALL_COMMANDS = [generate_profile_from_mibs, translate_profile, validate_mib_filenames, check_duplicate_metrics]
