...
def get_commit(repo, commit_sha, config):
    response = requests.get(
        f'https://api.github.com/repos/DataDog/{repo}/git/commits/{commit_sha}',
...
def get_tag(repo, ref, config):
    response = requests.get(
        f'https://api.github.com/repos/DataDog/{repo}/git/tags/{ref}',
        auth=get_auth_info(config),
    )
...
def get_tags(repo, config):
    response = requests.get(
        f'https://api.github.com/repos/DataDog/{repo}/git/refs/tags',
        auth=get_auth_info(config),
    )
