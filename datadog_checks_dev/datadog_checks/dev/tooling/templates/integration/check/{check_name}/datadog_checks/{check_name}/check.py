...
class {check_class}(AgentCheck):
    def check(self, _):
        ...
        # More info at https://datadoghq.dev/integrations-core/base/databases/#datadog_checks.base.utils.db.core.QueryManager
        self._query_manager.execute()

        # If your check ran succesfully, you can send the status.
        # More info at https://datadoghq.dev/integrations-core/base/api/#datadog_checks.base.checks.base.AgentCheck.service_check
