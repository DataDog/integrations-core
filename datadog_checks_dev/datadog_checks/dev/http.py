...
class MockResponse(Response):
    """Requests-backed test double. New tests should reach for MockHTTPResponse below, which stands in
    for the backend-agnostic HTTPResponse protocol rather than for a concrete requests response."""
