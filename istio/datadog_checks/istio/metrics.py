...
MIXER_METRICS = {
    ...
    'mixer_config_rule_config_error_count': 'config.rule.config.error.count',
    'mixer_config_rule_config_match_error_count': 'config.rule.config.match.error.count',
    'mixer_config_unsatisfied_action_handler_count': 'config.unsatisfied.action.handler.count',
    'mixer_config_adapter_info_config_error_count': 'config.adapter.info.config.error.count',
    'mixer_config_handler_validation_error_count': 'config.handler.validation.error.count',
    'mixer_config_instance_config_error_count': 'config.instance.config.error.count',
    'mixer_handler_handler_build_failure_count': 'handler.handler.build.failure.count',
}
