...
setup(
    ...
    packages=['dd_integrations.activemq_xml'],
    ...
    package_data={b'dd_integrations.activemq_xml': ['activemq_xml.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'activemq_xml=dd_integrations.activemq_xml:main',
        ],
    },
)
