...
class TestNfsstat:
    ...
    def test_check(self, aggregator, mock_safe_os):
        instance = self.INSTANCES['main']
        c = NfsStatCheck(self.CHECK_NAME, self.INIT_CONFIG, [instance])
        ...
        mock_safe_os.get_subprocess_output.return_value = (mock_output, '', 0)
        c.check(instance)
