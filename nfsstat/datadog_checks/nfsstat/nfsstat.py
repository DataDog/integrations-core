...
class NfsStatCheck(AgentCheck):
    ...
    def check(self, instance):
        stat_out, err, _ = self.os.get_subprocess_output(self.nfs_cmd, self.log)
        all_devices = []
        this_device = []
