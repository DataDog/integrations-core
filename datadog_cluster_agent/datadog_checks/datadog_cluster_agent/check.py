...
DEFAULT_METRICS = {
    ...
    'language_detection_dca_handler_fail_response': 'language_detection_dca_handler.fail_response',
    'language_detection_dca_handler_ok_response': 'language_detection_dca_handler.ok_response',
    'language_detection_patcher_fail_patch': 'language_detection_patcher.fail_patch',
    'language_detection_patcher_retries': 'language_detection_patcher.retries',
    'language_detection_patcher_skipped_patch': 'language_detection_patcher.skipped_patch',
    'language_detection_patcher_success_patch': 'language_detection_patcher.success_patch',
