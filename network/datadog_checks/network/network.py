...
class Network(AgentCheck):
    ...
    def _check_linux(self, instance):
        ...
        if self._is_collect_cx_state_runnable(net_proc_base_location):
            self._collect_connection_state_linux(net_proc_base_location, custom_tags)

        self._collect_device_and_ethtool_metrics_linux(net_proc_base_location, custom_tags)
        self._collect_netstat_metrics_linux(net_proc_base_location, custom_tags)
        self._collect_conntrack_metrics_linux(proc_location, custom_tags)
    ...
    def _collect_connection_state_linux(self, net_proc_base_location, custom_tags):
        try:
    ...
    def _collect_device_and_ethtool_metrics_linux(self, net_proc_base_location, custom_tags):
    ...
    def _collect_netstat_metrics_linux(self, net_proc_base_location, custom_tags):
        netstat_data = {}
    ...
    def _collect_conntrack_metrics_linux(self, proc_location, custom_tags):
