...
class KafkaCheck(AgentCheck):
    ...
    def check(self, _):
        ...
        try:
            self._consumer_offsets = self.client.get_consumer_offsets()
        except Exception:
        ...
        try:
            if self.should_get_highwater_offsets():
                self._highwater_offsets = self.client.get_highwater_offsets()
            else:
    ...
    def collect_broker_metadata(self):
        ...
        version_data = [str(part) for part in version]
