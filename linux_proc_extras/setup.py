...
setup(
    ...
    packages=['check', 'check.linux_proc_extras'],
    ...
    package_data={b'check.linux_proc_extras': ['linux_proc_extras.yaml.example']},
    include_package_data=True,

    # The entrypoint to run the check manually without an agent
    entry_points={
        'console_scripts': [
            'linux_proc_extras=check.linux_proc_extras:main',
        ],
    },
)
