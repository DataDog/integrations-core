...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'windows_registry', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-windows_registry',
    version=ABOUT['__version__'],
    description='The Windows Registry check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent windows_registry check',
    ...
    packages=['datadog_checks.windows_registry'],
