...
from .common import HOST, USERNAME, PASSWORD, PORT
...
def test_redis_auth_acl_good(aggregator, redis_auth_acl):
    ...
    """
    instance = {'host': HOST, 'port': PORT, 'username': USERNAME, 'password': PASSWORD, 'collect_client_metrics': False}
    redis = Redis('redisdb', {}, [instance])
...
def test_redis_auth_acl_bad(aggregator, redis_auth_acl):
    ...
    """
    instance = {'host': HOST, 'port': PORT, 'username': USERNAME, 'password': PASSWORD, 'collect_client_metrics': True}
    redis = Redis('redisdb', {}, [instance])
