...
def assert_common_metrics(aggregator):
    ...
    aggregator.assert_metric('redis.net.instantaneous_input_kbps', count=2, tags=tags)
    aggregator.assert_metric('redis.net.instantaneous_output_kbps', count=2, tags=tags)
