...
def test_e2e_v_latest(dd_agent_check, master_instance):
    ...
    aggregator.assert_metric('redis.clients.recent_max_input_buffer', count=1, tags=tags)
    aggregator.assert_metric('redis.clients.recent_max_output_buffer', count=1, tags=tags)
