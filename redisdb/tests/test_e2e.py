...
def assert_common_metrics(aggregator):
    ...
    aggregator.assert_metric('redis.net.instantaneous_input', count=1, tags=tags)
    aggregator.assert_metric('redis.net.instantaneous_output', count=1, tags=tags)
    ...
    aggregator.assert_metric('redis.net.commands', count=2, tags=tags)
...
def test_e2e(dd_agent_check, master_instance):
    ...
    if redis_version == 'latest' or int(redis_version) > 7:
        ...
        aggregator.assert_metric('redis.eventloop.instantaneous_cycles_per_sec', count=1, tags=tags)
