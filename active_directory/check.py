...
DEFAULT_COUNTERS = [
    ...
    ["NTDS", None, "DRA Inbound Bytes Compressed (Between Sites, After Compression)/sec",   "active_directory.dra.inbound.bytes.after_compression",  "gauge"],
    ["NTDS", None, "DRA Inbound Bytes Compressed (Between Sites, Before Compression)/sec",  "active_directory.dra.inbound.bytes.before_compression", "gauge"],
    ["NTDS", None, "DRA Inbound Bytes Not Compressed (Within Site)/sec",                    "active_directory.dra.inbound.bytes.not_compressed",     "gauge"],
    ["NTDS", None, "DRA Inbound Bytes Total/sec",                                           "active_directory.dra.inbound.bytes.total",              "gauge"],
    ["NTDS", None, "DRA Inbound Full Sync Objects Remaining",                               "active_directory.dra.inbound.objects.remaining",        "gauge"],
    ...
    ["NTDS", None, "DRA Inbound Object Updates Remaining in Packet",                        "active_directory.dra.inbound.objects.remaining_in_packet", "gauge"],
    ["NTDS", None, "DRA Inbound Properties Applied/sec",                                    "active_directory.dra.inbound.properties.applied_persec", "gauge"],
    ["NTDS", None, "DRA Inbound Properties Filtered/sec",                                   "active_directory.dra.inbound.properties.filtered_persec", "gauge"],
    ...
    ["NTDS", None, "DRA Outbound Bytes Compressed (Between Sites, After Compression)/sec",   "active_directory.dra.outbound.bytes.after_compression",  "gauge"],
    ["NTDS", None, "DRA Outbound Bytes Compressed (Between Sites, Before Compression)/sec",  "active_directory.dra.outbound.bytes.before_compression", "gauge"],
    ["NTDS", None, "DRA Outbound Bytes Not Compressed (Within Site)/sec",                    "active_directory.dra.outbound.bytes.not_compressed",     "gauge"],
    ["NTDS", None, "DRA Outbound Bytes Total/sec",                                           "active_directory.dra.outbound.bytes.total",              "gauge"],

    ["NTDS", None, "DRA Outbound Objects Filtered/sec",                                      "active_directory.dra.outbound.objects.filtered_persec",  "gauge"],
    ...
    ["NTDS", None, "DRA Remaining Replication Updates",                                      "active_directory.dra.replication.remaining_updates",        "gauge"],
    ["NTDS", None, "DRA Pending Replication Synchronizations",                               "active_directory.dra.replication.pending_synchronizations", "gauge"],
    ["NTDS", None, "DRA Sync Requests Made",                                                 "active_directory.dra.sync_requests_made",                   "gauge"],

    ["NTDS", None, "DS Security Descriptor Suboperations/sec",                               "active_directory.ds.security_descriptor.subops_persec",      "gauge"],
    ["NTDS", None, "DS Security Descriptor Propagation Events",                              "active_directory.ds.security_descriptor.propagation_events", "gauge"],
