...
from datadog_checks.marklogic.parsers.storage import (
    parse_per_resource_storage_metrics,
    parse_summary_storage_base_metrics,
)
    ...
    assert result == {
        ...
        "forest": {
            "Documents": {
                ...
                "message": "HEALTH-FOREST-UNMOUNTED (critical): Forest unmounted. HEALTH-FOREST-OK (info): Recovered.",
            }
        },
    }
