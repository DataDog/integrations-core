...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "fluxcd", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description="The fluxcd check",
    long_description=long_description,
    long_description_content_type="text/markdown",
    keywords="datadog agent fluxcd check",
    # The project's main homepage.
    url="https://github.com/DataDog/integrations-extras",
    # Author details
    author="Melchior MOULIN",
    author_email="melchior.moulin@blablacar.com",
    # License
    ...
    packages=["datadog_checks.fluxcd"],
