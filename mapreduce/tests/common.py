...
import os
from datadog_checks.mapreduce.mapreduce import YARN_APPS_PATH, MAPREDUCE_JOBS_PATH
...
YARN_APPS_URL_BASE = '{}/{}'.format(RM_URI, YARN_APPS_PATH)
MR_JOBS_URL = '{}/proxy/{}/{}'.format(RM_URI, APP_ID, MAPREDUCE_JOBS_PATH)
