...
OVERVIEW_ATTRIBUTES = [
    ...
    ('churn_rate/channel_created', 'churn.channel.created.count', float),
    ('churn_rate/channel_created_details/rate', 'churn.channel.created.rate', float),
    ('churn_rate/channel_closed', 'churn.channel.closed.count', float),
    ('churn_rate/channel_closed_details/rate', 'churn.channel.closed.rate', float),
    ('churn_rate/connection_created', 'churn.connection.created.count', float),
    ('churn_rate/connection_created_details/rate', 'churn.connection.created.rate', float),
    ('churn_rate/connection_closed', 'churn.connection.closed.count', float),
    ('churn_rate/connection_closed_details/rate', 'churn.connection.closed.rate', float),
    ('churn_rate/queue_created', 'churn.queue.created.count', float),
    ('churn_rate/queue_created_details/rate', 'churn.queue.created.rate', float),
    ('churn_rate/queue_declared', 'churn.queue.declared.count', float),
    ('churn_rate/queue_declared_details/rate', 'churn.queue.declared.rate', float),
    ('churn_rate/queue_deleted', 'churn.queue.deleted.count', float),
    ('churn_rate/queue_deleted_details/rate', 'churn.queue.deleted.rate', float),
    ('message_stats/ack', 'messages.ack.count', float),
    ('message_stats/ack_details/rate', 'messages.ack.rate', float),
    ('message_stats/confirm', 'messages.confirm.count', float),
    ('message_stats/confirm_details/rate', 'messages.confirm.rate', float),
