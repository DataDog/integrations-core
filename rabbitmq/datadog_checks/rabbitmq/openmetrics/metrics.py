_METRIC_RENAMES = {
    ...
    "erlang_vm_dist_node_queue_size_bytes": "erlang.vm.dist.node.queue_bytes",
    "erlang_vm_dist_node_state": "erlang.vm.dist.node.state",
    "erlang_vm_dist_port_input_bytes": "erlang.vm.dist.port.input_bytes",
    "erlang_vm_dist_port_memory_bytes": "erlang.vm.dist.port.memory_bytes",
    "erlang_vm_dist_port_output_bytes": "erlang.vm.dist.port.output_bytes",
    "erlang_vm_dist_port_queue_size_bytes": "erlang.vm.dist.port.queue_bytes",
    ...
    "erlang_vm_dist_recv_bytes": "erlang.vm.dist.recv.bytes",
    ...
    "erlang_vm_dist_send_bytes": "erlang.vm.dist.send.bytes",
    ...
    "erlang_vm_memory_atom_bytes_total": "erlang.vm.memory.atom_bytes",
    "erlang_vm_memory_bytes_total": "erlang.vm.memory.bytes",
    "erlang_vm_memory_dets_tables": "erlang.vm.memory.dets_tables",
    "erlang_vm_memory_ets_tables": "erlang.vm.memory.ets_tables",
    "erlang_vm_memory_processes_bytes_total": "erlang.vm.memory.processes_bytes",
    "erlang_vm_memory_system_bytes_total": "erlang.vm.memory.system_bytes",
    ...
    "erlang_vm_msacc_gc_full_seconds_total": "erlang.vm.msacc.gc.full_seconds",
    "erlang_vm_msacc_gc_seconds_total": "erlang.vm.msacc.gc.seconds",
    ...
    "erlang_vm_msacc_send_seconds_total": "erlang.vm.msacc.send.seconds",
    ...
    "erlang_vm_wordsize_bytes": "erlang.vm.wordbytes",
    "process_start_time_seconds": "process_start_time_seconds",
    "rabbitmq_auth_attempts_failed_total": "auth_attempts_failed",
    "rabbitmq_auth_attempts_succeeded_total": "auth_attempts_succeeded",
    ...
    "rabbitmq_channel_get_ack_total": "channel.get_ack",
    "rabbitmq_channel_get_empty_total": "channel.get_empty",
    ...
    "rabbitmq_channel_messages_delivered_total": "channel.messages.delivered.total",
    "rabbitmq_channel_messages_published_total": "channel.messages.published",
    "rabbitmq_channel_messages_redelivered_total": "channel.messages.redelivered.total",
    ...
    "rabbitmq_global_messages_delivered_total": "global.messages.delivered.total",
    ...
    "rabbitmq_global_messages_redelivered_total": "global.messages.redelivered.total",
    ...
    "rabbitmq_queue_process_memory_bytes": "queue.process.memory_bytes",
    "rabbitmq_queue_process_reductions_total": "queue.process.reductions",
    ...
    "rabbitmq_raft_log_commit_index": "raft.log_commit_index",
    "rabbitmq_raft_log_last_applied_index": "raft.log_last_applied_index",
    "rabbitmq_raft_log_last_written_index": "raft.log_last_written_index",
    "rabbitmq_raft_log_snapshot_index": "raft.log_snapshot_index",
    "rabbitmq_raft_term_total": "raft.term",
    "rabbitmq_resident_memory_limit_bytes": "resident_memory_limit_bytes",
    "rabbitmq_schema_db_disk_tx_total": "schema_db.disk_tx",
    "rabbitmq_schema_db_ram_tx_total": "schema_db.ram_tx",
    "telemetry_scrape_duration_seconds": "telemetry.scrape.duration_seconds",
    "telemetry_scrape_encoded_size_bytes": "telemetry.scrape.encoded_bytes",
    "telemetry_scrape_size_bytes": "telemetry.scrape.bytes",
}
...
METRICS_RENAMES = {k: v for k, v in _METRIC_RENAMES.items() if k not in UNTYPED_METRICS}
