...
DEFAULT_OPENMETRICS = [
    ...
    'rabbitmq.channel.messages.delivered.total.count',
    'rabbitmq.channel.messages.published.count',
    'rabbitmq.channel.messages.redelivered.total.count',
    ...
    'rabbitmq.global.messages.delivered.total.count',
    ...
    'rabbitmq.global.messages.redelivered.total.count',
