...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `openmetrics_endpoint` | [Python3 only] The URL where your application metrics are exposed by Prometheus (must be unique). If running on Python 2 use the old `prometheus_url` configuration option name.                                                                                                                         |
