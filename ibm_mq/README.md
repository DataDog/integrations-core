...
2. Update your `LD_LIBRARY_PATH` and `C_INCLUDE_PATH` to include the location of the libraries. (Create these 2 environment variables if they don’t exist yet.) For example:
